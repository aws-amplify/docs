...
4. If the spell-check flags any 'Unknown words' while you're making a pull request, please add these words to the `"words"` list in [cspell.json](https://github.com/aws-amplify/docs/blob/main/cspell.json#L4) to ignore them.
