...
The Amplify CLI requires the below IAM policies for performing project creation. You can grant or restrict category permissions by including or removing items from the `Action` section as appropriate.
