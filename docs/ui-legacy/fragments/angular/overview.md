...
Angular 9 is not supported in the legacy version of the Angular UI Components. If your app is using Angular 9, please see our new [Angular UI Component package](~/ui/ui.md/q/framework/angular).
