...
* [Install Node.js®](https://nodejs.org/en/download/) and [NPM](https://www.npmjs.com/get-npm) if they are not already on your machine. ([Yarn](https://yarnpkg.com/) is not supported as of the moment)
