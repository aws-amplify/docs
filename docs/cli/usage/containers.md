...
> Install the latest Amplify CLI beta version to take advantage of serverless containers. (Production release of Amplify CLI's serverless container support is arriving later today)

> **Open terminal and run `npm install -g @aws-amplify/cli@beta` to update to the latest Amplify CLI beta**
