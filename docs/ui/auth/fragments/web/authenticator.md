...
If you'd like to customize the form fields in the Authenticator Sign In or Sign Up component you can do some by using the `formFields` property.
...
<component-playground component-name="AuthenticatorWithSlots"></component-playground>
