...
<inline-fragment framework="angular" src="~/legacy-ui/fragments/sign-up-attributes.md"></inline-fragment>
...
<inline-fragment framework="angular" src="~/legacy-ui/fragments/sign-up-fields.md"></inline-fragment>
...
Additional details about the authState can be found in the [Subscribe to Authentication State Changes](~/legacy-ui/auth/authenticator.md#subscribe-to-authentication-state-changes) section.
