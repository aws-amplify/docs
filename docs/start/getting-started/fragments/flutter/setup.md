...
2. Modify your AndroidManifest.xml to target minSDK 21 or higher.  Within your project open `android/app/src/build.gradle` and change the line starting with `minSdkVersion` to be `minSdkVersion 21`. 
