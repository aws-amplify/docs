When using `npx amplify-app` a NPM script named `amplify-modelgen` should be added to your `package.json`. You can **generate model code** with the following command.
