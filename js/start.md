...
See the [Angular Guide](https://aws-amplify.github.io/amplify-js/media/angular_guide){: target='_new'} for details and usage.  This guide includes documentation about Ionic-specific components.
{: .callout .callout--action}
