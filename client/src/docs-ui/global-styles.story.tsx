...
@Component({
  tag: "docs-global-styles-story",
  shadow: false,
})
export class DocsGlobalStylesStory {
  render() {
    return (
      <Host>
        <hr />
        ...
        <ul>
          <li>
            Create a list by starting a line with <code>+</code>, <code>-</code>
            , or <code>*</code>
          </li>
          <li>
        ...
        <pre class="hljs language-js">
          <code>
            ...
            <span class="hljs-function">
              ...
              <span class="hljs-params">bar</span>){" "}
            </span>
            {`{`}
        ...
        <h2>Plugins</h2>
        <p>
          The killer feature of <code>markdown-it</code> is very effective
          support of
          <a href="https://www.npmjs.org/browse/keyword/markdown-it-plugin">
            syntax plugins
          </a>
          .
        </p>
        ...
        <h3>
          <a href="https://github.com/markdown-it/markdown-it-footnote">
            Footnotes
          </a>
        </h3>
        <p>
        ...
        <h3>
          <a href="https://github.com/markdown-it/markdown-it-deflist">
            Definition lists
          </a>
        </h3>
        <dl>
        ...
        <p>
          It converts “<abbr title="Hyper Text Markup Language">HTML</abbr>”,
