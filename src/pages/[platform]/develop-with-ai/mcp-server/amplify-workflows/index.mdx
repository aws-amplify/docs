...
- Deploying to your own AWS account with self-managed hosting and CDK
...
1. Connect your GitHub repository to Amplify Hosting, or configure self-managed hosting with CDK
...
1. [Set up AWS MCP Server](/[platform]/develop-with-ai/mcp-server/set-up-mcp/) if you haven't already
