...
Now that you have AWS MCP Server configured, learn about the [guided workflows](/[platform]/develop-with-ai/mcp-server/amplify-workflows/) available to accelerate your Amplify development.
