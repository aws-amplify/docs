...
Sandbox enables you to develop your backend alongside your frontend's development server. This command will automatically watch for changes in `amplify/` folder, and redeploy each time you save a file. Run `npx amplify sandbox` to deploy to your personal cloud sandbox.
