...
Sandbox enables you to develop your backend alongside your frontend's development server. This command will automatically watch for changes in `amplify/`, and redeploy each time you save a file. Run `npx ampx sandbox` to deploy to your personal cloud sandbox.
...
```bash
npx ampx generate config --stack amplify-nextamplifygen2-josef-sandbox-ca85e1081b
```
...
```bash
npx ampx generate config --stack amplify-nextamplifygen2-josef-sandbox-ca85e1081b --format json-mobile
```
