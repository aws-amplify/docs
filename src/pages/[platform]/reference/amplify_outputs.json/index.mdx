...
export async function getStaticProps() {
  async function fetchBackendOutputsSchema() {
    const request = new Request("https://raw.githubusercontent.com/aws-amplify/amplify-backend/main/packages/client-config/src/client-config-schema/schema_v1.json")
  ...
  return {
    props: {
      meta,
      schema: await fetchBackendOutputsSchema()
    }
  };
}
