...
Amplify Gen 2 backends are defined using TypeScript, and enable you to collocate resources depending on their function. For example, you can author a [post confirmation trigger for Amazon Cognito](/[platform]/build-a-backend/functions/examples/create-user-profile-record/) right next to your auth's resource file.
