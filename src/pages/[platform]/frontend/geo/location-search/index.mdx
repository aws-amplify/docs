...
First, make sure you've provisioned a search index resource and configured your app using the instructions in either [Configure Location Search](/[platform]/frontend/geo/configure-location-search/) or [Use existing Amazon Location Service resources](/[platform]/frontend/geo/existing-resources/) and you have already setup [displaying a map](/[platform]/frontend/geo/maps) in your application.
