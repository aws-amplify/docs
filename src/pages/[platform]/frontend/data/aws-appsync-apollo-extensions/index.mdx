...
<Block name="With Amplify">
Before you begin, you will need an Amplify Data backend deploy. To get started, see [Set up Data](/[platform]/frontend/data/set-up-data/). 
