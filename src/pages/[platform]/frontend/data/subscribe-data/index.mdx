...
The model's [authorization rules](/[platform]/frontend/data/customize-authz/) must grant the appropriate rights to the user.
...
- [Customize your auth rules](/[platform]/frontend/data/customize-authz/)
- [Customize your data model](/[platform]/frontend/data/data-modeling/)
- [Add custom business logic](/[platform]/frontend/data/custom-business-logic/)
