...
![A screenshot of AWS Toolkit for JetBrains that displays auth config options for Amazon Q + CodeWhisperer using IAM Identity Center, AWS Builder ID, and IAM credentials](/images/gen2/q-developer/JetBrains.png)
