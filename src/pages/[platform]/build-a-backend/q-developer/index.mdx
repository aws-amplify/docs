...
export const meta = {
  title: 'Use Amplify with Amazon Q Developer',
...
You can quickly setup an Amplify Gen 2 project using one of our [Quickstart](/start) guides. In this example, we will setup a [Next.js App Router (Client Components)](/[platform]/start/quickstart/nextjs-app-router-client-components/).
