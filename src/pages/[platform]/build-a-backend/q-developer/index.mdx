...
[Amazon Q Developer](https://aws.amazon.com/q/) reimagines the experience across the entire Software Development LifeCycle (SDLC), making it faster and easier for developers and IT professionals to explore and understand problems and codebases, plan and develop a solution, build and deploy their apps, or modernize legacy workloads. Q Developer in the IDE provides [Inline completions (former Amazon CodeWhisperer)](https://docs.aws.amazon.com/codewhisperer/latest/userguide/what-is-cwspr.html) - an AI-powered productivity tool that generates code suggestions ranging from snippets to full functions in 
real time in the IDE based on your comments and existing code. When you start typing out singles of code or comments, Inline completions
...
![A screenshot of AWS Toolkit for VS Code that displays options with sign in mechanisms for Amazon Q + CodeWhisperer, AWS Explorer, and Amazon CodeCatalyst](/images/gen2/q-developer/VSCode.png)
...
![A screenshot of AWS Toolkit for JetBrains that displays tabs with sign in options for Amazon Q + CodeWhisperer using IAM Identity Center, AWS Builder ID, and IAM credentials](/images/gen2/q-developer/VSCode.png)

</Block>
</BlockSwitcher>

## Setup a AWS Amplify Gen 2 project

You can quickly setup an Amplify Gen 2 project using one of our [Quickstart](/start) guides. In this example, we will setup a [Next.js App Router (Client Components)](https://next-release-main.d1ywzrxfkb9wgg.amplifyapp.com/javascript/start/quickstart/nextjs-app-router-client-components/).
...
Amplify generates two folders in our backend directory, `auth` and `data` which contain TypeScript CDK definitions for each of these resources.  We’ll build out the schema for our API through the help of Amazon Q Developer - Inline completions capabilities.
...
<video autoPlay={true} muted={true} loop={true} width="100%" playsInline={true}>
  <source src="/images/gen2/q-developer/Amplify-Gen2-Cwspr.mp4" />
</video>
...
Success! You've learned how to use Amazon Q Developer - Inline completions feature with Amplify.
