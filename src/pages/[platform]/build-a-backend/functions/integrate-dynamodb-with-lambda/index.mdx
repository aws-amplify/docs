...
To learn how to interact with DynamoDB from Lambda, check out [Calling DynamoDB from Lambda in Node.js](/[platform]/build-a-backend/functions/dynamodb-from-lambda-nodejs/).
