...
After you successfully deploy your personal cloud sandbox, start your frontend application, and sign up for the first time, you will see logs printed to the terminal from your triggers' executions.
...
Log output also supports printing multi-line strings

```console title="Terminal"
[auth-pre-sign-up] 3:36:34 PM 2024-07-19T22:36:34.783Z	685be2bd-5df1-4dd5-9eb1-24f5f6337f91	INFO	event {
  "version": "1",
  "region": "<your-aws-region>",
  "userPoolId": "<your-user-pool-id>",
  "userName": "e4f844d8-c0e1-7064-37a4-78d4236bff68",
  "callerContext": {
