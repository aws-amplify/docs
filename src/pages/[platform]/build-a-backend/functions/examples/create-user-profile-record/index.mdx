...
Run the command `npx amplify sandbox` to create the backend, then use the command below to generate GraphQL client code to call your data backend.
<Callout info>
...
npx amplify generate graphql-client-code --out <path-to-post-confirmation-handler-dir>/graphql
```
