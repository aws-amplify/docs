...
Third, create the corresponding handler file, `amplify/auth/pre-sign-up/handler.ts`, file with the following contents:
...
import { postConfirmation } from './pre-sign-up/resource';
