...
For examples on streaming analytics data to the Kinesis stream from your frontend, see the [Streaming analytics data](/[platform]/frontend/analytics/streaming-data/) documentation.
</InlineFilter>
