...
To improve the ergonomics of your API, you may want to rename the generated types to better accommodate your use case. Use the `renameModels()` modifier to rename the auto-inferred data models.
