...
export const meta = {
  title: 'Manage Data in Amplify console',
  description:
    'Manage GraphQL data in Amplify console',
  platforms: [
    'android',
    'angular',
    'flutter',
...
The **Data manager** in the Amplify Console offers a user-friendly interface for managing the backend GraphQL API data of an application. It enables real-time creation and updates of application data, eliminating the need to build separate admin views.
...
<video autoPlay={true} muted={true} loop={true} width="100%" playsInline={true}>
  <source src="/images/gen2/manage/data-manager.mp4" />
</video>
