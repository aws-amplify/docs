...
- A frontend application set up. For instructions on setting up an app, see the [quickstart](/[platform]/start/quickstart) for Amplify Gen 2
...
- [Create, update, and delete application data](/[platform]/build-a-backend/data/mutate-data/)
