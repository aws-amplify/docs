...
// Retrieve the file's signed URL:
let signedUrl = try await Amplify.Storage.getURL(path: imagePath)
```
</InlineFilter>
...
class SongViewModel: ObservableObject {
    ...
    func createSong(name: String, artCover: UIImage) async throws {
        ...
        // Upload the art cover image
        _ = try await Amplify.Storage.uploadData(path: .fromString("images/\(createdSong.id)"), data: imageData).value
    ...
    func updateArtCover(artCover: UIImage) async throws {
        ...
        // Upload the new art image
        _ = try await Amplify.Storage.uploadData(path: .fromString("images/\(currentSong.id)"), data: imageData).value
