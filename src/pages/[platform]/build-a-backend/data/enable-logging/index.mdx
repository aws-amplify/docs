...
- **`DataLogConfig` object**  
  Overrides one or more default fields.
...
For more details on different logging levels, see https://docs.aws.amazon.com/appsync/latest/devguide/monitoring.html#cwl. 
