...
1. **`retention?: LogRetention`**  
   ...
   - Defaults to `'1 week'`.  
   - Supported values of [AppSync RetentionDays](https://docs.aws.amazon.com/cdk/api/v2/docs/aws-cdk-lib.aws_logs.RetentionDays.html), such as:  
...
3. **`fieldLogLevel?: DataLogLevel`**  
   - Defaults to `'none'`.  
   - Supported values of [AppSync Log Levels](https://docs.aws.amazon.com/appsync/latest/devguide/monitoring.html#cwl), such as:
     `'none'`, `'error'`, `'info'`, `'debug'`, or `'all'`.
