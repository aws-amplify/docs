...
## Step 4 - Add your Amazon Translate as Datasource

To access Amazon Rekognition service, you need to add Amazon Rekognition as Http Data Source and configure the proper IAM policy for Lambda to utilize the desired feature effectively. Update amplify/backend.ts file as shown below.
...
Define the function handler by creating a new file, `amplify/data/identifyText.ts`. This function converts text into speech using Amazon Polly and stores the synthesized speech as an MP3 file in an S3 bucket.
    ...
    params: {
      body: {
        Image: {
          S3Object: {
            Bucket:
              "amplify-gen2atpredictions-predictionsforgen2bucket-cmyvdjtbdsmu",
            Name: "public/" + ctx.arguments.path,
          },
        },
      },
      headers: {
