...
### Step 4a: Add the AppSync Resolver for the Search Query
...
const schema = a.schema({
  Todo: a
    ...
    .authorization([a.allow.public()]),
  //highlight-start  
  searchTodos: a.query().returns(a.ref("Todo").array()),
  //highlight-end
});
```

### Step 4b:Add OpenSearch Datasource to backend
...
```
### Step 4c: Create Resolver and attach to query
