...
## Step 4 - Configure IAM Roles
 ...
 To access Amazon Polly service, you need to configure the proper IAM policy for Lambda to utilize the desired feature effectively. Update `amplify/backend.ts` file add Role policy shown below.
