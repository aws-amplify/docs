...
## Step 4 - Configure IAM Roles
 ...
 To activate Polly, we need to configure the proper IAM policy for Lambda to utilize the desired feature effectively. Update `amplify/backend.ts` file as shown below.
