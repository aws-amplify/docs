...
## Step 3 - Add your Amazon Translate as Datasource
 ...
 To access Amazon Translate service, you need to add Amazon Translate as Http Data Source and configure the proper IAM policy for AWS Lambda to utilize the desired feature effectively. Update `amplify/backend.ts` file as shown below.
