...
## Step 3 - Add your Aamzon Translate as datasource

 To access Amazon Translate service, you need to add Amazon Translate as Http DataSource and configure the proper IAM policy for Lambda to utilize the desired feature effectively. Update `amplify/backend.ts` file as shown below.
