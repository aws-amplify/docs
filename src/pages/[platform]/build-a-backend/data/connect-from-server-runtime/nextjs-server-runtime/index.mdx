...
- [A Next.js application](/nextjs/start/project-setup/create-application/)
- [The Amplify libraries for Next.js installed and configured in your app](/nextjs/build-a-backend/server-side-rendering/)
