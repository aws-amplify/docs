...
`input AMPLIFY { globalAuthRule: AuthRule = { allow: public } }` allows you to get started quickly without worrying about authorization rules. Review the [Authorization rules](/[platform]/build-a-backend/graphqlapi/customize-auth/) section to setup the appropriate access control for your GraphQL API.
...
For Flutter, Android, and Swift client code generation, refer to [JavaScript, Android, Swift, and Flutter client code generation](/[platform]/tools/cli/graphqlapi/client-code-generation/).
...
2. Modifying the [primary key](/[platform]/tools/cli/graphqlapi/data-modeling/#configure-a-primary-key) of a model
...
- [How to model your database table and their access patterns](/[platform]/tools/cli/graphqlapi/data-modeling/)
- [Secure your API with fine-grained authorization rules](/[platform]/build-a-backend/graphqlapi/customize-auth/)
- [Create relationships between different database model](/[platform]/tools/cli/graphqlapi/data-modeling/#setup-relationships-between-models)
- [Add custom business logic to the GraphQL API](/[platform]/tools/cli/graphqlapi/custom-business-logic/)
- [Run search and result aggregation queries](/[platform]/tools/cli/graphqlapi/search-and-result-aggregations/)
- [Connect to machine learning services](/[platform]/tools/cli/graphqlapi/connect-machine-learning-services/)
