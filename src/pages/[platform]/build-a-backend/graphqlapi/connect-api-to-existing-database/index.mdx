...
First, place your database connection information (hostname, username, password, port, and database name) into Secrets Manger.
...
You can also optionally configure a rotation schedule and create a lambda or choose an existing one from your account to rotate the database credentials automatically.

When viewing your new secret's value, it should look something like this:

![Storing Database Credentials in Secrets Manager](/images/storing-db-creds-in-secrets-manager.png)
</Block>
</BlockSwitcher>
