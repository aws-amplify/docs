...
![Database credentials stored in SSM Parameter Store as Secure Strings](/images/storing-db-creds-in-ssm.png)
</Block>
...
![Database credentials stored in Secrets Manager with username and password defined](/images/storing-db-creds-in-secrets-manager.png)
