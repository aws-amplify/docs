...
export const meta = {
  ...
  platforms: ['javascript', 'react-native', 'angular', 'vue', 'react', 'nextjs', 'swift', 'android', 'flutter']
};
...
amplifyApi.resources.cfnResources.cfnTables["Todo"].pointInTimeRecoverySpecification = {
  pointInTimeRecoveryEnabled: true
}
```
