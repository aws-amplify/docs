...
Review the Amplify Library documentation to set the custom authorization token for [GraphQL API](/[platform]/build-a-backend/graphqlapi/customize-authz/#aws-lambda) and [DataStore](/[platform]/build-a-backend/more-features/datastore/authz-rules-setup/#configure-custom-authorization-logic-with-aws-lambda).
...
Refer to the [sample code](/[platform]/build-a-backend/graphqlapi/graphql-from-nodejs/#iam-authorization) to learn how to sign the request to call the GraphQL API using IAM authorization.
