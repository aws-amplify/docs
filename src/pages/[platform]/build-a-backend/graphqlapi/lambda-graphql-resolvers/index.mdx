...
To learn more about the `@function` directive, check out the GraphQL Transform documentation [here](/[platform]/tools/cli/graphqlapi/custom-business-logic/#lambda-function-resolver).
