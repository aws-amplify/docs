...
To enable this, you can use the [@index](/[platform]/tools/cli/graphqlapi/data-modeling/) directive. This directive will allow you to set a custom `sortKey` on any field in your API.
...
To learn more about the `@index` directive, check out the documentation [here](/[platform]/tools/cli/graphqlapi/data-modeling/)
ing)
