...
export const meta = {
  ...
  platforms: ['javascript', 'angular', 'nextjs', 'react', 'vue', 'swift', 'android']
};
...
To learn more about the `@index` directive, check out the documentation [here](/[platform]/build-a-backend/graphqlapi/data-modeling/) ing)
