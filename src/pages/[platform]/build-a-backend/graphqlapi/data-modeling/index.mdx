...
As your project grows, you may want to organize your custom queries, mutations, and subscriptions depending on the size and maintenance requirements of your project. You can either consolidate  all of your custom queries, mutations, and subscriptions into one file or colocate them with their corresponding models.
...
<Callout warning>
Declaring custom Query, Mutation, and/or Subscription with the same field name in another schema file will result in schema validation errors similar to the following:
