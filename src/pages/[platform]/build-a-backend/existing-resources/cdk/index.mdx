...
1. Section two shows how to build and integrate a Flutter app with the AppSync API. Follow this if you want a cross-platform frontend.
1. Section three explains how to create and connect a React web app to the AppSync API. Follow this if you want to build a web-only frontend or want to add a web frontend to complement the mobile experience.

The recommended approach is to complete section one to build the backend, then optionally complete section two or three, or both, to connect frontends for Flutter or React, or both.
...
## Build backend resources with the CDK
