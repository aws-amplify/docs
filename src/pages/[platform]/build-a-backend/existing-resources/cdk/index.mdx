...
1. [Section one](/[platform]/build-a-backend/existing-resources/cdk/#build-backend-resources-with-the-cdk) provides instructions for using the Amplify Data CDK to create a GraphQL API backend with AWS AppSync. This creates the core backend.
