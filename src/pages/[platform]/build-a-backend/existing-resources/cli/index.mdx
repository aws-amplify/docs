...
![The team-provider-info.json file within the file directory of the Amplify app.](/images/existing-resources/team-provider-info-mobile-cli.png)
...
![The environment and AmplifyAppId in team-provider-info.json file.](/images/existing-resources/dev-amplifyappid-mobile-cli.png)
...
Accept the default values for the prompts about the default editor, type of the app, and storage location of the configuration file. Then answer **Yes** to the “modifying this backend” question. Amplify CLI will initialize the backend and connect the project to the cloud.
...
Amplify AppID found: dorapq24trw9r. Amplify App name is: amplifytripsplanner
Backend environment dev found in Amplify Console app: amplifytripsplanner
? Choose your default editor: Visual Studio Code
✔ Choose the type of app that you're building · flutter
Please tell us about your project
? Where do you want to store your configuration file? ./lib/
? Do you plan on modifying this backend? Yes
⠦ Fetching updates to backend environment: dev from the cloud.⠋ Building resource api/amplifytripspla
⠧ Fetching updates to backend environment: dev from the cloud.⚠️ WARNING: owners may reassign ownership for the following model(s) and role(s): Trip: [owner], Activity: [owner], Profile: [owner]. If this is not intentional, you may want to apply field-level authorization rules to these fields. To read more: https://docs.amplify.aws/cli/graphql/authorization-rules/#per-user--owner-based-data-access.
⠹ Fetching updates to backend environment: dev from the cloud.✅ GraphQL schema compiled successfully.

Edit your schema at /Users/malakamm/development/amplify_connect_resources/amplify/backend/api/amplifytripsplanner/schema.graphql or place .graphql files in a directory at /Users/malakamm/development/amplify_connect_resources/amplify/backend/api/amplifytripsplanner/schema
...
![The Amplify folder and amplifyconfiguration.dart file within the file directory of the Amplify app.](/images/existing-resources/amplify-amplifyconfig-mobile-cli.png)
...
![The models folder within the file directory of the Amplify app.](/images/existing-resources/lib-models-dart-mobile-cli.png)
...
Now that you’ve finished this guide, you can delete the backend resources to avoid incurring unexpected costs by running the following command in the root folder of the app. 
...
## Connect a web app to existing AWS resources
...
![The team-provider-info.json file within the file directory of the Amplify app.](/images/existing-resources/team-provider-info-web-cli.png)
...
![The environment and AmplifyAppId in team-provider-info.json file.](/images/existing-resources/dev-amplifyappid-web-cli.png)
...
![The amplify folder within the file directory of the Amplify app.](/images/existing-resources/app-root-folder-web-cli.png)
...
![The graphql folder within the file directory of the Amplify app.](/images/existing-resources/graphql-web-cli.png)
...
![Amplify CLI publish the app and display a URL.](/images/existing-resources/publish-app-web-cli.png)
...
Now that you’ve finished this walkthrough, you can delete the backend resources to avoid incurring unexpected costs by running the following command in the root folder of the app.
