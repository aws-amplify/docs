...
- [Convert text to speech](/[platform]/frontend/predictions/text-to-speech/)
- [Transcribe audio to text](/[platform]/frontend/predictions/transcribe-audio/)
- [Translate text from one language to another](/[platform]/frontend/predictions/translate/)
- [Identify text from an image](/[platform]/frontend/predictions/identify-text/)
- [Identify entities from an image](/[platform]/frontend/predictions/identify-entity/)
- [Identify real world objects from an image](/[platform]/frontend/predictions/identify-entity)
- [Interpret text](/[platform]/frontend/predictions/interpret-sentiment)
