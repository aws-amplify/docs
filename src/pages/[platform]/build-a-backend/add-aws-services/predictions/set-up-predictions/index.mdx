...
**Note:** In the following example, we configure the policy to enable all supported ML capabilities. Ensure to include only the actions relevant to your specific use cases.
