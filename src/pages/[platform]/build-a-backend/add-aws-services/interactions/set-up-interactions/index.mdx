...
![A screenshot of Amazon Lex intents page under a bot called 'BookTripNew', showing a list of two created intents 'BookCar' and 'FallbackIntent'. The intents have a last edited date 8 days ago and 1 month ago](/images/interactions_lex_v2_console_edit_bot.png)
