...
Create a [Function](/[platform]/build-a-backend/functions) with the following.
...
Refer to the [Amplify REST API documentation](/gen1/[platform]/build-a-backend/restapi/) to learn how to work with REST API in your web app.
