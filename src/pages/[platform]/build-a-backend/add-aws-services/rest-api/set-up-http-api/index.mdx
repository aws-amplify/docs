...
To setup and configure your application with HTTP API to make requests to [Amazon API Gateway](https://aws.amazon.com/api-gateway/) and trigger the lambda function, you can create a HTTP API using the AWS Cloud Development Kit (AWS CDK).
