...
To setup and configure your application with REST API to make requests to [Amazon API Gateway](https://aws.amazon.com/api-gateway/) and trigger the lambda function, you can create a REST using the AWS Cloud Development Kit (AWS CDK).
