...
![Geofence Create example when selecting an area on a map](/images/geofence-create.png)

![Geofence Edit example when selecting an area on a map](/images/geofence-edit.png)
