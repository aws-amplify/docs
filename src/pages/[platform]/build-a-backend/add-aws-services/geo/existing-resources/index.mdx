...
Now you can proceed to [displaying a map](/gen1/[platform]/build-a-backend/more-features/geo/maps/) or [adding location search](/gen1/[platform]/build-a-backend/more-features/geo/location-search/) to your app.
</InlineFilter>
...
Amplify Geo is dependent on your Amplify Auth category. If it is not already configured, then you will need to [configure it](/gen1/[platform]/build-a-backend/auth/existing-resources) as well.
