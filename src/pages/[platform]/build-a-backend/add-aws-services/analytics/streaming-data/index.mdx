  ...
  canonicalObjects: [
    {
      ...
      canonicalPath: '/[platform]/build-a-backend/add-aws-services/analytics/streaming-data/'
    }
  ]
};
...
Ensure you have [setup IAM permissions](https://docs.aws.amazon.com/streams/latest/dev/learning-kinesis-module-one-iam.html) for `kinesis:PutRecords`.
