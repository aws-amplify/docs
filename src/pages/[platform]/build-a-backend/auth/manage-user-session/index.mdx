...
**Note:** `Amplify.configure()` takes in two parameters - `BackendResources` and `LibraryConfiguration`. Be sure to pass `cognitoUserPoolsTokenProvider` into the second parameter.
