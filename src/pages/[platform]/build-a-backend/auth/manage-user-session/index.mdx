...
Amplify Auth provides access to current user sessions and tokens to help you retrieve your user's information to determine if they are signed in with a valid session and control their access to your app. You can manage tokens, expiration times, and revoke sessions. In this guide, we will review how to retrieve your user's session and understand what token management options are available.
...
Now that you updated how your credentials are managed you may also want to further refine the sign-in and sign-out workflows as well as update how you listen for these Auth events. We recommend you learn more about:

- [Enable sign-up, sign-in, and sign-out](/[platform]/build-a-backend/auth/enable-sign-up/)
- [Listen to auth events](/[platform]/build-a-backend/auth/auth-events/)
