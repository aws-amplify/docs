...
<ContentItem platform="javascript">
### React

[Go to React docs](/react/build-a-backend/auth/set-up-auth/)

### Next.js

[Go to Next.js docs](/nextjs/build-a-backend/auth/set-up-auth/#build-an-authentication-experience-using-the-authenticator)

### Angular

[Go to Angular docs](/angular/build-a-backend/auth/set-up-auth/#build-an-authentication-experience-using-the-authenticator)

### Vue

[Go to Vue docs](/vue/build-a-backend/auth/set-up-auth/#build-an-authentication-experience-using-the-authenticator)
</ContentItem>

<ContentItem platform="react">
