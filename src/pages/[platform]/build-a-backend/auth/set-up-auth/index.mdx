...
Navigate to your preferred platform page to continue building an Authentication experience using the Authenticator UI component:

<Columns>

<PlatformLinkCard url="/react/build-a-backend/auth/set-up-auth/#build-an-authentication-experience-using-the-authenticator" title="Go to the React docs" />

<PlatformLinkCard url="/nextjs/build-a-backend/auth/set-up-auth/#build-an-authentication-experience-using-the-authenticator" title="Go to the Next.js docs" />

<PlatformLinkCard url="/angular/build-a-backend/auth/set-up-auth/#build-an-authentication-experience-using-the-authenticator" title="Go to the Angular docs" />

<PlatformLinkCard url="/vue/build-a-backend/auth/set-up-auth/#build-an-authentication-experience-using-the-authenticator" title="Go to the Vue docs" />
