...
- An Amplify app set up (see the [quickstart](/[platform]/start/quickstart/) if you need to set up an app)
...
- [Set up admin actions and user group management](/[platform]/build-a-backend/auth/admin-actions/)
