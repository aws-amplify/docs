...
**Note:** `Amplify.configure()` takes in two parameters - `BackendResources` and `LibraryConfiguration`. Be sure to ass your CustomCredentialsProvider into the second parameter.
