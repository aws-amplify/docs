...
The Auth category can be used to register a user, confirm attributes like email and phone, and sign in with optional multi-factor authentication. It is set up to use Amazon Cognito User Pools which manages the users and their properties.
