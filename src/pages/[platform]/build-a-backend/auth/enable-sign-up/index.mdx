...
Before you begin, you should have finished the [_Set up and connect backend resources_](/lib/auth/getting-started/q/platform/js/#set-up-and-connect-backend-resources) section of the _Set up Amplify Auth_ guide.
...
Before you begin, you should have finished the [_Set up backend resources_](/lib/auth/getting-started/q/platform/react-native/#set-up-backend-resources) section of the _Set up Amplify Auth_ guide.
...
For more information on handling the TOTP & MFA steps that may be returned, please see [_'Multi-factor authentication'_](/lib-v1/auth/mfa/q/platform/js/).
...
- [Add social provider sign-in](/lib/auth/social/q/platform/js/)
...
- [Add social provider sign-in](/lib/auth/social/q/platform/react-native/)
