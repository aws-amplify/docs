...
Future<void> confirmTotpUser(String emailAddress) async {
  try {
    final result = await Amplify.Auth.confirmSignIn(
      ...
      Amplify.Auth.signIn(
              ...
              result ->
              {
                  ...
                  switch (nextStep.getSignInStep()) {
                      ...
                      case CONFIRM_SIGN_IN_WITH_EMAIL_MFA_CODE: {
                          Log.i("AuthQuickstart", "Email code sent to " + nextStep.getCodeDeliveryDetails().getDestination());
                          Log.i("AuthQuickstart", "Additional Info :" + nextStep.getAdditionalInfo());
