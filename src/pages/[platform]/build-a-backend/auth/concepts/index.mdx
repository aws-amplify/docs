...
This is not a username the user will be able to sign in with, but it can be used to mask their personal information such as their email or phone number when displaying publically. 

{/* frontend examples of vanity username */}
{/* overriding defaults for pure "username" */}
