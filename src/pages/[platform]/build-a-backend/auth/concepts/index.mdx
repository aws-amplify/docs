...
With Amazon Cognito, usernames are immutable, which means after the initial sign-up users are unable to change their username later. 

{/* more about usernames */}
{/* backend examples of vanity username */}
