...
Secrets must be created manually with [`amplify sandbox secret`](/[platform]/reference/cli-commands#amplify-sandbox-secret) for use with cloud sandbox, or via the Amplify Console for branch environments.
...
If you are using the [Authenticator component](https://ui.docs.amplify.aws/react/connected-components/authenticator/configuration#social-providers) with Amplify, this feature works without any additional code. The guide below is for writing your own implementation.
