...
export const meta = {
  title: 'Manage users in Amplify console',
  description:
    'Manage applications Cognito users and groups in Amplify console',
  platforms: [
    'android',
    'angular',
    'flutter',
...
The **User management** in the Amplify Console provides a user-friendly interface for managing your application's users. you can create and manage users and groups, edit user attributes, and suspend users. 

If you have not yet created a **Auth** resource, visit the [Auth setup guide](/[platform]/build-a-backend/build-a-backend/auth/set-up-auth/)
...
<video autoPlay={true} muted={true} loop={true} width="100%" playsInline={true}>
  <source src="/images/gen2/manage/user-manager.mp4" />
</video>
