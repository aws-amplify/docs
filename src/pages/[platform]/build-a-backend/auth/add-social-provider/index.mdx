...
<InlineFilter filters={['flutter', 'android', 'swift']}>
## Prerequisites
...
Secrets must be created manually with [`amplify sandbox secret`](/[platform]/reference/cli-commands#amplify-sandbox-secret) for use with cloud sandbox, or via Amplify Console for branch environments.
...
You're now ready to launch sign in with your social provider's web UI.
...
- [Delete user account](/[platform]/build-a-backend/auth/delete-user-account/)
