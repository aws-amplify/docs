...
Hub.listen("auth", async ({ payload }) => {
  switch (payload.event) {
    case "signInWithRedirect":
      ...
      displayUser({ user, element: document.getElementById('usernameLabel')! })
      break;
    case "signInWithRedirect_failure":
      break;
    case "customOAuthState":
      handleState(payload.data); // this will be 'shopping-cart'
      break;
  }
});

function displayUser({ user, element }: { user: AuthUser, element: HTMLElement }) {
