...
Secrets must be created manually with [`ampx sandbox secret`](/[platform]/reference/cli-commands#amplify-sandbox-secret) for use with cloud sandbox, or via Amplify Console for branch environments.
