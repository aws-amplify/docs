...
While using the Amplify Backend is the easiest way to get started, existing storage resources can be integrated with Amplify Storage. 

You can accomplish this by passing your existing storage resource metadata to `Amplify.configure`. This will configure the Amplify Storage client library to interact with your existing storage resources. It's recommended to add the Amplify configuration step to your app's root entry point.
