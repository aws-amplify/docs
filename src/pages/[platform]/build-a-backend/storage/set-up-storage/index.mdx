...
With Amplify Storage, you can enable file storage and management for user's content in your app. Paths within your storage instance can have different access rules. Amplify Storage is powered by Amazon Simple Storage Service (Amazon S3) buckets.
...
{/* I'm confused by this example - is this needed? why are they copying and pasting multiple examples? If the goal is to conceptually tie to Gen 1 maybe we can do a separate "Storage in Gen 1 vs. Gen 2" guide or something - I personally feel this is confusing. */}
