...
Refer to the following example to construct access rules for your storage bucket. [Learn more about customizing access to file path](/[platform]/build-a-backend/storage/authorization/).
...
Copy and paste the following definition for authorization rules to implement public, protected, and private paths (this is currently the pattern in Gen 1).
