...
To learn how to use storage in your frontend, see docs on [uploading files](/gen1/javascript/build-a-backend/storage/upload/) or [downloading files](/gen1/javascript/build-a-backend/storage/download/).
...
- [Learn more about `defineBackend`](/[platform]/build-a-backend/)
