...
This guide will help you migrate v5 Storage implementations to the new functional APIs in v6.

## Deprecated Options

<Callout>Many input and output properties have been deprecated due to low usage or added complexity. If you would like to see these options re-implemented in v6, feel free to open a [feature request](https://github.com/aws-amplify/amplify-js/issues/new?assignees=&labels=pending-triage&projects=&template=2.feature_request.yaml) in our github repository.</Callout>

The input options below have been removed in v6 from Storage APIs:

- `provider`: _Custom providers are no longer supported in v6. All examples below use the input/output values expected from the Default AWSS3Provider._
...
- `track`: _Auto-tracking Storage events in pinpoint is Deprecated in V6. You can track Storage events [using the Analytics category](/[platform]/build-a-backend/more-features/analytics/record-events/)._
...
- `$metadata`: _Debugging information like `httpStatusCode` and `attempts` will be reintroduced in an upcoming release focused on changes to logging._
- `bucket`: _The `bucket` is required for `Storage` configuration and has therefore been removed from input options._

>Note: We have remapped all capitalized input and output keys to camel case in v6.
...
- The `resumable` option has been removed from `config` as all upload tasks are resumable in v6. You can find the `pause`, `resume`, and `cancel` functions on the `uploadData` output. See [the v6 Storage documentation](/[platform]/build-a-backend/storage/upload/#pause-and-resume-upload) for details.
  ...
  <Columns columns={2}>
    <div>
      **V5**
      ...
      key: string
      object: {
        ACL?: string; // Deprecated in V6
        CacheControl?: string; // Deprecated in V6
        ContentDisposition? string;
        ContentEncoding?: string;
        ContentMD5?: string;
        ContentType?: string;
        Expires?: Date; // Deprecated in V6
        Metadata?: Record<string, string>;
        ServerSideEncryption?: string; // Deprecated in V6
        SSECustomerAlgorithm?: string; // Deprecated in V6
        SSECustomerKey?: string; // Deprecated in V6
        SSECustomerKeyMD5?: string; // Deprecated in V6
        SSEKMSKeyId?: string; // Deprecated in V6
        Bucket: string;
        Key: string;
        Body?: string | ReadableStream<any> | Blob | Uint8Array | Buffer;
        Tagging?: string; // Deprecated in V6
      }
      // non-resumable config
      config?: {
        level?: 'public' | 'protected' | 'private';
        provider?: string; // Deprecated in V6
        customPrefix?: { // Deprecated in V6
          private?: string;
          public?: string;
          protected?: string;
        };
        track?: boolean; // Deprecated in V6
    ...
    <div>
      **V5**
      ...
      options: {
        ...
        track?: boolean; // Deprecated in V6
        download?: boolean; // Deprecated in V6
        expires?: number;
        identityId?: string;
        progressCallback?: (progress: any) => any;
        cacheControl?: string; // Deprecated in V6
        contentDisposition?: string; // Deprecated in V6
        contentEncoding?: string; // Deprecated in V6
        contentLanguage?: string; // Deprecated in V6
        contentType?: string; // Deprecated in V6
        SSECustomerAlgorithm?: string; // Deprecated in V6
        SSECustomerKey?: string; // Deprecated in V6
        SSECustomerKeyMD5?: string; // Deprecated in V6
  ...
  <Columns columns={2}>
    <div>
      **V5**
      ...
      S3ProviderGetOutput {
        Body?: Blob;
        DeleteMarker?: boolean; // Deprecated in V6
        AcceptRanges?: string; // Deprecated in V6
        Expiration?: string; // Deprecated in V6
        Restore?: string; // Deprecated in V6
        LastModified?: Date;
        ContentLength?: number;
        ETag?: string;
        ChecksumCRC32?: string; // Deprecated in V6
        ChecksumCRC32C?: string; // Deprecated in V6
        ChecksumSHA1?: string; // Deprecated in V6
        ChecksumSHA256?: string; // Deprecated in V6
        MissingMeta?: number; // Deprecated in V6
        VersionId?: string; // Deprecated in V6
        CacheControl?: string; // Deprecated in V6
        ContentDisposition?: string; // Deprecated in V6
        ContentEncoding?: string; // Deprecated in V6
        ContentLanguage?: string; // Deprecated in V6
        ContentRange?: string; // Deprecated in V6
        ContentType?: string;
        Expires?: Date; // Deprecated in V6
        WebsiteRedirectLocation?: string; // Deprecated in V6
        ServerSideEncryption?: ServerSideEncryption | string; // Deprecated in V6
        Metadata?: Record<string, string>;
        SSECustomerAlgorithm?: string; // Deprecated in V6
        SSECustomerKeyMD5?: string; // Deprecated in V6
        SSEKMSKeyId?: string; // Deprecated in V6
        BucketKeyEnabled?: boolean; // Deprecated in V6
        StorageClass?: StorageClass | string; // Deprecated in V6
        RequestCharged?: RequestCharged | string; // Deprecated in V6
        ReplicationStatus?: ReplicationStatus | string; // Deprecated in V6
        PartsCount?: number; // Deprecated in V6
        TagCount?: number; // Deprecated in V6
        ObjectLockMode?: ObjectLockMode | string; // Deprecated in V6
        ObjectLockRetainUntilDate?: Date; // Deprecated in V6
        ObjectLockLegalHoldStatus?: ObjectLockLegalHoldStatus | string; // Deprecated in V6
        $metadata: { // Deprecated in V6
...
In addition to [the changes mentioned above](/[platform]/build-a-backend/storage/storage-v5-to-v6-migration-guide/#deprecated-options), the `copy` API in v6 no longer supports content options (`contentDisposition`, `contentLanguage`, and `contentType`) as they override options selected on the original file `upload` and have caused complexity in implementation.
  ...
  <Columns columns={2}>
    <div>
      **V5**
      ...
      DeleteMarker?: boolean; // Deprecated in V6
      VersionId?: string; // Deprecated in V6
      RequestCharged?: 'requester' | string; // Deprecated in V6
      $metadata: { // Deprecated in V6
        httpStatusCode?: number;
        requestId?: string;
    ...
    <div>
      **V5**
      ...
      StorageListOutput {
        ...
        nextToken?: string;
        hasNextToken: boolean; // Deprecated in V6
      };
