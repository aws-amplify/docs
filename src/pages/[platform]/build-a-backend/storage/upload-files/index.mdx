...
Option | Type | Description |
| -- | -- | ----------- |
| bucket | String \| <br />\{ bucketName: string;<br/> region: string; \} | A string representing the target bucket's user defined alias or an object specifying the bucket name and region as strings.<br/><br/> Read more at [Multi-Bucket](/[platform]/build-a-backend/storage/multi-bucket) |
