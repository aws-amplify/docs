...
export const meta = {
  title: 'Manage files in Amplify console',
  description:
    'Manage your applications storage files in Amplify console',
  platforms: [
    'android',
    'angular',
    'flutter',
...
The **File storage** in the Amplify Console provides a user-friendly interface for managing your application's backend file storage. It allows for efficient testing and management of your files.
...
<video autoPlay={true} muted={true} loop={true} width="100%" playsInline={true}>
  <source src="/images/gen2/manage/storage-manager.mp4" />
</video>
