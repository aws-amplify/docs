...
[Get URL API usage](/gen2/build-a-backend/storage/download-files/get-url)
</Card>
<Card variation="outlined">
[Download data API usage](/gen2/build-a-backend/storage/download-files/download-data)
</Card>
</Columns>
