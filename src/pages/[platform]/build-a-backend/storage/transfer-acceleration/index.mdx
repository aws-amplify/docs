...
- `getUrl(key:options:)` (Deprecated)
- `downloadData(key:options:)` (Deprecated)
- `downloadFile(key:local:options:)` (Deprecated)
- `uploadData(key:data:options:)` (Deprecated)
- `uploadFile(key:local:options:)` (Deprecated)
