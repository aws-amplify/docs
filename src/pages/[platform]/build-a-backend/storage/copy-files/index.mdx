...
Alternatively, specify a non-default bucket target by including `bucket` in both the source and destination objects. See [Multi-Bucket Support](/[platform]/build-a-backend/storage/multi-bucket) for more information.
