...
export const meta = {
  ...
  platforms: ['javascript', 'react-native', 'flutter','angular','nextjs','react','vue'] 
};
...
The v6 Developer Preview doesn't support all categories yet. If your application uses any of the unsupported categories, you will need to remove this usage to test out the developer preview changes with your existing application.
