...
```tsx title="module-fetch-auth.ts"
...
If you are working in a multi-page app, you can call `Amplify.configure` in a common source file and import it into each page.
