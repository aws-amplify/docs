...
You must **not** hoist any variables, object references created within the callback function (e.g., the `contextSpec` parameter), or your business logic to an outer scope, as it may lead to cross-request pollution.
