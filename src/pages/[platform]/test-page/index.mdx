...
<Accordion title="An accordion with heading level 2" eyebrow="Heading test" headingLevel="2">

Here is some content inside of the accordion.

</Accordion>

<Accordion title='Understanding Auth high-level concepts' headingLevel='2' eyebrow='Learn more'>
