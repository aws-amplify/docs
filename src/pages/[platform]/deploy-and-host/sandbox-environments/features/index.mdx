...
```bash title="Terminal" showLineNumbers={false}
npx ampx sandbox --config-out-dir path/to/config --config-format ["mjs", "json", "json-mobile", "ts", "dart"]
```
...
```bash title="Terminal" showLineNumbers={false}
npx ampx sandbox --config-format json-mobile --config-out-dir app/src/main/res/raw
```
</InlineFilter>
...
```bash title="Terminal" showLineNumbers={false}
npx ampx sandbox --config-format json-mobile
```
...
```bash title="Terminal" showLineNumbers={false}
npx ampx generate config --app-id <app-id> --branch main --format json-mobile --out-dir app/src/main/res/raw
```
</InlineFilter>
<InlineFilter filters={['swift']}>
...
<InlineFilter filters={['android']}>
```bash title="Terminal" showLineNumbers={false}
npx ampx generate graphql-client-code --format modelgen --model-target java --out app/src/main/java
```
</InlineFilter>
<InlineFilter filters={['flutter']}>
```bash title="Terminal" showLineNumbers={false}
