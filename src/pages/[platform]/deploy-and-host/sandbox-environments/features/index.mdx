...
Alternatively, if you want to generate the config for a branch environment to test against, you can follow the following command template below in the terminal:
