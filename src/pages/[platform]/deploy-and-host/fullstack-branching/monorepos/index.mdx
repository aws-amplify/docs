...
npx ampx generate config --branch main --app-id BACKEND-APP
```
</InlineFilter>

<InlineFilter filters={['flutter']}>
```bash title="Terminal" showLineNumbers={false}
npx ampx generate config --app-id BACKEND-APP --branch main --format dart --out-dir lib
```
</InlineFilter>
...
```bash title="Terminal" showLineNumbers={false}
npx ampx generate config --app-id BACKEND-APP --branch main --format json-mobile --out-dir app/src/main/res/raw
```
</InlineFilter>

<InlineFilter filters={['swift']}>
```bash title="Terminal" showLineNumbers={false}
npx ampx generate config --app-id BACKEND-APP --format json-mobile
```
