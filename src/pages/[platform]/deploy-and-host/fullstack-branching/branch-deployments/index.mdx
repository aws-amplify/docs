...
```bash title="Terminal" showLineNumbers={false}
npx amplify generate config --app-id <your-amplify-app-id> --branch main --out-dir path/to/config
```
</InlineFilter>
...
```bash title="Terminal" showLineNumbers={false}
npx amplify generate config --app-id <your-amplify-app-id> --branch main --format json-mobile --out-dir app/src/main/res/raw
```
</InlineFilter>
<InlineFilter filters={['flutter']}>
```bash title="Terminal" showLineNumbers={false}
npx amplify generate config --app-id <your-amplify-app-id> --branch main --format dart --out-dir lib
```
</InlineFilter>
<InlineFilter filters={['swift']}>
```bash title="Terminal" showLineNumbers={false}
npx amplify generate config --app-id <your-amplify-app-id> --format json-mobile
```
