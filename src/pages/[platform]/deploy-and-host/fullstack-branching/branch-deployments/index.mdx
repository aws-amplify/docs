...
```bash title="Terminal" showLineNumbers={false}
npx amplify generate outputs --app-id <your-amplify-app-id> --branch main --out-dir path/to/config
```
</InlineFilter>
...
```bash title="Terminal" showLineNumbers={false}
npx amplify generate outputs --app-id <your-amplify-app-id> --branch main --format dart --out-dir lib
```
</InlineFilter>
<InlineFilter filters={['swift']}>
```bash title="Terminal" showLineNumbers={false}
npx amplify generate outputs --app-id <your-amplify-app-id>
```
