...
By default, the framework is auto-detected from your `package.json`. Supported frameworks include `nextjs`, `nuxt`, `astro`, `nitro`, `spa`, and `static`. You can optionally override the framework detection if needed.
