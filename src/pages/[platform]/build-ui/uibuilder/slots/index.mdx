...
<br />
Automatic nested data fetching for many-to-many relationships is currently not supported. Component slots only automatically fetch data for [has One](/cli/graphql/data-modeling/#has-one-relationship) and [has Many relationships](/cli/graphql/data-modeling/#has-many-relationship), like one Post to many Comments.
