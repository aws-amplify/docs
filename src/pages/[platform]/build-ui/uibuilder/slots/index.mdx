...
3. Select a Figma component from your UI Library that you've imported into Studio. _If you don't have any Figma components already, you can start with [Amplify's Figma UI file](/console/uibuilder/figmatocode/)._
