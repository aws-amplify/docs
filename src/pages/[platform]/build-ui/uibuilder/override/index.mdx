...
**Note:** Amplify Studio now provides a new experience to build React forms. We recommend that you review [Form Builder (React)](/console/formbuilder/overview) first before using the data action bindings documented below.
