...
- You must have Amplify Authentication, [either through Studio](/[platform]/tools/console/auth//) or [through the CLI](/[platform]/tools/cli/auth/)
...
- You must have a GraphQL API, deployed either [through Studio](/[platform]/tools/console/data/data-model//) or [through the CLI](/[platform]/tools/cli/graphqlapi/).
