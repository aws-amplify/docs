...
With the [GraphQL Transformer v2](/[platform]/tools/cli/graphqlapi/), Amplify introduces as a range of new features to help customers create app backends even faster and easier.
...
- I use a custom resolver in my GraphQL API
  - To add a custom resolver in the new GraphQL Transformer follow the instructions [here](/[platform]/tools/cli/graphqlapi/custom-business-logic/#vtl-resolver).
- I have overwritten Amplify-generated resolvers by placing custom .vtl files in the resolvers/ folder.
  - In GraphQL Transformer v2, all resolvers are “pipeline resolvers”, this means we provide you more modularity and flexibility when customizing the auto-generated resolvers.
    ...
    - Review how to [extend Amplify-generated resolvers](/[platform]/tools/cli/graphqlapi/custom-business-logic/#extend-amplify-generated-resolvers)
