...
**DataStore (Swift)** now supports [Bi-directional “has one” relationship](/[platform]/tools/cli/graphqlapi/data-modeling//#belongs-to-relationship). Previously, due to Swift language limitations the generated Swift model types will not compile.
