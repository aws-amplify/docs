...
```graphql
mutation CreatePost {
<<<<<<< HEAD:src/pages-old/cli/graphql/data-modeling.mdx
  createPost(input: { title: "Hello World!!" }) {
=======
  title: 'Customize your data model',
>>>>>>> next-release/main:src/pages/[platform]/tools/cli/graphqlapi/data-modeling/index.mdx
    title
    id
    comments {
      items {
...
Project --> Team : team @hasOne
Team --> Project : project @belongsTo
```
