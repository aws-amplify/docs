...
export const meta = {
  ...
  description:
    'Configure the Amplify CLI to use existing Amazon Cognito User Pool and Identity Pool resources as an authentication & authorization mechanism for other Amplify categories. (API, Storage, and more)',
  platforms: [
    'android',
    'angular',
    'flutter',
