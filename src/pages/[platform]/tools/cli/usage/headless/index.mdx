...
Contains configuration for AppSync [codegen](/[platform]/tools/cli/graphqlapi/client-code-generation/), the following are the specifications:
...
Pushes schema changes that require removal or replacement of underlying tables. See [update schema](/[platform]/tools/cli/graphqlapi/#update-schema).
