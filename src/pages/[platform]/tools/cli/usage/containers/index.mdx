...
- [JavaScript GraphQL configuration](/[platform]/build-a-backend/graphqlapi/connect-to-api/#configure-the-amplify-library)
- [JavaScript REST configuration](/[platform]/build-a-backend/restapi/set-up-rest-api/#manual-setup-import-existing-rest-api)
- [Android GraphQL configuration](/[platform]/build-a-backend/graphqlapi/existing-resources/)
- [Android REST configuration](/[platform]/build-a-backend/restapi/set-up-rest-api/)
- [iOS GraphQL configuration](/[platform]/build-a-backend/graphqlapi/existing-resources/)
