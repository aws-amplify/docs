...
We can also use Amplify CLI to [import a Cognito user pool resource](/[platform]/tools/cli/auth/import/).
...
We can also use Amplify CLI to [import a Cognito identity pool resource](/[platform]/tools/cli/auth/import/).
