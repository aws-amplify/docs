...
export const meta = {
  ...
  description:
    'Configure Amplify Studio to use existing Amazon Cognito user pool and identity pool resources as an authentication and authorization mechanism for other Amplify categories ( For example, API, Storage, and more).',
  platforms: [
    'android',
    'angular',
    'flutter',
