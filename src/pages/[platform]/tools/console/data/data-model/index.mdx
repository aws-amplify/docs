...
To interface with your data while Conflict Resolution is enabled, you will likely be using [DataStore syntax](/[platform]/build-a-backend/datastore/manipulate-data//q/platform/js/). However, if Conflict Resolution is disabled, any data interactions must be updated to use [GraphQL syntax](/[platform]/build-a-backend/graphqlapi/mutate-data/) instead.
...
- [`@default` directive](/[platform]/tools/cli/graphqlapi/data-modeling/#assign-default-values-for-fields)
- [`@index` directive](/[platform]/tools/cli/graphqlapi/data-modeling/#configure-a-secondary-index)
- [`@function` directive](/[platform]/tools/cli/graphqlapi/custom-business-logic/#lambda-function-resolver)
- [`@http` directive](/[platform]/tools/cli/graphqlapi/custom-business-logic/#http-resolver)
- [`@predictions` directive](/[platform]/tools/cli/graphqlapi/connect-machine-learning-services/)
- [`@primaryKey` directive](/[platform]/tools/cli/graphqlapi/data-modeling/#configure-a-primary-key)
- [`@searchable` directive](/[platform]/tools/cli/graphqlapi/search-and-result-aggregations/)
- [`@mapsTo` directive](/[platform]/tools/cli/graphqlapi/schema-evolution/)
- [`@auth` `groupClaim` property](/[platform]/build-a-backend/graphqlapi/customize-auth/#user-group-based-data-access)
- [`@auth` `groupsField` property](/[platform]/build-a-backend/graphqlapi/customize-auth/#field-level-authorization-rules)
- [`@auth` custom `groupClaim`](/[platform]/build-a-backend/graphqlapi/customize-auth/#configure-custom-identity-and-group-claims)
- [`@auth` custom `identityClaim`](/[platform]/build-a-backend/graphqlapi/customize-auth/#configure-custom-identity-and-group-claims)
- [`@auth` field-level rules](/[platform]/build-a-backend/graphqlapi/customize-auth/#field-level-authorization-rules)
- [OIDC and Function providers](/[platform]/build-a-backend/graphqlapi/customize-auth/#using-oidc-authorization-provider)
- [OwnerField as Array type](/[platform]/build-a-backend/graphqlapi/customize-auth/#multi-user-data-access)
- [`Query` type](/[platform]/tools/cli/graphqlapi/custom-business-logic/#create-a-custom-query-or-mutation)
- [`Mutation` type](/[platform]/tools/cli/graphqlapi/custom-business-logic/#create-a-custom-query-or-mutation)
- [`Subscription` type](/[platform]/tools/cli/graphqlapi/custom-business-logic/#create-a-custom-query-or-mutation)
