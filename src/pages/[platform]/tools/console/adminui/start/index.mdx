...
Amplify provisions AWS resources directly in your account. Changes to resources can lead to unexpected behavior, so we recommend using a dedicated AWS account for building with Amplify.
