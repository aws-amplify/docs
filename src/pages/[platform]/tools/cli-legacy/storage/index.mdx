...
This documentation references the AWS AppSync SDK for JavaScript (V2), which is now in Maintenance mode. Please refer to the [Upgrade Guide](/[platform]/build-a-backend/graphqlapi/upgrade-guide/) and the [Working with Files](/[platform]/build-a-backend/graphqlapi/connect-to-api/) guide for updated guidance.
