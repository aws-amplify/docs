...
**Note:** If you are working with an older project you can also review the configuration properties for the [previous version](/[platform]/prev/tools/libraries/configure-categories/) for your chosen framework or language.
