...
If you prefer a manual setup, skip to the end of this step. Otherwise, to get started open CloudShell, located in the console footer.
...
- Now you are ready to sign in to the access portal. Navigate back to the IAM Identity Center dashboard. Within the **Settings summary** pane, copy the AWS access portal URL which is your **Start Session URL**.
