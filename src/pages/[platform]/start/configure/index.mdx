...
Before you get started, you will need to [create an AWS Account](https://portal.aws.amazon.com/billing/signup?redirect_url=https%3A%2F%2Faws.amazon.com%2Fregistration-confirmation#/start). Additionally, if you have not yet created an Amplify Gen 2 app, visit the [quickstart](/[platform]/start/quickstart).

Inside your Amplify Gen 2 project, use [`amplify configure profile`](/[platform]/reference/cli-commands#amplify-configure-profile) to configure your local AWS profile:
...
- [Learn more about account setup](/[platform]/start/account-setup)
