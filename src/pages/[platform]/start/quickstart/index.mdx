...
Go to the **src/toods/todos.component.ts** file and add a new `deleteTodo` function.

```tsx title="src/toods/todos.component.ts"
@Component {
  // ...
  // highlight-start
...
```html title="src/toods/todos.component.html"
...
  <ul>
