...
```bash title="Terminal" showLineNumbers={false}
cd my-android-app
npx ampx generate graphql-client-code --format modelgen --model-target java --out app/src/main/java --app-id <your-amplify-app-id> --branch main
```
...
```bash showLineNumbers={false}
npx ampx generate outputs --out-dir app/src/main/res/raw --app-id <your-amplify-app-id> --branch main
```
