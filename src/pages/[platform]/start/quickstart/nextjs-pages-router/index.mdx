...
This quickstart uses Amplify Hosting for deployment. You can also [deploy to your own AWS account](/[platform]/deploy-and-host/self-hosting/) with full infrastructure control.
