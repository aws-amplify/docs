...
Project setup guides are available for the [previous version](/[platform]/prev/start/project-setup/prerequisites/). However, we highly recommend using the latest version and following this guide when setting up new projects.
