...
Project setup guides are available for the [previous version](/[platform]/prev/start/project-setup/prerequisites/). However, it is highly recommended that you use the latest version to set up new projects following this guide.
