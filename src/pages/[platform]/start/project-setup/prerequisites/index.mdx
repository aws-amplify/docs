...
export const meta = {
  ...
  platforms: ['javascript', 'react', 'nextjs', 'angular', 'vue', 'swift', 'android', 'react-native', 'flutter']
};
...
We highly recommend using the latest version and following this guide when setting up new projects. However, project setup guides are available for the [previous version](/[platform]/prev/start/project-setup/prerequisites/) if needed. 
