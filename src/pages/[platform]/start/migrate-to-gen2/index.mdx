...
```bash title="Terminal" showLineNumbers={false}
npx @aws-amplify/migrate@0.1.0-next-5.0 to-gen-2 prepare
```
...
```bash title="Terminal" showLineNumbers={false}
npx @aws-amplify/migrate@0.1.0-next-5.0 to-gen-2 execute \
...
```bash title="Terminal" showLineNumbers={false}
npx @aws-amplify/migrate@0.1.0-next-5.0 to-gen-2 revert \
