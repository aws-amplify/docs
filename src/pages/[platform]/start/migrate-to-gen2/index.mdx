...
We will need to add the following manually to `backend.ts` file to set up the additional user pool client for your `Identity providers`. This is needed since Gen 2 only supports 1 user pool client out-of-the-box:
