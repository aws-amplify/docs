...
<<<<<<< HEAD:src/pages/[platform]/start/migrate-to-gen2/index.mdx
| Add User pool groups | Yes | Yes |
=======
| Add user pool groups | Yes | Yes |
>>>>>>> next-release/main:src/pages/[platform]/start/gen1-gen2/index.mdx
...
| Custom Mutation, Query, Subscription | Yes | Yes |
...
<<<<<<< HEAD:src/pages/[platform]/start/migrate-to-gen2/index.mdx
| MySQL and Postgres support | No | Yes |
=======
