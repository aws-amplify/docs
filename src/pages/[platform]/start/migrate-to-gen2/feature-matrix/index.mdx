...
The tool can produce Gen 2 code, but the feature requires refactoring support which the tool does not have. You will need to perform manual data replication. For example, Geo (GeofenceCollection) can be code-generated but the existing geofence data cannot be automatically moved to the new Gen 2 resource.
