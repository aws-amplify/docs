...
Now that you have a conceptual understanding of AWS Amplify's code-first (Gen 2) capabilities, complete the [quickstart tutorial](/[platform]/start/quickstart/) to put it into action in an app.
