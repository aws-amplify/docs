...
We recommend using Amplify’s tooling-first (Gen 1) developer experience with the CLI and Studio to get access to our complete feature set. If your primary use cases are configuring Auth or Data, we recommend starting with our [L3 CDK constructs](/[platform]/reference/cdk-constructs/) that power the Gen 2 experience.
