...
export const meta = {
  ...
  description: 'Learn more about how to enable triggers for the Storage Category with Amazon S3 and Amazon DynamoDB as Providers. The CLI supports associating Lambda triggers with S3 and DynamoDB events. ',
