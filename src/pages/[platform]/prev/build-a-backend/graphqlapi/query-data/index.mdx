...
- An [application connected to the API](/[platform]/prev/build-a-backend/graphqlapi/set-up-data/)
- Data already created to view
...
To learn more, see [Authorization rules](/[platform]/build-a-backend/graphqlapi/customize-auth//) for the GraphQL API.
...
- [Authorization rules](/[platform]/build-a-backend/graphqlapi/customize-auth/)
- [Data modeling](/[platform]/tools/cli/graphqlapi/data-modeling/)
- [Custom business logic](/[platform]/tools/cli/graphqlapi/custom-business-logic/)
