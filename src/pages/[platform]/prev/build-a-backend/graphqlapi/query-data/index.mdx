...
export const meta = {
  ...
  platforms: ['flutter', 'swift', 'android', 'javascript', 'react-native','angular','nextjs','react','vue'] 
};
...
- An [application connected to the API](/lib-v1/graphqlapi/connect/q/platform/js/)
...
- An [application connected to the API](/lib-v1/graphqlapi/getting-started/q/platform/react-native/)
- Data already created to view
...
- Sorting is [available in DataStore](/lib-v1/datastore/data-access/q/platform/js/#predicates) but not in AWS AppSync.
...
- There is no API to get a total page count at this time. Note that scanning all items is a [potentially expensive operation](https://github.com/aws-amplify/amplify-js/issues/2901).
- Sorting is [available in DataStore](/lib-v1/datastore/data-access/q/platform/react-native/#predicates) but not in AWS AppSync.
- AWS AppSync schemas do not follow the edges/nodes of the [Relay spec](https://relay.dev/docs/guides/graphql-server-specification) but are spiritually similar.
- You [cannot query by `page` number](https://github.com/aws-amplify/amplify-cli/issues/5086); you have to query by `nextToken`.
...
- [Subscribe to real-time events](/lib-v1/graphqlapi/subscribe-data/q/platform/js/)
...
- [Subscribe to real-time events](/lib-v1/graphqlapi/subscribe-data/q/platform/react-native/)
- [Authorization rules](/cli/graphql/authorization-rules/)
- [Data modeling](/cli/graphql/data-modeling/)
- [Custom business logic](/cli/graphql/custom-business-logic/)
