...
First, install the `@aws-amplify/ui-react@^5.0` library as well as `aws-amplify` if you have not already:

```sh
npm install aws-amplify@^5.0 @aws-amplify/ui-react@^5.0
```
...
First, install the `@aws-amplify/ui-vue@^3.0` library as well as `aws-amplify` if you have not already:

```bash
npm install aws-amplify@^5.0 @aws-amplify/ui-vue@^3.0
```
...
```bash
npm install aws-amplify@^5.0 @aws-amplify/ui-components@^0
```
...
First, install the `@aws-amplify/ui-angular@^4.0` library as well as `aws-amplify` if you have not already:

```bash
npm install aws-amplify@^5.0 @aws-amplify/ui-angular@^4.0
```
