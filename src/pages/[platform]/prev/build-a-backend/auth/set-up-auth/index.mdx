...
export const meta = {
  ...
  platforms: ['flutter', 'swift', 'android', 'javascript', 'angular', 'nextjs', 'react', 'react-native', 'vue']
};
...
<Fragments fragments={{ javascript: js_authenticator_support }} />
...
<Callout warning={true}>
  If your existing user pool client has a required attribute that is NOT set to
...
The v6 Developer Preview is not yet compatible with the Amplify Authenticator component. To integrate Auth with your application, you will need to build your own interface and invoke the auth APIs. Please review the [_Enable Sign-up, Sign-in, and Sign-out_](/lib/auth/emailpassword/q/platform/js/) guide for more information on these APIs.
