...
You can use AWS _Service Interface Objects_ to work AWS Services in authenticated State. You can call methods on any AWS Service interface object by passing your credentials from Amplify to the service call constructor:
