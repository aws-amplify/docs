...
export const meta = {
  ...
  platforms: ['javascript', 'flutter', 'react-native']
};
...
- [Switching authentication flows](/lib-v1/auth/switch-auth/q/platform/js/)
- [Advanced workflows](/lib-v1/auth/advanced/q/platform/js/)

</InlineFilter>

<InlineFilter filters={["react-native"]}>

- [Switching authentication flows](/lib-v1/auth/switch-auth/q/platform/react-native/)
- [Advanced workflows](/lib-v1/auth/advanced/q/platform/react-native/)
