...
- `myapp://`
- `exp://127.0.0.1:19000/--/` (Local development if your app is running [in the Expo client](https://docs.expo.dev/guides/linking/?redirected#linking-to-your-app)).
...
The sample below uses Expo's [WebBrowser.openAuthSessionAsync](https://docs.expo.dev/versions/latest/sdk/webbrowser/?redirected#webbrowseropenauthsessionasyncurl-redirecturl-options).
