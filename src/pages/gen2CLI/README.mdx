...
**Ways of working:** The `Stage-Gen2CLI` is a staging branch for drafts and fastest workflow. Please commit your drafting branches into this one for your PR reviews with the team. When you have final copy ready, you can then submit PRs to `next-release/main` where we are staging additional changes for a larger site update. Please note that PRs into `next-release/main` will require additional approvals.
