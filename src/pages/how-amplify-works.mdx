...
Learn more about connecting to existing AWS resources for both web and mobile.
...
The following diagram outlines a few scenarios you could implement with Amplify. The purple stages are data displayed by AWS Amplify, the pink ones are backend resources provisioned by Amplify, and the service icons are the underlying resources Amplify deploys for you.
...
## CTA to start the [getting started tutorial](https://docs.amplify.aws/start/q/integration/js/#what-youll-build)
