  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="AWS Amplify Contributor Program - Getting Started"
          key="title"
        />
        ...
        <meta
          ...
          content="The steps below will help you get set up to open a pull request in the Amplify JS project. The Amplify Contributor Program is an open invitation for you to participate in the Amplify open source development journey."
        />
        ...
        <meta property="og:url" content="https://contributetoamplify.com" />
        <meta property="og:locale" content="en-us" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@AWSAmplify" />
        <meta name="twitter:creator" content="@AWSAmplify" />
        <meta
          name="twitter:title"
          content="Amplify Contributor Program - Getting Started"
        />
        <meta
          name="twitter:description"
          content="The Amplify Contributor Program is an open invitation for you to participate in the Amplify open source development journey. Get involved with AWS Amplify by making open source contributions to the Amplify JS project!"
        />
        <meta
          property="twitter:image"
          content="https://contributetoamplify.com/contributor-bash-og-image.png"
        />
        <meta name="twitter:domain" content="https://contributetoamplify.com" />
      </Head>
