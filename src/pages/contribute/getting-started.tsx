...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>AWS Amplify Contributor Program - Getting Started</title>
        ...
        /> */}
        <meta name="twitter:domain" content={'https://docs.amplify.aws'} />
      </Head>
          ...
          >
            <Flex direction="column">
              ...
              <Text fontSize={'large'} color="brand.squidInk">
                The steps below will help you get set up to open a pull request
                in the Amplify JS project. Check out the{' '}
                <Code>CONTRIBUTING.md</Code> in each project's repository for
                instructions on how to get started with local environment set
                up.
              </Text>
              <Text fontSize={'large'} color="brand.darkSquidInk">
                The Amplify Contributor Program is an open invitation for you to
                participate in the Amplify open source development journey. It
                is a great way to learn more about the Amplify ecosystem and
                make constructive, helpful pull requests. It builds your resume
                by demonstrating that you can collaborate with others on code,
                and it feels good to give back to a project you use! We're
                looking forward to developing with you!
              </Text>
            </Flex>
            <Flex direction="column">
            ...
            <Flex direction="column">
              ...
              <Flex direction="column" gap="1em">
                <ol>
                  ...
                  <li>
                    <Text fontSize={'large'}>
                      Open VS Code and clone your fork down to your machine so
                  ...
                  <li>
                    <Text fontSize={'large'}>
                      Run <Code>git status</Code> before you start coding to
                      make sure everything in the project files are updated with
                      the <Code>origin/main</Code> branch.
                    </Text>
                    <SyntaxHighlighter language="bash">{_4a}</SyntaxHighlighter>
                  </li>
                  <li>
                    <Text fontSize={'large'}>
                      Use one of the commands below to create a new branch
                      within your fork.
                    </Text>
                    ...
                    <Flex direction="column" margin="1em 1em">
                      ...
                      <Text fontSize={'large'}>
                        ...
                        The <Code color="brand.rind">short-token</Code> can be
                        one of the following: <Code>feat</Code>,{' '}
                        <Code>chore</Code>, or <Code>bug</Code>.
                      </Text>
                      <Text fontSize={'large'}>
                        <Icon color="brand.sky" width="25px" height="25px">
                          <MdOutlineInfo />{' '}
                        </Icon>
                        The <Code color="brand.rind">branch-name</Code> should
                        be representative of the feature or fix.
                      </Text>
                    </Flex>
                  </li>
                  <li>
                ...
                <Text fontSize={'large'}>
                  ...
                  reviews. For such cases it might take up to 4 weeks to
                  complete the review. Make sure to address any automated check
                  that fail (such as linting, unit tests, etc. in the CI
                  pipeline). Finally, once your changes meet the requirements
                  and checks, the team will merge your changes into the Amplify
                  JS repo.
                </Text>
            ...
            <Flex direction="column">
              ...
              <Flex direction="column">
                ...
                <Text fontSize={'large'}>
                  Please read through these guidelines carefully before
                  submitting a PR.
                </Text>
