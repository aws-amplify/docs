...
| [`amplify env update [--permissions-boundary <IAM Policy ARN>]`](/legacy/gen1/[platform]/tools/cli/project/permissions-boundary/) | Updates the environment's IAM Permissions Boundary |
