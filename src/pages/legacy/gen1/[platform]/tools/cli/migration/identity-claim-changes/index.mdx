...
Learn more about [configuring the `@index` directive here](/legacy/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/#configure-a-secondary-index).
