...
Contains configuration for AppSync [codegen](/legacy/gen1/[platform]/build-a-backend/graphqlapi/client-code-generation/), the following are the specifications:
...
Pushes schema changes that require removal or replacement of underlying tables. See [update schema](/legacy/gen1/[platform]/build-a-backend/graphqlapi/#update-schema).
