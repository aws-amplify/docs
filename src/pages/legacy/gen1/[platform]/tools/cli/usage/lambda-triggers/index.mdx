...
- As a part of the [Storage category](/legacy/gen1/[platform]/build-a-backend/storage/configure-storage/#)
- As a part of the [GraphQL API (types with @model annotation)](/legacy/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/)
