...
<MigrationAlert isLegacy url={'/legacy/gen1/[platform]/build-a-backend/graphqlapi/'} />
...
- [`@model`: Defines top level object types in your API that are backed by Amazon DynamoDB](/legacy/gen1/[platform]/tools/cli-legacy/model-directive/)
- [`@key`: Configures custom index structures for @model types](/legacy/gen1/[platform]/tools/cli-legacy/key-directive/)
- [`@auth`: Defines authorization rules for your @model types and fields](/legacy/gen1/[platform]/tools/cli-legacy/auth-directive/)
- [`@connection`: Defines 1:1, 1:M, and N:M relationships between @model types](/legacy/gen1/[platform]/tools/cli-legacy/connection-directive/)
- [`@function`: Configures a Lambda function resolvers for a field](/legacy/gen1/[platform]/tools/cli-legacy/function-directive/)
- [`@http`: Configures an HTTP resolver for a field](/legacy/gen1/[platform]/tools/cli-legacy/http-directive/)
- [`@predictions`: Queries an orchestration of AI/ML services such as Amazon Rekognition, Amazon Translate, and/or Amazon Polly](/legacy/gen1/[platform]/tools/cli-legacy/predictions-directive/)
- [`@searchable`: Makes your data searchable by streaming it to Amazon OpenSearch](/legacy/gen1/[platform]/tools/cli-legacy/searchable-directive/)
- [`@versioned`: Defines the versioning and conflict resolution strategy for an @model type](/legacy/gen1/[platform]/tools/cli-legacy/versioned-directive/)
...
> Looking to build your own transformers & directives? Check out the guide on [how to author your own transformer & directives](/legacy/gen1/[platform]/tools/cli/plugins/authoring/#authoring-custom-graphql-transformers--directives).
