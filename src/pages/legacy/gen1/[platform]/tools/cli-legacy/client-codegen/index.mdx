...
<MigrationAlert
  isLegacy
  url={'/legacy/gen1/[platform]/build-a-backend/graphqlapi/client-code-generation/'}
/>
...
After completing the [Amplify Getting Started](/legacy/gen1/[platform]/start/getting-started/introduction/) navigate in your terminal to an Xcode project directory and run the following:
...
After completing the [Amplify Getting Started](/legacy/gen1/[platform]/start/getting-started/introduction/) navigate in your terminal to an Android Studio project directory and run the following:
