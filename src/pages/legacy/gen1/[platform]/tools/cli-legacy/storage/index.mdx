...
This documentation references the AWS AppSync SDK for JavaScript (V2), which is now in Maintenance mode. Please refer to the [Upgrade Guide](/legacy/gen1/[platform]/build-a-backend/graphqlapi/upgrade-guide/) and the [Working with Files](/legacy/gen1/[platform]/build-a-backend/graphqlapi/working-with-files/) guide for updated guidance.
