...
1. [Lambda functions](/legacy/gen1/[platform]/build-a-backend/functions/set-up-function/)
2. [Resource overrides](/legacy/gen1/[platform]/tools/cli/commands/#override)
...
The errors mentioned above occur during deployment if your Amplify project contains an `override.ts` file or [custom resources](/legacy/gen1/[platform]/tools/cli/custom/cdk/) are deployed. Amplify Studio does not support deploying projects with override files or custom resources.
