...
AWS Amplify Studio is a visual development environment for building fullstack web and mobile apps. To learn more, see the [Amplify Studio introduction](/legacy/gen1/[platform]/tools/console).
...
If you have [created a new Amplify project through the CLI](/legacy/gen1/[platform]/tools/cli/start/key-workflows/#initialize-new-project), Studio will need to be activated before it can be launched. Use the following steps:
...
- [Build a data model](/legacy/gen1/[platform]/tools/console/data/data-model/)
<InlineFilter filters={['javascript', 'react', 'nextjs']}>
- [Create UI components in Figma](/legacy/gen1/[platform]/build-ui/uibuilder/)
</InlineFilter>
- [Invite your team members to collaborate](/legacy/gen1/[platform]/tools/console/adminui/access-management/)
