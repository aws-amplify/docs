...
The [Data modeling](/legacy/gen1/[platform]/tools/console/data/data-model/) documentation guides you through several examples for creating data models and setting the relationships between them. The following data management procedures, reference the *Book* and *Author* tables that were created in the data modeling example in order to demonstrate how to perform operations on your data.
...
To use these features, you can add DataStore to your app by [adjusting your Conflict Resolution settings.](/legacy/gen1/[platform]/tools/console/data/data-model/#datastore-and-graphql)
...
This limitation does not apply to GraphQL APIs with [Conflict Resolution disabled](/legacy/gen1/[platform]/tools/console/data/data-model/#datastore-and-graphql).
