...
Clone the [example data model](/legacy/gen1/[platform]/tools/console/data/data-model/#data-modeling-example) to follow along
...
4. Navigate to the **Content** tab and create data in the tables. You should be able to create and link records from different models. For more information, see [Manage content](/legacy/gen1/[platform]/tools/console/data/content-management/).
