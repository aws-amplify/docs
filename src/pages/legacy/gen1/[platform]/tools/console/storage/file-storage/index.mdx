...
[Learn more about how to import file storage.](/legacy/gen1/[platform]/build-a-backend/storage/import/#connect-to-an-imported-s3-bucket-with-amplify-libraries)
...
[Learn more about how to configure IAM roles for imported file storage](/legacy/gen1/[platform]/build-a-backend/storage/import/#configuring-iam-role-to-use-amplify-recommended-policies)
