...
In [Amplify Studio](/legacy/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app), choose the “Sync from Figma” button to review all the components from your Figma file.
