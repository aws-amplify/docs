...
Skip ahead to [set up authorization rules](/legacy/gen1/[platform]/tools/console/authz/permissions/) for the bookstore app, or learn about the different authorization modes below.
