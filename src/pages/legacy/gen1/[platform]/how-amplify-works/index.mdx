...
Learn more about [Amplify Data.](/legacy/gen1/[platform]/build-a-backend/graphqlapi/)
...
Learn more about [Amplify Auth](/legacy/gen1/[platform]/build-a-backend/auth/).
...
Learn more about [Amplify Storage](/legacy/gen1/[platform]/build-a-backend/storage/set-up-storage/).
...
Figma to code is available for React users. Learn more about [Figma-to-code generation](/legacy/gen1/react/build-ui/uibuilder/).
...
Form Builder is available for React users. Learn more about [Form Builder](/legacy/gen1/react/build-ui/formbuilder/).
...
Learn more about [extensibility](/legacy/gen1/[platform]/tools/cli/#extensibility).
