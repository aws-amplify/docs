...
**Amplify Studio now provides a new experience to build React forms**. We recommend reviewing [Form Builder (React)](/legacy/gen1/[platform]/build-ui/formbuilder/) before using the data action bindings documented below.
...
To enable multiple authentication types in DataStore & Amplify Forms, please refer to [Configure Multiple Authorization Types](/legacy/gen1/[platform]/build-a-backend/more-features/datastore/authz-rules-setup/#configure-multiple-authorization-types).
