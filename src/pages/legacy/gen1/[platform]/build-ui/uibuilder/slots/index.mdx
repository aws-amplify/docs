...
3. Select a Figma component from your UI Library that you've imported into Studio. _If you don't have any Figma components already, you can start with [Amplify's Figma UI file](/legacy/gen1/[platform]/build-ui/uibuilder/)._
...
Any component can be bound to data and used to [generate to a collection](/legacy/gen1/[platform]/build-ui/uibuilder/collections/), including components with component slots. Studio supports data binding to any GraphQL API created with Amplify, [with and without DataStore](/legacy/gen1/[platform]/tools/console/data/data-model/#datastore-and-graphql).
...
One](/legacy/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/#has-one-relationship)
and [has Many
relationships](/legacy/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/#has-many-relationship),
...
Dynamically rendering child components is where component slots get very useful - you can even [pass another collection](/legacy/gen1/[platform]/build-ui/uibuilder/override/#nesting-collections) into this component slot.
