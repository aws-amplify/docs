...
Amplify Studio supports data binding to all Amplify GraphQL APIs, **with or without DataStore**. [Learn more about DataStore and Conflict Resolution here](/legacy/gen1/[platform]/tools/console/data/data-model/#datastore-and-graphql).
...
1. Launch [Amplify Studio](/legacy/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app) for an app
2. Create a [collection](/legacy/gen1/[platform]/tools/console/tutorial/collections/) from a component
...
Collections bound to an GraphQL API without DataStore cannot be sorted. [Learn more about DataStore and Conflict Resolution](/legacy/gen1/[platform]/tools/console/data/data-model/#datastore-and-graphql).
...
Collections bound to GraphQL APIs without DataStore have limited Search capabilities. [Learn more about DataStore and Conflict Resolution](/legacy/gen1/[platform]/tools/console/data/data-model/#datastore-and-graphql).
...
[Learn more about DataStore and Conflict Resolution](/legacy/gen1/[platform]/tools/console/data/data-model/#datastore-and-graphql).
