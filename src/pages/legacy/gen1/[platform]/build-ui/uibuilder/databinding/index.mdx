...
3. **Create collection**: Create a collection out of a component. [Learn more](/legacy/gen1/[platform]/build-ui/uibuilder/collections/).
...
You need to [deploy a data model](/legacy/gen1/[platform]/tools/console/data/data-model/) in order to bind to data. Studio supports any GraphQL API created with Amplify, [with and without DataStore](/legacy/gen1/[platform]/tools/console/data/data-model/#datastore-and-graphql).

1. In [Amplify Studio](/legacy/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app), navigate to UI builder components and select a component.
...
Learn more in the [Collections documentation](/legacy/gen1/[platform]/build-ui/uibuilder/collections/)
