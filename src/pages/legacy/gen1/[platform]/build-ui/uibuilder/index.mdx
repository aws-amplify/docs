...
In [Amplify Studio](/legacy/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app), enter the URL for the Figma file you just created (or duplicated). You will be asked to authenticate with Figma.
...
Before importing and using your components and theme, the project will need an initial setup. To get started, create a [new React App](/legacy/gen1/[platform]/start/project-setup/create-application/#create-a-new-react-app) then,
