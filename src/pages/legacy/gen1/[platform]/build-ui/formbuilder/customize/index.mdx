...
To access **Form Builder**, login into [Amplify Studio](/legacy/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app).
...
4. **Validation rules**: Visually add validation rules. Learn more about [How to add validation rules](/legacy/gen1/[platform]/build-ui/formbuilder/validations/).
...
Some form inputs have unique configurations, like **File Uploader**. [Learn more about configuring special fields in the documentation](/legacy/gen1/[platform]/build-ui/formbuilder/special-inputs/).
