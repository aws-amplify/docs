...
In [Amplify Studio](/legacy/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app), you can visually add validation rules to inputs. If a form input has multiple validation rules, then all rules must be met for the input to be valid.
...
<Video src="/images/console/formbuilder/validations-visual.mp4" description="Video - Add validation rules" />
