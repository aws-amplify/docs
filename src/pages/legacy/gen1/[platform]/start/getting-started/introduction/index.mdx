...
- **Amplify [CLI](/legacy/gen1/[platform]/tools/cli)** - Configure all the services needed to power your backend through a simple command line interface.
- **Amplify [Libraries](/legacy/gen1/[platform]/tools/libraries/)** - Client libraries to build common use cases such as Auth, data, and File Storage by connecting your frontend app to your backend resources.
- **Amplify [Studio](/legacy/gen1/[platform]/tools/console)** - Build your fullstack web and mobile app using a simple and intuitive visual development environment.
...
<InternalLinkButton href={{
  pathname: '/legacy/gen1/[platform]/start/getting-started/installation',
