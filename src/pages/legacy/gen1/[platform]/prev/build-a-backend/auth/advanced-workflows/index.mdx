...
You can take specific actions when users sign-in or sign-out by subscribing authentication events in your app. Please see our [Hub Module Developer Guide](/legacy/gen1/[platform]/build-a-backend/utilities/hub/) for more information.
