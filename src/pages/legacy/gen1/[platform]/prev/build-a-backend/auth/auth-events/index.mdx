...
You can review the Amplify Hub guide to [learn more](/legacy/gen1/[platform]/build-a-backend/utilities/hub/).

<Callout warning>

Channels are logical group names that help you organize dispatching and listening. However, some channels are protected and cannot be used to publish custom events, and `auth` is one of these channels. Sending unexpected payloads to protected channels can have undesirable side effects such as impacting authentication flows. See the [Amplify Hub](/legacy/gen1/[platform]/build-a-backend/utilities/hub/) guide for more protected channels.
...
- [Manage user profile](/legacy/gen1/[platform]/prev/build-a-backend/auth/manage-user-profile/)
- [Set up password change and recovery](/legacy/gen1/[platform]/prev/build-a-backend/auth/manage-passwords/)
