...
- [Switching authentication flows](/legacy/gen1/[platform]/prev/build-a-backend/auth/switch-auth/#customauth-flow)
- [Advanced workflows](/legacy/gen1/[platform]/prev/build-a-backend/auth/advanced-workflows/)
