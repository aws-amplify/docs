...
- [Social sign-in (OAuth)](/legacy/gen1/[platform]/prev/build-a-backend/auth/add-social-provider/)
- [Multi-factor authentication](/legacy/gen1/[platform]/prev/build-a-backend/auth/manage-mfa/)
