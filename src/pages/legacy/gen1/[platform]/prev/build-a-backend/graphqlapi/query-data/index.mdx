...
- An [application connected to the API](/legacy/gen1/[platform]/prev/build-a-backend/graphqlapi/connect-to-api/)
...
To learn more, see [Authorization rules](/legacy/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules/) for the GraphQL API.
...
- Sorting is [available in DataStore](/legacy/gen1/[platform]/prev/build-a-backend/more-features/datastore/manipulate-data/#predicates) but not in AWS AppSync.
...
- [Subscribe to real-time events](/legacy/gen1/[platform]/prev/build-a-backend/graphqlapi/subscribe-data/)
- [Authorization rules](/legacy/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules/)
- [Data modeling](/legacy/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/)
- [Custom business logic](/legacy/gen1/[platform]/build-a-backend/graphqlapi/custom-business-logic/)
