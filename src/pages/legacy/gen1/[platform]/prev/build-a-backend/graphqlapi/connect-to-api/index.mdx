...
- A frontend application set up. For instructions on setting up an app, see [Project Setup: Create your application](/legacy/gen1/[platform]/prev/start/project-setup/create-application/)
...
To learn more about queries, mutations, and subscriptions in more detail, see the guides to [_Create, update, and delete application data_](/legacy/gen1/[platform]/prev/build-a-backend/graphqlapi/mutate-data/) and [_Read application data_](/legacy/gen1/[platform]/prev/build-a-backend/graphqlapi/query-data/).
...
- [Create, update, and delete application data](/legacy/gen1/[platform]/prev/build-a-backend/graphqlapi/mutate-data/)
- [Read application data](/legacy/gen1/[platform]/prev/build-a-backend/graphqlapi/query-data/)
