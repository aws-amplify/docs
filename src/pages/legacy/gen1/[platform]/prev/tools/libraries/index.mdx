...
If you are beginning a new project, we recommend you work with the [latest version of the Amplify libraries](/legacy/gen1/[platform]/tools/libraries/) for your chosen framework or language.
...
- [Authentication](/legacy/gen1/[platform]/prev/build-a-backend/auth/set-up-auth/)
- [File Storage](/legacy/gen1/[platform]/prev/build-a-backend/storage/set-up-storage/)
- [Analytics](/legacy/gen1/[platform]/prev/build-a-backend/more-features/analytics/set-up-analytics/)
