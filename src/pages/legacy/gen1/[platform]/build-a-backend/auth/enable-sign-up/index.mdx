...
Before you begin, you should have finished the [_Set up and connect backend resources_](/legacy/gen1/[platform]/build-a-backend/auth/set-up-auth/#set-up-and-connect-backend-resources) section of the _Set up Amplify Auth_ guide.
...
Before you begin, you should have finished the [_Set up backend resources_](/legacy/gen1/[platform]/build-a-backend/auth/set-up-auth/#set-up-backend-resources) section of the _Set up Amplify Auth_ guide.
...
We will use the username and password authentication flow to get started. Both [third-party social provider federation](/legacy/gen1/[platform]/build-a-backend/auth/add-social-provider/) and [Multi-factor authentication](/legacy/gen1/[platform]/build-a-backend/auth/manage-mfa/) can be added after this initial setup.

</InlineFilter>

<InlineFilter filters={["react-native"]}>

We will use the username and password authentication flow to get started. Both [third-party social provider federation](/legacy/gen1/[platform]/build-a-backend/auth/add-social-provider/) and [Multi-factor authentication](/legacy/gen1/[platform]/build-a-backend/auth/manage-mfa/) can be added after this initial set up.
...
For more information on handling the TOTP & MFA steps that may be returned, please see [_'Multi-factor authentication'_](/legacy/gen1/[platform]/prev/build-a-backend/auth/manage-mfa/).
...
- [Add social provider sign-in](/legacy/gen1/[platform]/build-a-backend/auth/add-social-provider/)
