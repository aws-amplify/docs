...
- [Switching authentication flows](/legacy/gen1/[platform]/build-a-backend/auth/switch-auth/#customauth-flow)
- [Advanced workflows](/legacy/gen1/[platform]/build-a-backend/auth/advanced-workflows/)
