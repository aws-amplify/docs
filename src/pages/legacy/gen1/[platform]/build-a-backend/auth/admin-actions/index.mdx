...
1. Initialize Amplify API. Refer to [Set up Amplify REST API](/legacy/gen1/[platform]/build-a-backend/restapi/set-up-rest-api/) for more details.
...
2. Sign in using `Amplify.Auth`. See [Amplify.Auth](/legacy/gen1/[platform]/build-a-backend/auth/set-up-auth/) to learn more about signing up and signing in a user.
