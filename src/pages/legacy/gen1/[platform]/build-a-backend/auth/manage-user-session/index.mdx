...
- [Enable sign-up, sign-in, and sign-out](/legacy/gen1/[platform]/build-a-backend/auth/enable-sign-up/)
- [Auth events](/legacy/gen1/[platform]/build-a-backend/auth/auth-events/)
