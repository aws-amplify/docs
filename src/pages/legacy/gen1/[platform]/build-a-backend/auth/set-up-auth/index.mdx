...
- A frontend app
- If you want Amplify to set up and manage your backend resources, you need to [install and configure](/legacy/gen1/[platform]/start/project-setup/prerequisites/) the Amplify CLI. Make sure to also create a new Amplify project using `amplify init` in your terminal, or pull in an existing Amplify project to your frontend app by using `amplify pull`.
...
> Prerequisites: [Install and configure](/legacy/gen1/[platform]/start/project-setup/prerequisites/) the Amplify CLI in addition to the Amplify Libraries.
...
If you wish to federate with social providers, [you will need to configure them first](/legacy/gen1/[platform]/build-a-backend/auth/add-social-provider/#social-providers-and-federation).
...
> You can also [import](/legacy/gen1/[platform]/tools/console/auth/import/) existing Amazon Cognito resources and [manage users and groups](/legacy/gen1/[platform]/tools/console/auth/user-management/) through the Amplify Studio UI.
...
- [Social sign-in (OAuth)](/legacy/gen1/[platform]/build-a-backend/auth/add-social-provider/)
- [Multi-factor authentication](/legacy/gen1/[platform]/build-a-backend/auth/manage-mfa/)
