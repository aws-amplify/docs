...
- [Manage user profile](/legacy/gen1/[platform]/build-a-backend/auth/manage-user-profile/)
- [Set up password change and recovery](/legacy/gen1/[platform]/build-a-backend/auth/manage-passwords/)
