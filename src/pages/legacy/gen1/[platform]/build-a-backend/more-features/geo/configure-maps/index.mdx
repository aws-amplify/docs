...
That's it! You can now render maps in your application. Follow the documentation for working with maps as listed [here](/legacy/gen1/[platform]/build-a-backend/more-features/geo/maps/).
