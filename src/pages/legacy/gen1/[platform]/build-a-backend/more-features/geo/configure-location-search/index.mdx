...
That's it! You can now search in your application. Follow the documentation for working with search as listed [here](/legacy/gen1/[platform]/build-a-backend/more-features/geo/location-search/).
