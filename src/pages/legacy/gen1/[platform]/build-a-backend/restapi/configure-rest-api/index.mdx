...
> See the list of all [supported Lambda runtimes](/legacy/gen1/[platform]/build-a-backend/functions/set-up-function/).
...
REST APIs have support for [multiple environments](/legacy/gen1/[platform]/tools/cli/teams/) (e.g. dev, qa, and prod). This means that you can easily isolate different versions of your REST API by using different Amplify environments.
