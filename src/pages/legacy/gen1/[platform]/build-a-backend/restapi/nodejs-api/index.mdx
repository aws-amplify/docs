...
To learn more about interacting with REST APIs using Amplify, check out the complete documentation [here](/legacy/gen1/[platform]/build-a-backend/restapi/set-up-rest-api/).
