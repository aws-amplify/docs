...
- There is no API for [Cognito Group-based access to files](https://github.com/aws-amplify/amplify-js/issues/3388). You may use [Amplify Gen2 Storage](/legacy/[platform]/build-a-backend/storage/authorization/#access-types) to achieve this.
