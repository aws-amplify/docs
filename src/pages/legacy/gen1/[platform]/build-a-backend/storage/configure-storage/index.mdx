...
Select `Individual Groups` to scope access permissions based on [Cognito User Groups](/legacy/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules/)
...
Learn more about this workflow [here](/legacy/gen1/[platform]/tools/cli/usage/lambda-triggers/#s3-lambda-triggers).

That's it! Your content storage is set up! Head to the [library's storage docs](/legacy/gen1/[platform]/build-a-backend/storage/set-up-storage/) to integrate this newly created S3 bucket into your app.
...
If you want to configure a Lambda trigger for your Table, you'll have the option. Learn more about this workflow [here](/legacy/gen1/[platform]/tools/cli/usage/lambda-triggers/#dynamodb-lambda-triggers).
