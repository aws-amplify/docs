...
You can either configure your IAM role to use the Amplify-recommended policies or use [`path`](/legacy/gen1/[platform]/build-a-backend/storage/path/) to specify your own path.
...
You can either configure your IAM role to use the Amplify-recommended policies or use [`StoragePath`](/legacy/gen1/[platform]/build-a-backend/storage/storagepath/) to specify your own path.

</InlineFilter>

It is highly recommended to review your S3 bucket's CORS settings. Review the [recommendation guide here](/legacy/gen1/[platform]/build-a-backend/storage/set-up-storage/#amazon-s3-bucket-cors-policy-setup).
