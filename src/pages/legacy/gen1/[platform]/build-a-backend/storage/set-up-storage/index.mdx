...
- [Completed the CLI and project setup steps.](/legacy/gen1/[platform]/start/project-setup/prerequisites/)
...
Amplify CLI supports running a local mock server for testing your application with Amazon S3. Please see the [CLI toolchain documentation](/legacy/gen1/[platform]/tools/cli/usage/mock/) for more details.
