...
For more details, see how to [Use an existing S3 bucket or DynamoDB table](/legacy/gen1/[platform]/build-a-backend/storage/import/).
...
Note that before you can add an AWS resource to your application, the application must have the Amplify libraries installed. If you need to perform this step, see [Install Amplify Libraries](/legacy/gen1/[platform]/start/project-setup/create-application/#n2-install-amplify-libraries).
