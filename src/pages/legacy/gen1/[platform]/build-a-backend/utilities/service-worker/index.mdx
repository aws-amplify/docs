...
If you enable AWS Amplify [Analytics](/legacy/gen1/[platform]/build-a-backend/more-features/analytics/set-up-analytics/) category, *ServiceWorker* module automatically tracks service worker state changes and message events.
