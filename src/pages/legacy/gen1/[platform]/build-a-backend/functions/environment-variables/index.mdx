...
> Environment variables should NOT be used for storing sensitive configuration values such as database passwords, API keys, or access tokens. Use [function secrets configuration](/legacy/gen1/[platform]/build-a-backend/functions/secrets/) instead!
