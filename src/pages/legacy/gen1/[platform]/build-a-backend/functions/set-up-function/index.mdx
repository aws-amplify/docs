...
You can add a Lambda function to your project which you can use alongside a REST API or as a datasource in your GraphQL API using the [`@function` directive](/legacy/gen1/[platform]/build-a-backend/graphqlapi/custom-business-logic/#lambda-function-resolver).
...
For more information on files generated in the function resource folder, see [Function Category Files](/legacy/gen1/[platform]/tools/cli/reference/files/#function-category-files).
