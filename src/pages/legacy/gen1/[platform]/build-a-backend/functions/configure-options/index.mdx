...
- [Secret values (example: access keys, API keys etc.)](/legacy/gen1/[platform]/build-a-backend/functions/secrets/)
- [Non-secret values (example: endpoint information, locale information etc.)](/legacy/gen1/[platform]/build-a-backend/functions/environment-variables/)
...
To learn more about extending the Amplify CLI with custom resources, check out the documentation [here](/legacy/gen1/[platform]/tools/cli/custom/cdk/)
