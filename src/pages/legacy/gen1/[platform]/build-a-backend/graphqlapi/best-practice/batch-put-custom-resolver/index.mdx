...
2. [Create a custom resource for your resolver](/legacy/gen1/[platform]/build-a-backend/graphqlapi/custom-business-logic/#vtl-resolver) and use the following code snippets as a guide to get started
...
The full documentation for custom resolvers [is available here](/legacy/gen1/[platform]/build-a-backend/graphqlapi/custom-business-logic/#vtl-resolver)
