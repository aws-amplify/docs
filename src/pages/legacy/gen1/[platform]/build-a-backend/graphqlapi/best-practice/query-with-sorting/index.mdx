...
To enable this, you can use the [@index](/legacy/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/) directive. This directive will allow you to set a custom `sortKey` on any field in your API.
...
To learn more about the `@index` directive, check out the documentation [here](/legacy/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/)
