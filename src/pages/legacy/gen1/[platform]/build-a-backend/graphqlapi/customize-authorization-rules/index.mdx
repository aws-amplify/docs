...
<MigrationAlert url={'/legacy/gen1/[platform]/tools/cli-legacy/auth-directive/'} />
...
Review the Amplify Library documentation to set the custom authorization token for [GraphQL API](/legacy/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules#aws-lambda) and [DataStore](/legacy/gen1/[platform]/build-a-backend/more-features/datastore/authz-rules-setup/#configure-custom-authorization-logic-with-aws-lambda).
...
Refer to the [sample code](/legacy/gen1/[platform]/build-a-backend/graphqlapi/connect-from-server-runtime/#iam-authorization) to learn how to sign the request to call the GraphQL API using IAM authorization.
