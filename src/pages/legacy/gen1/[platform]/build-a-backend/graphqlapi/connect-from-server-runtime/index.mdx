...
- [A Next.js application created](/legacy/gen1/nextjs/start/project-setup/create-application/)
- [Installed and configured Amplify libraries for Next.js](/legacy/gen1/nextjs/build-a-backend/server-side-rendering/)
- [Deployed a GraphQL API via the Amplify CLI, AWS CDK](/legacy/gen1/[platform]/build-a-backend/graphqlapi/set-up-graphql-api/), or directly using [AWS AppSync](https://aws.amazon.com/appsync/)
