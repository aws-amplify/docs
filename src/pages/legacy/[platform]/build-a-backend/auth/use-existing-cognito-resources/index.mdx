...
You can also use the [`access` property](/legacy/[platform]/build-a-backend/auth/grant-access-to-auth-resources/) to grant permissions to your auth resource from other Amplify backend resources. For example, if you have a function that needs to retrieve details about a user:
...
- [Learn how to connect your frontend](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/)
