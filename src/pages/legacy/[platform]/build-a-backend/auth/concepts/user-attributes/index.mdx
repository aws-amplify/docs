...
Unlike standard attributes, custom attributes cannot natively be required for sign-up, however can be codified to require some value by [validating user attributes upon sign-up with a pre sign-up trigger](/legacy/[platform]/build-a-backend/functions/examples/user-attribute-validation/).
...
- [Learn how attributes are surfaced to tokens](/legacy/[platform]/build-a-backend/auth/concepts/tokens-and-credentials/)
- [Learn how to manage your user attributes](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/manage-user-attributes)
