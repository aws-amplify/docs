...
- [Learn how to customize the ID token](/legacy/[platform]/build-a-backend/functions/examples/override-token/)
- [Learn how to bring your own tokens from external providers](/legacy/[platform]/build-a-backend/auth/advanced-workflows/#custom-token-providers)
- [Learn how to use cookie storage server-side](/legacy/[platform]/build-a-backend/server-side-rendering/#configure-amplify-library-for-client-side-usage)
