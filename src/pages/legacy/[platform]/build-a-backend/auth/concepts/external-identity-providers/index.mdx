...
Secrets must be created manually with [`ampx sandbox secret`](/legacy/[platform]/reference/cli-commands#npx-ampx-sandbox-secret) for use with cloud sandbox, or via the Amplify Console for branch environments.
...
- [Learn how to sign in with external providers](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in/#sign-in-with-an-external-identity-provider)
