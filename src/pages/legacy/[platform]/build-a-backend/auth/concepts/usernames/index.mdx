...
- [Learn how to configure email sign-up](/legacy/[platform]/build-a-backend/auth/concepts/email/)
- [Learn how to configure phone sign-up](/legacy/[platform]/build-a-backend/auth/concepts/phone/)
