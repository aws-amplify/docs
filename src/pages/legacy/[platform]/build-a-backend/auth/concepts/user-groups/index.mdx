...
- [Learn how to automatically add a user to a group upon account confirmation](/legacy/[platform]/build-a-backend/functions/examples/add-user-to-group/)
- [Learn how to secure access to data models using groups](/legacy/[platform]/build-a-backend/data/customize-authz/user-group-based-data-access)
- [Learn how to secure access to storage objects using groups](/legacy/[platform]/build-a-backend/storage/set-up-storage/)
