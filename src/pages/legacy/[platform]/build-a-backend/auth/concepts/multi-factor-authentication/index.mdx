...
**Warning:** In order to send SMS authentication codes, you must [request an origination number](https://docs.aws.amazon.com/pinpoint/latest/userguide/settings-request-number.html). [Learn more about configuring your auth resource for production workloads](/legacy/[platform]/build-a-backend/auth/moving-to-production/).
...
- Cognito must be configured to send emails using [Amazon Simple Email Service (Amazon SES)](/legacy/[platform]/build-a-backend/auth/moving-to-production/#email).
...
- [Learn how to sign-up with MFA enabled](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in/#with-multi-factor-auth-enabled)
- [Learn how to manage user devices](/legacy/[platform]/build-a-backend/auth/manage-users/manage-devices/)
