...
SMS-based one-time password requires your Amazon Cognito user pool to be configured to use Amazon Simple Notification Service (SNS) to send text messages. [Learn how to configure your auth resource with SNS](/legacy/[platform]/build-a-backend/auth/moving-to-production/#sms).

{/* NOTE the linked page will need to be updated with sns instructions */}

</Callout>

[Learn more about using SMS OTP in your application code](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in/#sms-otp).
...
Email-based one-time password requires your Amazon Cognito user pool to be configured to use Amazon Simple Email Service (SES) to send email messages. [Learn how to configure your auth resource with SES](/legacy/[platform]/build-a-backend/auth/moving-to-production/#email).

</Callout>

[Learn more about using email OTP in your application code](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in/#email-otp).
...
1. Use the Amplify Android APIs to first [register a passkey](/legacy/[platform]/build-a-backend/auth/manage-users/manage-webauthn-credentials/#associate-webauthn-credentials) and then to [sign in with WebAuthn](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in/#webauthn-passkeys).
...
[Learn more about using WebAuthn passkeys in your application code](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in/#webauthn-passkeys).
...
[Learn more about managing WebAuthn credentials](/legacy/[platform]/build-a-backend/auth/manage-users/manage-webauthn-credentials).
...
- [Learn how to implement passwordless sign-in in your application](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in/)
- [Configure email settings for Email OTP](/legacy/[platform]/build-a-backend/auth/moving-to-production/#email)
- [Configure SMS settings for SMS OTP](/legacy/[platform]/build-a-backend/auth/moving-to-production/#sms)
- [Manage WebAuthn credentials](/legacy/[platform]/build-a-backend/auth/manage-users/manage-webauthn-credentials/)
