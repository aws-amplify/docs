...
If you have not yet created an **auth** resource, visit the [Auth setup guide](/legacy/[platform]/build-a-backend/auth/set-up-auth/).
...
A user can be confirmed by using the [pre-built UI components](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/using-the-authenticator/) and [Amplify libraries](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-up/).
