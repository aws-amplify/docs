...
Amplify Auth is powered by [Amazon Cognito](https://aws.amazon.com/cognito/). Cognito is a robust user directory service that handles user registration, authentication, account recovery, and other operations. [Review the concepts to learn more](/legacy/[platform]/build-a-backend/auth/concepts/).
...
- [Passwordless authentication](/legacy/[platform]/build-a-backend/auth/concepts/passwordless/) (Email OTP, SMS OTP, or WebAuthn passkeys)
</InlineFilter>
...
[Learn more about passwordless authentication options](/legacy/[platform]/build-a-backend/auth/concepts/passwordless/).
...
- [Learn more about authentication concepts](/legacy/[platform]/build-a-backend/auth/concepts/)
- [Moving to production](/legacy/[platform]/build-a-backend/auth/moving-to-production/)
