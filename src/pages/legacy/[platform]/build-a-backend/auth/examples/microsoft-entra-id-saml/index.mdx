...
**Note:** the following guidance showcases configuration with your [personal cloud sandbox](/legacy/[platform]/deploy-and-host/sandbox-environments/setup/). You will need to repeat the configuration steps for branch deployments after confirming functionality against your sandbox.
