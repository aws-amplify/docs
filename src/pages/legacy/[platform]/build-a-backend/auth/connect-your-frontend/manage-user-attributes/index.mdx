...
- [Learn how to set up password change and recovery](/legacy/[platform]/build-a-backend/auth/manage-users/manage-passwords/)
- [Learn how to set up custom attributes](/legacy/[platform]/build-a-backend/auth/concepts/user-attributes#custom-attributes)
