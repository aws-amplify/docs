...
Follow the instructions in [Custom Auth Sign In](/legacy/gen1/[platform]/build-a-backend/auth/sign-in-custom-flow/) to learn about how to integrate custom authentication flow in your application with the Auth APIs.
...
<Callout>
For more information about determining a first factor, and signing in with passwordless authentication factors, please visit the [Passwordless](/legacy/[platform]/build-a-backend/auth/concepts/passwordless/) concepts page.
</Callout>
...
To define your challenges for custom authentication flow, you need to implement three Lambda triggers for Amazon Cognito. Please visit [AWS Amplify Custom Auth Challenge example](/legacy/[platform]/build-a-backend/functions/examples/custom-auth-flows/) for set up instructions.
...
To create a CAPTCHA challenge with a Lambda Trigger, please visit [AWS Amplify Google reCAPTCHA challenge example](/legacy/[platform]/build-a-backend/functions/examples/google-recaptcha-challenge/) for detailed examples.
