...
For more information on handling the MFA steps that may be returned, see [multi-factor authentication](/legacy/[platform]/build-a-backend/auth/concepts/multi-factor-authentication/).
...
Visit the [multi-factor authentication documentation](/legacy/[platform]/build-a-backend/auth/concepts/multi-factor-authentication/) to learn more about enabling MFA on your backend auth resource.
...
For guidance on configuring an external Identity Provider with Amplify see [External Identity Providers](/legacy/[platform]/build-a-backend/auth/concepts/external-identity-providers/)
...
Your application's users can also sign in using passwordless methods. To learn more, including how to setup the various passwordless authentication flows, visit the [concepts page for passwordless](/legacy/[platform]/build-a-backend/auth/concepts/passwordless/).
...
<Callout>
The user must have previously associated a credential to use this auth factor. To learn more, visit the [manage WebAuthn credentials page](/legacy/[platform]/build-a-backend/auth/manage-users/manage-webauthn-credentials/).
</Callout>
