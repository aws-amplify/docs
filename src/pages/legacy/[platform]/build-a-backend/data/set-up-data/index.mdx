...
You can also use `.onCreate`, `.onUpdate`, or `.onDelete` to subscribe to specific events. Review [Subscribe to real-time events](/legacy/[platform]/build-a-backend/data/subscribe-data) to learn more about subscribing to specific mutation events.
...
- [How to model your database table and their access patterns](/legacy/[platform]/build-a-backend/data/data-modeling)
- [Secure your API with fine-grained authorization rules](/legacy/[platform]/build-a-backend/data/customize-authz)
- [Create relationships between different database model](/legacy/[platform]/build-a-backend/data/data-modeling/relationships)
- [Add custom business logic](/legacy/[platform]/build-a-backend/data/custom-business-logic)
