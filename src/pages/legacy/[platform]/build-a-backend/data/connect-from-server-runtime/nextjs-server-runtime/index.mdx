...
- [A Next.js application created](/legacy/[platform]/start/quickstart/)
- [Installed and configured Amplify libraries for Next.js](/nextjs/build-a-backend/server-side-rendering/)
- [Deployed Amplify Data resources](/legacy/[platform]/build-a-backend/data/set-up-data/), or directly using [AWS AppSync](https://aws.amazon.com/appsync/)
