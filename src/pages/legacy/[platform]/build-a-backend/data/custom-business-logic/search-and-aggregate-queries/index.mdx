...
Begin by setting up your project by following the instructions in the [Quickstart guide](/legacy/[platform]/start/quickstart/). For the purpose of this guide, we'll sync a Todo table from DynamoDB to OpenSearch.
