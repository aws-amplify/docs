...
export const meta = {
  ...
  route: "/legacy/[platform]/build-a-backend/data/data-modeling",
  platforms: [
    'android',
    'angular',
    'flutter',
...
**Note:** Some features available in Gen 1 GraphQL SDL are not available in Gen 2. See the [feature matrix](/legacy/[platform]/start/migrate-to-gen2/#gen-1-vs-gen-2-feature-matrix) for features supported in Gen 2.
