...
Set up your project by following the instructions in the [Quickstart guide](/legacy/[platform]/start/quickstart/).
...
For more details on how to configure Storage authorization levels, see the [Storage documentation](/legacy/[platform]/build-a-backend/storage/authorization/). For more on configuring Data authorization, see the [API documentation](/legacy/[platform]/build-a-backend/data/customize-authz/).
