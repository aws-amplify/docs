...
Use "oidc" as your authorization mode when connecting applications to a trusted identity provider. Private, owner, and group authorization can be configured with an OIDC authorization mode. Review the [OIDC authorization docs](/legacy/[platform]/build-a-backend/data/customize-authz/using-oidc-authorization-provider) to learn more.
...
Use "Lambda Authorizer" when using your own custom authorization logic via `allow.custom()`. Review [Customize your auth rules](/legacy/[platform]/build-a-backend/data/customize-authz) to learn more about how to implement your authorization protocol.
...
You can implement your own custom API authorization logic using a AWS Lambda function. Review [Customize your auth rules](/legacy/[platform]/build-a-backend/data/customize-authz) to learn more about how to implement your authorization protocol with AWS Lambda.
