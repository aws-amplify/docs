...
- An [application connected to the API](/legacy/[platform]/build-a-backend/data/connect-to-API/)
...
**Note:** When deleting items in many-to-many relationships, the join table records must be deleted before deleting the associated records. For example, for a many-to-many relationship between Posts and Tags, delete the PostTags join record before deleting a Post or Tag. Review [Many-to-many relationships](/legacy/[platform]/build-a-backend/data/data-modeling/relationships/) for more details.
...
- [Read application data](/legacy/[platform]/build-a-backend/data/query-data/)
- [Subscribe to real-time events](/legacy/[platform]/build-a-backend/data/subscribe-data/)
