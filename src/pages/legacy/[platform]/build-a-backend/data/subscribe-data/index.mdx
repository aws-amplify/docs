...
The model's [authorization rules](/legacy/[platform]/build-a-backend/data/customize-authz/) must grant the appropriate rights to the user.
...
- [Customize your auth rules](/legacy/[platform]/build-a-backend/data/customize-authz/)
- [Customize your data model](/legacy/[platform]/build-a-backend/data/data-modeling/)
