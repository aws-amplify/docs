...
In addition, you can also use OpenID Connect with `authenticated` authorization. See [OpenID Connect as an authorization provider](/legacy/[platform]/build-a-backend/data/customize-authz/using-oidc-authorization-provider/).
