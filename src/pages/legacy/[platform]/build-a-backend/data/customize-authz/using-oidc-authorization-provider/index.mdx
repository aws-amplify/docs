...
The example below highlights the supported authorization strategies with a `oidc` authorization provider. For owner and group-based authorization, you also will need to [specify a custom identity and group claim](/legacy/[platform]/build-a-backend/data/customize-authz/configure-custom-identity-and-group-claim).
