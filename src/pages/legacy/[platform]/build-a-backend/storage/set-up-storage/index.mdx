...
If you have not yet created an Amplify app, visit the [quickstart guide](/legacy/[platform]/start/quickstart/).
...
[Learn more about customizing access to file path](/legacy/[platform]/build-a-backend/storage/authorization/).
...
For a full example, please follow the [project setup walkthrough](/legacy/[platform]/start/quickstart/).
...
* An Android application targeting Android API level 24 (Android 7.0) or above
    * For a full example of creating Android project, please follow the [quickstart guide](/legacy/[platform]/start/quickstart/)

### Install the Amplify library

Expand **Gradle Scripts**, open **build.gradle (Module: app)**. You will already have configured Amplify by following the steps in the [quickstart guide](/legacy/[platform]/start/quickstart/).
...
Note that because the storage category requires auth, you will need to either configure [guest access](/legacy/[platform]/build-a-backend/auth/concepts/guest-access/) or [sign in a user](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in) before using features in the storage category.
...
- [Upload Files](/legacy/[platform]/build-a-backend/storage/upload-files/)
- [Download Files](/legacy/[platform]/build-a-backend/storage/download-files/)
