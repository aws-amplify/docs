...
Authentication is required to continue using Amplify Storage, please make sure you set it up if you haven't already - [documentation to set up Auth](/legacy/[platform]/build-a-backend/auth/set-up-auth/).
...
[Learn more about function resource access environment variables](/legacy/[platform]/build-a-backend/functions/#resource-access)
