...
**Note:** Refer to [the Transfer Acceleration documentation](/legacy/[platform]/build-a-backend/storage/extend-s3-resources/#example---enable-transfer-acceleration) to learn how to enable transfer acceleration for storage APIs.
...
Read more at [Configure additional storage buckets](/legacy/[platform]/build-a-backend/storage/set-up-storage/#configure-additional-storage-buckets)
...
| useAccelerateEndpoint | boolean | Whether to use accelerate endpoint. <br/><br/> Read more at [Transfer Acceleration](/legacy/[platform]/build-a-backend/storage/upload-files/#transfer-acceleration) |
