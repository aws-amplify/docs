...
To learn how to add IAM policies to a Function's execution role, visit the [documentation for granting access to other resources](/legacy/[platform]/build-a-backend/functions/grant-access-to-other-resources#using-cdk).
