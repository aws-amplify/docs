...
**Note:** The following options are not supported for [Custom Functions](/legacy/[platform]/build-a-backend/functions/custom-functions/) except for `resourceGroupName`.
