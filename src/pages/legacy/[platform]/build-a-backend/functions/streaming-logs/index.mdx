...
Amplify enables you to stream logs from your AWS Lambda functions directly to your terminal while running [`ampx sandbox`](/legacy/[platform]/reference/cli-commands/#npx-ampx-sandbox). To get started, specify the `--stream-function-logs` option when starting sandbox:
...
**Note**: this feature is only available for [Sandbox](/legacy/[platform]/deploy-and-host/sandbox-environments/)
