...
For examples on streaming analytics data to the Kinesis stream from your frontend, see the [Streaming analytics data](/legacy/[platform]/build-a-backend/add-aws-services/analytics/streaming-data/) documentation.
</InlineFilter>
