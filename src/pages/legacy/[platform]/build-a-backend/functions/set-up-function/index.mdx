...
To invoke your Function, we recommend adding your [Function as a handler for a custom query with your Amplify Data resource](/legacy/[platform]/build-a-backend/data/custom-business-logic/). This will enable you to strongly type Function arguments and the return statement, and use this to author your Function's business logic. To get started, open your `amplify/data/resource.ts` file and specify a new query in your schema:
...
- [Environment variables and secrets](/legacy/[platform]/build-a-backend/functions/environment-variables-and-secrets/)
- [Grant access to other resources](/legacy/[platform]/build-a-backend/functions/grant-access-to-other-resources/)
- [Explore example use cases](/legacy/[platform]/build-a-backend/functions/examples/)
- [Modifying underlying resources with CDK](/legacy/[platform]/build-a-backend/functions/modify-resources-with-cdk/)
