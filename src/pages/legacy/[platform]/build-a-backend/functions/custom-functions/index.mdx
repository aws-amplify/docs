...
- [Scheduling configuration](/legacy/[platform]/build-a-backend/functions/scheduling-functions/)
- [Lambda layers](/legacy/[platform]/build-a-backend/functions/add-lambda-layers/)
- [Function options](/legacy/[platform]/build-a-backend/functions/configure-functions/)
...
To invoke your function, we recommend adding your [function as a handler for a custom query with your Amplify Data resource](/legacy/[platform]/build-a-backend/data/custom-business-logic/). To get started, open your `amplify/data/resource.ts` file and specify a new query in your schema:
