...
Now you can proceed to [displaying a map](/legacy/[platform]/build-a-backend/add-aws-services/geo/maps/) or [adding location search](/legacy/[platform]/build-a-backend/add-aws-services/geo/location-search/) to your app.
</InlineFilter>
