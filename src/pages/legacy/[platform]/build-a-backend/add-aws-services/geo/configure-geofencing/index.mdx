...
**Note:** After you have provisioned the Geofence Collection, depending on your application's use-case, you can also add Geofences to the provisioned Geofence Collection programmatically. Refer this [API documentation](/legacy/[platform]/build-a-backend/add-aws-services/geo/geofences/#savegeofences) for more information.
