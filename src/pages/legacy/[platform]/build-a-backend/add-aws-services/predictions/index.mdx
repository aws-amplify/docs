...
export const meta = {
  ...
  route: "/legacy/[platform]/build-a-backend/add-aws-services/predictions",
  platforms: [
    'angular',
    'javascript',
    'nextjs',
...
- [Convert text to speech](/legacy/[platform]/build-a-backend/add-aws-services/predictions/text-to-speech/)
- [Transcribe audio to text](/legacy/[platform]/build-a-backend/add-aws-services/predictions/transcribe-audio/)
- [Translate text from one language to another](/legacy/[platform]/build-a-backend/add-aws-services/predictions/translate/)
- [Identify text from an image](/legacy/[platform]/build-a-backend/add-aws-services/predictions/identify-text/)
- [Identify entities from an image](/legacy/[platform]/build-a-backend/add-aws-services/predictions/identify-entity/)
- [Identify real world objects from an image](/legacy/[platform]/build-a-backend/add-aws-services/predictions/identify-entity)
- [Interpret text](/legacy/[platform]/build-a-backend/add-aws-services/predictions/interpret-sentiment)
