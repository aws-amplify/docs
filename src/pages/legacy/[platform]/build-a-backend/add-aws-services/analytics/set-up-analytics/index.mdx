...
When running your app on macOS you will need to enable keychain sharing in Xcode, as described in the [Project setup guide](/legacy/gen1/[platform]/start/project-setup/platform-setup/#enable-keychain).
...
- [Record Events](/legacy/[platform]/build-a-backend/add-aws-services/analytics/record-events/)
- [Track Sessions](/legacy/[platform]/build-a-backend/add-aws-services/analytics/auto-track-sessions/)
- [Identify User](/legacy/[platform]/build-a-backend/add-aws-services/analytics/identify-user/)
