...
You can get the current user's ID from the Amplify Auth category as shown below. Be sure you have it added and setup per the [Auth category documentation](/legacy/[platform]/build-a-backend/auth/set-up-auth/).
...
If the user is signed in through [Amplify.Auth.signIn](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-in/), then you can retrieve the current user's ID as shown below:
...
You can get the current user's ID from the Amplify Auth category as shown per the Auth category documentation. Be sure to have it ready before you set it as shown below (Check out the [Authentication Getting Started](/legacy/[platform]/build-a-backend/auth/set-up-auth/) guide for detailed explanation).
...
If the user was signed in through [signIn](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/sign-up/) you can retrieve the current user's ID as shown below:
