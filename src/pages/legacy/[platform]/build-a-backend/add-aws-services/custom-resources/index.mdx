...
With the Amplify code-first DX, you can add existing or custom CDK [constructs](https://docs.aws.amazon.com/cdk/v2/guide/constructs.html) to the [backend](/legacy/[platform]/how-amplify-works/concepts/#backend) of your Amplify app.
