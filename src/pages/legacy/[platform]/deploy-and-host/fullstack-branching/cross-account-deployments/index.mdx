...
<InlineFilter filters={["nextjs"]}>
 ...
 - Use our [**Next.js starter template**](/legacy/[platform]/start/quickstart/nextjs-pages-router/#1-create-the-repository) to create a repository in your GitHub account.
