        ...
        <Columns columns={2} as="ul">
          {!isMobilePlatform && (
            <FeatureItem
              ...
              href={{
                pathname: '/legacy/[platform]/how-amplify-works/concepts',
          ...
          {isMobilePlatform ? (
            <FeatureItem
              ...
              href={{
                pathname: '/legacy/[platform]/build-a-backend/data/set-up-data/',
                query: { platform: currentPlatform }
              }}
            >
          ...
          <FeatureItem
            ...
            href={{
              pathname: '/legacy/[platform]/build-a-backend/auth/set-up-auth/',
              query: { platform: currentPlatform }
            }}
          >
          ...
          {!isMobilePlatform && (
            <FeatureItem
              ...
              href={{
                pathname: '/legacy/[platform]/build-ui/',
                query: { platform: currentPlatform }
              }}
            >
      ...
      <Columns columns={2}>
        ...
        <FeatureList heading="Deploy" level={2}>
          {!isMobilePlatform && (
            <FeatureItem
              ...
              href={{
                pathname: '/legacy/[platform]/deploy-and-host/hosting/',
                query: { platform: currentPlatform }
              }}
            >
          ...
          <FeatureItem
            ...
            href={{
              pathname:
                '/legacy/[platform]/deploy-and-host/sandbox-environments/setup/',
              query: { platform: currentPlatform }
            }}
          >
          ...
          <FeatureItem
            ...
            href={{
              pathname:
                '/legacy/[platform]/deploy-and-host/fullstack-branching/branch-deployments/',
              query: { platform: currentPlatform }
            }}
          >
        ...
        <FeatureList heading="Customize" level={2}>
          <FeatureItem
            ...
            href={{
              pathname: '/legacy/[platform]/build-a-backend/add-aws-services/',
              query: { platform: currentPlatform }
            }}
          >
          ...
          <FeatureItem
            ...
            href={{
              pathname:
                '/legacy/[platform]/deploy-and-host/fullstack-branching/custom-pipelines/',
              query: { platform: currentPlatform }
            }}
          >
          ...
          <FeatureItem
            ...
            href={{
              pathname:
                '/legacy/[platform]/deploy-and-host/fullstack-branching/mono-and-multi-repos/',
              query: { platform: currentPlatform }
            }}
          >
