...
Now that you have a conceptual understanding of AWS Amplify's capabilities, complete the [quickstart tutorial](/legacy/[platform]/start/quickstart/) to put it into action in an app.
