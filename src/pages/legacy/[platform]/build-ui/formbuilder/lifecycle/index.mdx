...
With the `onValidate` event, you can extend the validation rules in code. Learn more about [How to add validation rules](/legacy/[platform]/build-ui/formbuilder/validations/).
