...
To use connected forms, you first need to deploy a data model from your sandbox environment. We will use the same example as in the getting started [tutorial](/legacy/[platform]/start/quickstart).
