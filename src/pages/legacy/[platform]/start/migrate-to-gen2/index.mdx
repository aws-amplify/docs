...
| Feature | Gen 1 | Gen 2 |
|---|---|---|
| Configure username | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/auth/modify-resources-with-cdk/) |
...
| Configure default password policy | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/auth/modify-resources-with-cdk/) |
| Configure read/write capabilities for attributes | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/auth/modify-resources-with-cdk/) |
| Oauth flow: Configure authorization v implicit grant | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/auth/modify-resources-with-cdk/) |
| Admin queries | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/auth/modify-resources-with-cdk/) |
...
| Custom attributes | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/auth/modify-resources-with-cdk/) |
| Oauth flow: Configure domain name prefix | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/auth/modify-resources-with-cdk/) |
...
| Auth and Guest access | Yes | [Yes](/legacy/[platform]/build-a-backend/storage/authorization/#for-gen-1-public-protected-and-private-access-pattern) |
...
| Function resource access permissions: geo | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/functions/grant-access-to-other-resources/#using-cdk) |
| Function resource access permissions: analytics | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/functions/grant-access-to-other-resources/#using-cdk) |
| Function runtime: .NET 6 | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/functions/custom-functions/) |
| Function runtime: Go | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/functions/custom-functions/) |
| Function runtime: Java | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/functions/custom-functions/) |
| Function runtime: JavaScript | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/functions/custom-functions/) |
| Function runtime: Python | Yes | [Yes with CDK](/legacy/[platform]/build-a-backend/functions/custom-functions/) |
...
[Amplify JS Auth API documentation](/legacy/[platform]/build-a-backend/auth/connect-your-frontend/)

| Feature | Gen 1 | Gen 2 |
|---|---|---|
| REST API| Yes|	No
| Analytics| Yes|	[Yes with custom CDK](/legacy/[platform]/build-a-backend/add-aws-services/analytics/)
| Geo| Yes|	[Yes with custom CDK](/legacy/[platform]/build-a-backend/add-aws-services/geo/)
| Predictions | Yes|	No
| Interactions| Yes|	No
...
| Feature | Gen 1 | Gen 2 |
|---|---|---|
| REST API| Yes|	[Yes with custom CDK](/legacy/[platform]/build-a-backend/add-aws-services/rest-api/)
| Analytics| Yes|	[Yes with custom CDK](/legacy/[platform]/build-a-backend/add-aws-services/analytics/)
| Geo| Yes|	[Yes with custom CDK](/legacy/[platform]/build-a-backend/add-aws-services/geo/)
| Predictions | Yes|	[Yes with custom CDK](/legacy/[platform]/build-a-backend/add-aws-services/predictions/)
| Interactions| Yes|	[Yes with custom CDK](/legacy/[platform]/build-a-backend/add-aws-services/interactions/)
