...
Otherwise, **[set up local AWS credentials](/legacy/[platform]/start/account-setup/)** that grant Amplify permissions to deploy backend updates from your local machine.
...
That's it! You have successfully built a fullstack app on AWS Amplify. If you want to learn more about how to work with Amplify, here's the conceptual guide for [how Amplify works](/legacy/[platform]/how-amplify-works/concepts/).
