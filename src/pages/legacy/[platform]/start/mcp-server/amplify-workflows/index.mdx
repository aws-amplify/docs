...
export const meta = {
  ...
  route: '/legacy/[platform]/start/mcp-server/amplify-workflows',
  platforms: [
    'angular',
    'javascript',
    'nextjs',
...
1. [Set up AWS MCP Server](/legacy/[platform]/start/mcp-server/set-up-mcp/) if you haven't already
...
- [Authentication](/legacy/[platform]/build-a-backend/auth/)
- [Data](/legacy/[platform]/build-a-backend/data/)
- [Storage](/legacy/[platform]/build-a-backend/storage/)
- [Functions](/legacy/[platform]/build-a-backend/functions/)
