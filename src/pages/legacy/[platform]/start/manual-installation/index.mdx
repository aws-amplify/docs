...
To get started with AWS Amplify we recommend that you use our [quickstart](/legacy/[platform]/start/quickstart) starter template. However, for some use cases, it may be preferable to start from scratch, either with a brand new directory or an existing frontend app. In that case we recommend to use [npm](https://npmjs.com) with [`create-amplify`](https://www.npmjs.com/package/create-amplify).
...
- [Learn more about defining authentication](/legacy/[platform]/build-a-backend/auth)
- [Learn more about defining data](/legacy/[platform]/build-a-backend/data)
- [Get started with cloud sandbox](/legacy/[platform]/deploy-and-host/sandbox-environments)
- [Deploy and host your first app](/legacy/[platform]/deploy-and-host/fullstack-branching)
