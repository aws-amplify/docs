...
Amplify Gen 2 backends are defined using TypeScript, and enable you to collocate resources depending on their function. For example, you can author a [post confirmation trigger for Amazon Cognito that creates a UserProfile model](/legacy/[platform]/build-a-backend/functions/examples/create-user-profile-record/) right next to your auth's resource file.
...
- [Learn the concepts](/legacy/[platform]/how-amplify-works/concepts)
- [Learn how to add AWS services to your backend](/legacy/[platform]/build-a-backend/add-aws-services)
