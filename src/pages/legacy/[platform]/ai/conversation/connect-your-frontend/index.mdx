...
The `toolConfiguration` argument allows you to optionally pass a client tool configuration to the AI assistant with a user message. See the [Tools concept page](/legacy/[platform]/ai/concepts/tools) and [Tools guide](/legacy/[platform]/ai/conversation/tools/) for more information on how tools works.
