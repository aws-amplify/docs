...
You will also need an AWS account that is [setup for local development](/legacy/[platform]/start/account-setup) and has access to the Bedrock Foundation Model(s) you want to use. You can request access to Bedrock models by going in to the [Bedrock console and requesting access](https://console.aws.amazon.com/bedrock/home#/modelaccess).
...
Then run the [Amplify sandbox](/legacy/[platform]/deploy-and-host/sandbox-environments/setup/) to start your local cloud sandbox:
...
<Callout type="info">
See [Supported Providers and Models](/legacy/[platform]/ai/concepts/models/#supported-providers-and-models) for a list of supported AI models.
</Callout>
