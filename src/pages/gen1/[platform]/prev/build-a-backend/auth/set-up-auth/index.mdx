...
- A frontend app
- If you want Amplify to set up and manage your backend resources, you need to [install and configure](/gen1/[platform]/start/project-setup/prerequisites/) the Amplify CLI. Make sure to also create a new Amplify project using `amplify init` in your terminal, or pull in an existing Amplify project to your frontend app by using `amplify pull`.
...
> Prerequisites: [Install and configure](/gen1/[platform]/start/project-setup/prerequisites/) the Amplify CLI in addition to the Amplify Libraries.
...
If you wish to federate with social providers, [you will need to configure them first](/gen1/[platform]/build-a-backend/auth/add-social-provider/#social-providers-and-federation).
...
- [Social sign-in (OAuth)](/gen1/[platform]/prev/build-a-backend/auth/add-social-provider/)
