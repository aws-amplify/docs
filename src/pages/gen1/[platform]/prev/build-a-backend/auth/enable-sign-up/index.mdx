...
- [Add social provider sign-in](/gen1/[platform]/prev/build-a-backend/auth/add-social-provider/)
- [Multi-factor authentication](/gen1/[platform]/prev/build-a-backend/auth/manage-mfa/)
