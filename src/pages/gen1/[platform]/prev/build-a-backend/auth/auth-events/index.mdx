...
- [Manage user profile](/gen1/[platform]/prev/build-a-backend/auth/manage-user-profile/)
- [Set up password change and recovery](/gen1/[platform]/prev/build-a-backend/auth/manage-passwords/)
