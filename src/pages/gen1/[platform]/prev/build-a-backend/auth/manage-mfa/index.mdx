...
- [Switching authentication flows](/gen1/[platform]/prev/build-a-backend/auth/switch-auth/#customauth-flow)
- [Advanced workflows](/gen1/[platform]/prev/build-a-backend/auth/advanced-workflows/)
