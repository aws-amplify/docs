...
REST APIs have support for [multiple environments](/gen1/[platform]/prev/tools/cli/teams/) (e.g. dev, qa, and prod). This means that you can easily isolate different versions of your REST API by using different Amplify environments.
