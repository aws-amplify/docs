...
That's it! You can now render maps in your application. Follow the documentation for working with maps as listed [here](/gen1/[platform]/prev/build-a-backend/more-features/geo/maps).
