...
To learn more, see [Authorization rules](/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules/) for the GraphQL API.
...
- Sorting is [available in DataStore](/gen1/[platform]/prev/build-a-backend/more-features/datastore/manipulate-data/#predicates) but not in AWS AppSync.
...
- [Subscribe to real-time events](/gen1/[platform]/prev/build-a-backend/graphqlapi/subscribe-data/)
- [Authorization rules](/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules/)
- [Data modeling](/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/)
- [Custom business logic](/gen1/[platform]/build-a-backend/graphqlapi/custom-business-logic/)
