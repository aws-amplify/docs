...
If you are beginning a new project, we recommend you work with the [latest version of the Amplify libraries](/gen1/[platform]/tools/libraries/) for your chosen framework or language.
