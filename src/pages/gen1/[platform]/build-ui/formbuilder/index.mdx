...
If you have a data model deployed in your Amplify app, Studio will automatically generate default [connected forms](/gen1/[platform]/build-ui/formbuilder/data-binding/#connected-forms) for you.

To use default forms:

1. Log into [Amplify Studio](/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app) and deploy a [Data model](/gen1/[platform]/tools/console/data/data-model/)
...
To use connected forms, you first need a data model. Log into [Amplify Studio](/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app) and deploy a [Data model](/gen1/[platform]/tools/console/data/data-model/).
...
1. In [Amplify Studio Console](/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app), navigate to **UI Library**
...
1. In the [Amplify Studio Console](/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app), navigate to **UI Library**
1. In the left-hand nav bar, next to the **Forms** header, select **New** ![Red box around the "new" section of Form Builder](/images/console/formbuilder/overview7.png)
1. Give your form a name, and select [Create or Update](#create-and-update-forms)
...
To use a form in your application, you first need to configure your project to use Amplify Studio generated components. To get started, create a [new React App](/gen1/[platform]/start/project-setup/create-application/#create-a-new-react-app) then,
