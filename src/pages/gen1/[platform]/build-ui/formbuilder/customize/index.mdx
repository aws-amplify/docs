...
To access **Form Builder**, login into [Amplify Studio](/gen1/[platform]/tools/console/adminui/start/#logging-in-and-creating-an-app).
...
4. **Validation rules**: Visually add validation rules. Learn more about [How to add validation rules](/gen1/[platform]/build-ui/formbuilder/validations/).
...
<Video src="/images/console/formbuilder/customize-add.mp4" ariaDescription="Video - Add form input" />
...
<Video src="/images/console/formbuilder/customize-drag-and-drop.mp4" ariaDescription="Video - Rearrange form inputs" />
...
<Video src="/images/console/formbuilder/customize-view-as-end-user.mp4" ariaDescription="Video - View form as end user" />
...
<Video src="/images/console/formbuilder/customize-spacing.mp4" ariaDescription="Video - Configure form spacings" />
...
<Video src="/images/console/formbuilder/customize-options.mp4" ariaDescription="Video - Configure options" />
...
<Video src="/images/console/formbuilder/customize-list-control.mp4" ariaDescription="Video - Customize list control" />
...
<Video src="/images/console/formbuilder/customize-sectional.mp4" ariaDescription="Video - Add sectional elements" />
