...
The schema generated is for a Todo app. You'll notice a `@model` directive on the `Todo` type. This directive is part of the [Amplify GraphQL API](/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/) category.
...
To test this out locally, you can run the `mock` command. Note: Refer to the [instructions to setup mocking](/gen1/[platform]/tools/cli/usage/mock/).
