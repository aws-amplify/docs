...
We highly recommend using the latest version and following this guide when setting up new projects. However, project setup guides are available for the [previous version](/gen1/[platform]/prev/start/project-setup/) if needed. 
