...
> To access non-sensitive configuration values in a Lambda function, use [environment variables](/gen1/[platform]/build-a-backend/functions/environment-variables/).
