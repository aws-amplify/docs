...
In addition to [the changes mentioned above](/gen1/[platform]/build-a-backend/storage/storage-v5-to-v6-migration-guide/#deprecated-options), the `getProperties` API in v6 also adds `key` to the result.
