...
Amplify CLI supports running a local mock server for testing your application with Amazon S3. Please see the [CLI toolchain documentation](/gen1/[platform]/tools/cli/usage/mock/) for more details.
