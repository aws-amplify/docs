...
Select `Individual Groups` to scope access permissions based on [Cognito User Groups](/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules/)
...
That's it! Your content storage is set up! Head to the [library's storage docs](/gen1/[platform]/build-a-backend/storage/set-up-storage/) to integrate this newly created S3 bucket into your app.
