...
Get a presigned URL of a stored file and expiration of URL. You can specify [access `level`](/gen1/[platform]/prev/build-a-backend/storage/configure-access/) of file
