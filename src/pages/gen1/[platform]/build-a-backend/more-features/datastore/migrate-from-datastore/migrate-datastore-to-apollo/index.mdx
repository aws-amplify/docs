...
export const meta = {
  ...
  description: 'Replace every Amplify DataStore operation with its Apollo Kotlin or Apollo iOS equivalent.',
  platforms: [
    'android',
    'swift'
  ]
...
In Apollo iOS, you create, update, and delete data using the [mutations](https://www.apollographql.com/docs/ios/fetching/mutations) defined in your schema.
...
In Apollo iOS, you query data using the [queries](https://www.apollographql.com/docs/ios/fetching/queries) defined in your schema.
