...
- A frontend application set up. For instructions on setting up an app, see [Project Setup: Create your application](/gen1/[platform]/start/project-setup/create-application/)
...
To learn more about queries, mutations, and subscriptions in more detail, see the guides to [_Create, update, and delete application data_](/gen1/[platform]/build-a-backend/graphqlapi/mutate-data/) and [_Read application data_](/gen1/[platform]/build-a-backend/graphqlapi/query-data/).
