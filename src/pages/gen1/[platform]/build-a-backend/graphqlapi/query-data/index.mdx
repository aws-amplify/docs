...
- An [application connected to the API](/gen1/[platform]/build-a-backend/graphqlapi/connect-to-api/)
...
- Sorting is [available in DataStore](/gen1/[platform]/build-a-backend/more-features/datastore/manipulate-data/#predicates) but not in AWS AppSync.
