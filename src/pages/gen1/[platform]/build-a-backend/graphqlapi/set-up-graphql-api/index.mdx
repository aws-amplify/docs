...
- The [Amplify CLI is installed and configured](/gen1/[platform]/tools/cli/start/set-up-cli/)
- Have an Amplify [project already initialized](/gen1/[platform]/tools/cli/start/key-workflows/#initialize-new-project)
...
`input AMPLIFY { globalAuthRule: AuthRule = { allow: public } }` allows you to get started quickly without worrying about authorization rules. Review the [Authorization rules](/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules/) section to setup the appropriate access control for your GraphQL API.
...
For Flutter, Android, and Swift client code generation, refer to [JavaScript, Android, Swift, and Flutter client code generation](/gen1/[platform]/build-a-backend/graphqlapi/client-code-generation/).
...
2. Modifying the [primary key](/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/#configure-a-primary-key) of a model
3. Modifying a Local Secondary Index of a model (only applies to projects with [secondaryKeyAsGSI](/gen1/[platform]/tools/cli/reference/feature-flags/#secondaryKeyAsGSI) turned off)
...
- [How to model your database table and their access patterns](/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/)
- [Secure your API with fine-grained authorization rules](/gen1/[platform]/build-a-backend/graphqlapi/customize-authorization-rules/)
- [Create relationships between different database model](/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/#setup-relationships-between-models)
- [Add custom business logic to the GraphQL API](/gen1/[platform]/build-a-backend/graphqlapi/custom-business-logic/)
- [Run search and result aggregation queries](/gen1/[platform]/build-a-backend/graphqlapi/search-and-result-aggregations/)
- [Connect to machine learning services](/gen1/[platform]/build-a-backend/graphqlapi/connect-machine-learning-services/)
- [Best practice and examples](/gen1/[platform]/build-a-backend/graphqlapi/best-practice/)
