...
Additionally, subscriptions will inherit related authentication when relational fields are set as required. To better protect relational data, consider modifying the schema to use optional relational fields.
</Callout>
