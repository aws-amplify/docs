...
- [Switching authentication flows](/gen1/[platform]/build-a-backend/auth/switch-auth/#customauth-flow)
- [Advanced workflows](/gen1/[platform]/build-a-backend/auth/advanced-workflows/)
