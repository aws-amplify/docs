...
where `<github-url>` is a valid sample Amplify project repository. Click [here](/gen1/[platform]/tools/cli/usage/headless/#--app) for more details.
...
If you are receiving errors on push regarding unknown GraphQL directives and have not yet migrated your GraphQL resource to use GraphQL Transformer v2, please review the [migration documentation page](/gen1/[platform]/tools/cli/migration/transformer-migration/) for an in-depth guide to migrating the resource.
