...
Team members will only be able to push to a stack only if they have the [correct credentials (access key/secret keys)](/gen1/[platform]/tools/cli/start/set-up-cli/#pre-requisites-for-installation) to do so.
