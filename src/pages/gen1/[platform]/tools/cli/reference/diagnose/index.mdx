...
* [backend-config.json](/gen1/[platform]/tools/cli/reference/files/#backend-configjson): Includes all the categories that were provided in the project.
* CloudFormation files: CLI generated CloudFormation files that are used to provide resources.
* [cli.json](/gen1/[platform]/tools/cli/reference/files/#clijson): The feature flag configuration.
* [amplify.state](/gen1/[platform]/tools/cli/reference/files/#general-category-files): Internal metadata on how to invoke the function category.
* [parameters.json](/gen1/[platform]/tools/cli/reference/files/#category-parametersjson) and cli-inputs.json. 
