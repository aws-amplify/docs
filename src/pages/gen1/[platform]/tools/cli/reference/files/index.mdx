...
Used to share project info within your team. Learn more at [Share single environment](/gen1/[platform]/tools/cli/teams/shared/#sharing-projects-within-the-team).
...
If you have opted in to [Usage Data](/gen1/[platform]/tools/cli/reference/usage-data) this file contains an installation UUID used to correlate data from your machine.
