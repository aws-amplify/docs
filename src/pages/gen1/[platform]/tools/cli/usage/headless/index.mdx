...
Contains configuration for AppSync [codegen](/gen1/[platform]/build-a-backend/graphqlapi/client-code-generation/), the following are the specifications:
...
Pushes schema changes that require removal or replacement of underlying tables. See [update schema](/gen1/[platform]/build-a-backend/graphqlapi/#update-schema).
