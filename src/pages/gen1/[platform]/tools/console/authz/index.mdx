...
Skip ahead to [set up authorization rules](/gen1/[platform]/tools/console/authz/permissions/) for the bookstore app, or learn about the different authorization modes below.
