...
1. Using the *Books* data model that you created in the [Create a data model example](/gen1/[platform]/tools/console/data/data-model/#Create-a-data-model-example), set the authorization mode to **Cognito user pool**. 
...
1. Using the *Books* data model that you created in the [Create a data model example](/gen1/[platform]/tools/console/data/data-model/#Create-a-data-model-example), set the authorization mode to **Cognito user pool**. 
2. Create an *Editors* group using the instructions to [create a group](/gen1/[platform]/tools/console/auth/user-management/#To-create-a-group). Alternately, you can create a new group from the **Add a new rule for...** menu.
