...
We can also use Amplify CLI to [import a Cognito user pool resource](/gen1/[platform]/tools/cli/commands/#auth-import).
...
We can also use Amplify CLI to [import a Cognito identity pool resource](/gen1/[platform]/tools/cli/commands/#auth-import).
