...
To set authorization rules that allow these users and groups to perform create, read, update, or delete operations on your app data, see [Authorization](/gen1/[platform]/tools/console/authz/).
...
A user can be confirmed by using the [pre-built UI components](/gen1/[platform]/build-a-backend/auth/set-up-auth/#enable-sign-up-sign-in-and-sign-out), [Amplify libraries](https://aws-amplify.github.io/amplify-js/api/modules/aws_amplify.auth.html)
