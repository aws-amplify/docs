...
Learn more about [Amplify Data.](/gen1/[platform]/build-a-backend/graphqlapi/)
...
Learn more about [Amplify Auth](/gen1/[platform]/build-a-backend/auth/).
...
Learn more about [Amplify Storage](/gen1/[platform]/build-a-backend/storage/set-up-storage/).
...
Figma to code is available for React users. Learn more about [Figma-to-code generation](/gen1/react/build-ui/uibuilder/).
...
Form Builder is available for React users. Learn more about [Form Builder](/gen1/react/build-ui/formbuilder/).
...
Learn more about [extensibility](/gen1/[platform]/tools/cli/#extensibility).
