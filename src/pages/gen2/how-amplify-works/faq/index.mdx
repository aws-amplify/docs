...
Not yet. After generally availablity of Gen 2, we will offer migration tooling that will help you move projects from Gen 1 to Gen 2.

**What platforms will Gen 2 support?** 

Gen 2 supports the same web and mobile platforms as Gen 1. 

**Which web frameworks will have first-class support?** 

Gen 2 offers support for all web frameworks that are supported in the Amplify libraries ( Next.js, React, Vue, and Angular).

**Does Gen 2 support mobile development?**

You can use a Gen 2 backend with a Swift, Kotlin, or Flutter app.
