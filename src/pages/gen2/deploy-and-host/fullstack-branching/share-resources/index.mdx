...
Sometimes you do not want to deploy new resources for every branch. For example you might have all your `feature` branches point to the backend resources deployed by the dev branch.
