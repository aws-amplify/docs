...
2. Submit a pull request to your `main` branch. Once your team has validated, merge to `main`. This will trigger a build on your `main` branch and update any frontend or backend resources that you have made changes to.
