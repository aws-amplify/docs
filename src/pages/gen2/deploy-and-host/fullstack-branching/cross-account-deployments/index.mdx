...
While building with Amplify CI/CD offers benefits such as zero-config setup, fullstack previews, centralized secrets management, Amplify Gen 2 makes it easy to integrate fullstack CI/CD into your custom pipelines (e.g. AWS CodePipeline, Amazon CodeCatalyst, GitHub Actions etc.). This guide will walk you through how to create a customized deployment pipeline for your AWS Amplify Gen 2 applications powered by Amazon CodeCatalyst and AWS Amplify Hosting. You can follow along the step-by-step process to build this deployment workflow for your cross account setup and can modify it based on your specific project needs.
