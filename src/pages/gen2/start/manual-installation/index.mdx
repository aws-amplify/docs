...
To get started, we will walk you through how to initialize your project, install dependencies, and author your first backend.
...
Moving forward, you can use other `define*` functions to _define_ additional resources. For example, you can define authentication:
...
And then define your data resource:
...
To upgrade existing Amplify (Gen 2) projects, use your Node.js package manager (e.g. `npm`) to update relevant backend packages:
