...
7. When prompted for the permission set type, choose **Predefined permission set** and the **Administrator Access** policy. Then select **Next**
8. Optionally change the permission set name and session duration, then select **Next**
...
15. When prompted to assign a user or group, select the **Users** tab, check the user created in step 13, and select **Next**
  ...
  ![AWS IAM Identity Center "AWS accounts" page assigning "amplify-admin" to the management AWS account](/images/gen2/account-setup/sso-aws-accounts.png)
