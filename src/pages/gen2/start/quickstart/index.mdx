...
![gen2](/images/gen2/getting-started/console4.png)

<Callout warning> If you have an existing Gen 2 application, you can modify the build image by navigating to _Hosting_ -> _Environment Variables_ and create a new environment variable `_CUSTOM_IMAGE`: `amplify:al2023` for specific or all branches, then redeploy the build. </Callout>
