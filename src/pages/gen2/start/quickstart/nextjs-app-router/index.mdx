...
3. In the Git provider screen, choose *Option 2: Start with an existing app*. Connect the repository you just deployed and pick a branch. Review all of your settings to ensure everything is set up correctly. Choose *Save and deploy* to deploy your web app to the AWS global content delivery network (CDN).
