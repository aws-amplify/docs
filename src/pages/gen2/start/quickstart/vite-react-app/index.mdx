...
This creates a new React app in a directory called react-amplify-gen2. You can then run the following commands to switch into the new 1react-amplify-gen2` directory and install the project dependencies:
