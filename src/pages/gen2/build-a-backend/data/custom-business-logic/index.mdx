...
`.computed()` makes fields read only and you have to decide on how to compute the field. You can either pass in a quick "mapping function" OR pass in entire resolver pipelines. <-- "is this possible at all?"
Option 1:
