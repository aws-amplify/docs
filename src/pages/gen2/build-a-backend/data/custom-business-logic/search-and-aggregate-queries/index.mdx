...
## Step1: Setting Up the OpenSearch Instance
...
## Step2: Setting Up Zero ETL from DynamoDB to OpenSearch

### Step2a: S3 Bucket and IAM Role
...
### Step2b: OpenSearch Service Pipeline
...
## Step3: Expose new queries on OpenSearch

### Step3a: Add the AppSync Resolver for the Search Query
...
```
### Step3c: Create Resolver and attach to query
