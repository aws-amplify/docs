...
The configuration is a data-prepper feature of OpenSearch. For specific documentation on DynamoDB configuration, refer to OpenSearch documentation.
...
![A screenshot of OpenSearch OSIS pipeline]
(/images/gen2/OpenSearch_pipeline.png)


You can also check this in the DynamoDB console by going to the Integrations section of the tables.

![A screenshot of OpenSearch OSIS pipeline]
(images/OpenSearch_DynamoDB_integration.png)
