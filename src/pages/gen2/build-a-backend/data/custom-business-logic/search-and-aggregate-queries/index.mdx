...
![A screenshot of OpenSearch OSIS pipeline](/images/gen2/OpenSearch_pipeline.png)


You can also check this in the DynamoDB console by going to the Integrations section of the tables.

![A screenshot of DynamoDB integration](images/OpenSearch_DynamoDB_integration.png)
