...
To grant an external AWS Resource or an IAM role access to Amplify Data's API, you will need to explicitly list the IAM role by adding them to the `allowListedRoleNames` property.
