...
In your app's entry point, make the following edits:

<BlockSwitcher>

<Block name="Next.js (App Router)">

TODO pending discussion with PM team

</Block>

<Block name="Next.js (Pages Router)">

TODO pending discussion with PM team

</Block>

<Block name="React (Vite)">

In your **main.tsx** file, import the Amplify library and configuration files. Then, configure the library with the following code snippet:
