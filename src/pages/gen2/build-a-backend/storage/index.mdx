...
<b>Coming soon: </b>The Storage experience for Amplify Gen 2 is still under development. You can add Amazon S3 to your Amplify Gen 2 project with AWS CDK.
</Callout>
...
Depending on the Node.js package manager you're using, you may encounter warnings about an unresolved peer dependency version that `@aws-amplify/backend` has on `aws-cdk-lib`. If you encounter a warning similar to the following, reinstall the version specified in the warning text:
