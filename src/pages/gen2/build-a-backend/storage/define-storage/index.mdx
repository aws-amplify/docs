...
Refer to the following example to construct access rules for your storage bucket or you can copy paste to test it out. You can also read more about the customizing authorization rules here.
