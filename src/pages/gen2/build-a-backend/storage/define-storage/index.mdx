...
Refer to the following example to construct access rules for your storage bucket or you can copy paste to test it out. [Learn more about customizing access to file prefixes](/gen2/build-a-backend/storage/authorization/).
