...
You can grant your backend function access to authentication resources, which will enable it to execute queries and operations against users and groups in your Cognito user pool.
...
This will grant the backend function, `demoFunction` ability to query users and updates to user in the Cognito user pool. See below for detailed list of permissions it grants.
...
|Action Name|Description|Granted Cognito Actions|
|-|-|-|
