...
For many apps, user sign-up and sign-in with a username and password is all that is required. Once authenticated, the app can talk to an API to access and mutate data. This is the method we illustrated in the [_Set up Amplify Auth_](../set-up-auth/) guide.
