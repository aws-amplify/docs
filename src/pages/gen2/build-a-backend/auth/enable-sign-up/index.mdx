...
For many apps, user sign-up and sign-in with a username and password is all that is required. Once authenticated, the app can talk to an API to access and mutate data. This is the method we illustrated in the [*Set up Amplify Auth*](../set-up-auth/) guide.

We will use the username and password authentication flow to get started. Both [third-party social provider federation](../add-social-provider/) and [Multi-factor authentication](../manage-mfa/) can be added after this initial setup.
...
For more information on handling the TOTP and MFA steps that may be returned, please see [_'Multi-factor authentication'_](../manage-mfa/).
...
- [Multi-factor authentication](../manage-mfa/)

TODO Review below as part of updates to above
