...
To configure your auth backend, edit the `amplify/auth/resource.ts` file. You can set up either sign in mechanisms that work with an email/phone and password, or use social provider sign-in.
