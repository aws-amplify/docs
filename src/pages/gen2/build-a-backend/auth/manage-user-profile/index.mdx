...
The backend authentication resource authored using `defineAuth` does not currently support adding custom attributes. If you wish to add custom attributes you will need to define them using [overrides](../override-cognito).
...
- [Set up password change and recovery](../password-management)
