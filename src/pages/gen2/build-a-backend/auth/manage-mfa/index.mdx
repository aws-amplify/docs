...
- An Amplify app set up (see the [Quickstart](../../../start/quickstart/) if you need to set up an app)
...
Below are the steps you can use to set up MFA using SMS or TOTP. Amplify Auth is designed to work with MFA even if you have set up your Amazon Cognito resources separately.
...
<Accordion title='Track devices in the Cognito User Pool console' headingLevel='4' eyebrow='Learn more'>

You can also enable the remembered device functionality in the Cognito User Pool console. To begin, go to your project directory and issue the command:
...
- [Listen to auth events](../auth-events/)
- [Set up admin actions and user group management](../admin-actions/)
