...
Auth has several events that can trigger functions to perform custom sign up, sign in and other tasks. Here we're going to configure a "preSignUp" trigger, but configuring any trigger is the same process.
