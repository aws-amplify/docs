...
The CLI should open the GraphQL schema, located at amplify/backend/api/myapi/schema.graphql, in your text editor. Update the schema with the following and save the file:
