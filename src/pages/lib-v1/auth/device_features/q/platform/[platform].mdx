...
import js0 from '/src/fragments/lib-v1/auth/common/device_features/common.mdx';

<Fragments fragments={{ js: js0 }} />

import reactnative0 from '/src/fragments/lib-v1/auth/common/device_features/common.mdx';
