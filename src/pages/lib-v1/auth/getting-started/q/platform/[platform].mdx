...
- Automatically populate your Amplify Library configuration files (aws-exports.json, amplifyconfiguration.json) with your chosen Amazon Cognito resource information
