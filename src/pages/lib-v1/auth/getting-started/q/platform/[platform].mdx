...
- Automatically populate your Amplify Library configuration files (amplifyconfiguration.json, amplifyconfiguration.json) with your chosen Amazon Cognito resource information
