...
- Automatically populate your Amplify Library configuration files (amplifyconfiguration.json.js, amplifyconfiguration.json) with your chosen Amazon Cognito resource information
