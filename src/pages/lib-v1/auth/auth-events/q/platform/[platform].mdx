...
- [Manage user profile](/lib-v1/auth/manageusers/q/platform/js/)
- [Set up password change and recovery](/lib-v1/auth/password_management/q/platform/js/)

</InlineFilter>

<InlineFilter filters={["react-native"]}>

- [Manage user profile](/lib-v1/auth/manageusers/q/platform/react-native/)
- [Set up password change and recovery](/lib-v1/auth/password_management/q/platform/react-native/)
