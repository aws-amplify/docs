...
Before you begin, you should have finished the [*Set up and connect backend resources*](/lib-v1/auth/getting-started/q/platform/js/#set-up-and-connect-backend-resources) section of the *Set up Amplify Auth* guide.
...
Before you begin, you should have finished the [*Set up backend resources*](/lib-v1/auth/getting-started/q/platform/react-native/#set-up-backend-resources) section of the *Set up Amplify Auth* guide.
...
We will use the username and password authentication flow to get started. Both [third-party social provider federation](/lib-v1/auth/social/q/platform/js/) and [Multi-factor authentication](/lib-v1/auth/mfa/q/platform/js/) can be added after this initial setup.

</InlineFilter>

<InlineFilter filters={["react-native"]}>

We will use the username and password authentication flow to get started. Both [third-party social provider federation](/lib-v1/auth/social/q/platform/react-native/) and [Multi-factor authentication](/lib-v1/auth/mfa/q/platform/react-native/) can be added after this initial set up.
...
<InlineFilter filters={["react-native"]}>
  ...
  Now that you completed setting up Amplify Auth with username and password, you may also want to add some additional features. We recommend:
  - [Social sign-in (OAuth)](/lib-v1/auth/social/q/platform/react-native/)
  - [Multi-factor authentication](/lib-v1/auth/mfa/q/platform/react-native/)
