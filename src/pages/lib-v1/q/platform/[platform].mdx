...
Welcome to the developer preview of **Amplify JavaScript library V6**. This preview introduces functional interfaces, typescript improvements and improved NextJS SSR support  for Authentication, Analytics and Storage.
