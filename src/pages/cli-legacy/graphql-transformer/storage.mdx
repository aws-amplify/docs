...
Some parts of this documentation is referring to the AWS AppSync SDK for JavaScript (V2), which is now in Maintenance mode. Please refer to the [Upgrade Guide](/lib/graphqlapi/upgrade-guide) and the [Working with Files](/lib/graphqlapi/working-with-files/) guide for updated guidance.
