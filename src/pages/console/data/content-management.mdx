...
3. On the **Actions** menu you have two options for downloading data.
  ...
  2. Choose **Download all items (.csv)** to download all rows of data on the currently selected model. Apps with conflict resolution disabled will show **Download visible items (.csv)** to download all the rows of data that are currently loaded into the table for the selected model.
