...
<Grid grid-gap="2" columns={1} className="margin-top-lg margin-bottom-lg">
  ...
  >
    <CardGraphic alt="Admin UI logo" src="/images/console/adminui.svg" />
    <CardDetail>
