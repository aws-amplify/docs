...
You are going to define set up role-based authorization rules for each of the models that you created for our bookstore example. Authorization rules help in restricting who can query or update a table based on certain conditions. 
