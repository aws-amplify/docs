...
![Owner authorization rules on a GraphQL data model](/images/console/10_ownersaccess.png)
...
![Private authorization rules on a GraphQL data model](/images/console/11_privatesaccess.png)
...
![Process of adding group authorization rules by selecting "Add a new rule" in the menu on a GraphQL data model](/images/console/8_menudetaileditors.png)
...
![Group authorization rules on a GraphQL data model](/images/console/9_editorgroupaccess.png)
...
![Public authorization rules on a GraphQL data model](/images/console/7_publicauthreadonly.png)
