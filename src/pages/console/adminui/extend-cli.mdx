...
To resolve this error, remove the `override.ts` file or custom resources and run `amplify push`. Alternatively, you can use Amplify CLI to build and push your resources. But you will not be able to deploy with Amplify Studio.
