...
The above errors are encountered if an Amplify project has an `override.ts` file or [custom resources](https://docs.amplify.aws/cli/custom/cdk/) deployed in the project. Amplify Studio does not support deploying projects containing override and custom resources.
