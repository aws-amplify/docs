...
1. If present, remove the leftover artifacts created in your current directory (Ex: `amplify` or `amplify-backup`) from the failed pull attempt
1. Rerun the Amplify CLI `amplify pull --appId <appID> --envName <envName>` command
