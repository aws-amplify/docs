...
This message occurs if the Amplify project has an `override.ts` file present in your resources. Amplify Studio does not support deploying projects containing this file. 

To resolve this error, remove the `override.ts` file and run `amplify push`. Alternatively, you can use Amplify CLI to build and push your resources. But you will not be able to deploy with Amplify Studio.
