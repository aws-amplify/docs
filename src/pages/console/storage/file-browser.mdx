...
By default your storage is created with a **public/** folder, which contains files that are accessible by all users of your app. Your files will be uploaded into **public/** by default when using Amplify methods and UI components. To access the **private/** and **protected/** folders, you need to use [Amplify storage libraries](https://docs.amplify.aws/lib/storage/getting-started/q/platform/js/).
