...
By default, your storage is created with the following folders:
...
Your files will be uploaded into **public/** by default when using Amplify methods and UI components. To access **private/** and **protected/**, use the [Amplify storage libraries.](https://docs.amplify.aws/lib/storage/getting-started/q/platform/js/)
