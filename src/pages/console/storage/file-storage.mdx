...
3. On the application information page, choose **[Launch Studio](/console/adminui/start/#log-into-the-amplify-console)**.
4. On the **Set up** menu, choose **Storage**.
5. On the **Storage** page, locate the **Authorization settings** on the bottom of the _File storage bucket_ card.
