...
3. On the application information page, choose the **Backend environments** tab, then choose **[Launch Studio](/console/adminui/start/#log-into-the-amplify-console)**.
