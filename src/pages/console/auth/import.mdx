...
![Process to add authentication using a imported Amazon Cognito user pool resource](/images/studio/import-auth.png)

Select a Cognito user pool and App clients required for your application.

![Selecting a user pool and app clients for a imported Amazon Cognito user pool resource](/images/studio/import-auth-selection.png)
...
![Process to import Amazon Cognito identity pool resource](/images/studio/import-identity-pool.png)
