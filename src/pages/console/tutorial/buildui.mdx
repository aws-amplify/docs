...
Back in Studio, select “Sync from Figma” button to review all the components from your Figma file. 
...
Either select **Accept all** or review individual components with the **Reject** and **Accept** buttons.
