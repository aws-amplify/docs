...
With Studio’s new “UI Library (Preview)”, you can sync components from Figma to React code. Amplify also provides you with a handy Figma file to get started faster. The Amplify Figma file includes both UI primitives and component templates. You can also create your own component in Figma! In this tutorial, we'll create a home listings app using Amplify Studio.

## Create UI components in Figma

1. **Clone the [Amplify UI Figma file](https://www.figma.com/community/file/1045072739574466126)**
...
In preview, you need to clone the Amplify-provided Figma file. At General Availability, our plan is to give you the ability to bring your own Figma file! 
</Callout>
