...
Studio also allows you to bind UI elements to real backend data. Add properties to components, then reference the properties in your child UI elements. To get started, navigate into a UI component by choosing the **Configure** button in the **UI Library**. For this example, you'll use the _CardB_ component.
