...
1. In your application's root directory, install the following npm dependencies
...
Now that your components are synced, navigate to a component and select **Configure**. To get your React code, select **Get component code**.
