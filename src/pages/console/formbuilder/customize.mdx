...
Use the Form Builder in [Amplify Studio](/console/adminui/start/#logging-in-and-creating-an-app) to customize React form components. You can add new form inputs, bind them to a field, customize labels, and add validation rules.
