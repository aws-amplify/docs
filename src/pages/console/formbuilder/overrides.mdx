...
[Amplify Studio](/console/adminui/start/#logging-in-and-creating-an-app) Forms are all based on top of the [Amplify UI library](https://ui.docs.amplify.aws/). The generated form provides a mechanism to override properties for each individual input component.
