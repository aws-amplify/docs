export const meta = {
  ...
  description: "Amplify Studio's generated forms come with three action buttons: **Submit**, **Cancel**, and **Clear** or **Reset**, depending on whether the form creates or updates a record."
}
