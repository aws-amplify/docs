export const meta = {
  ...
  description:
    "Amplify Studio's generated forms come with three action buttons: **Submit**, **Cancel**, and **Clear** or **Reset**, depending on whether the form creates or updates a record."
};

[Amplify Studio's](/console/adminui/start/#logging-in-and-creating-an-app) generated forms come with three action buttons: **Submit**, **Cancel**, and **Clear** or **Reset**, depending on whether the form creates or updates a record.

## Change button positions

You can choose to show the action buttons on the bottom (default), top, or top and bottom of the form.

1. Select the action buttons
...
If you hide all form action buttons, you can still leverage the [`onChange` event handler](/console/formbuilder/lifecycle/#get-form-data-as-your-user-inputs-data---onchange) to self-manage the form lifecycle. This is useful for a form that updates data in real-time without explicit user confirmation.
