...
If your data model has relationships, Studio will use an [autocomplete field](https://ui.docs.amplify.aws/react/components/autocomplete) that is automatically populated with records from the related data model. 
...
- Forms that start with a **Data model** will be pre-connected to your API, and will start will fields that match the bound data model
