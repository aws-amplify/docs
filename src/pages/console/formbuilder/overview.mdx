...
Form builder now supports **GraphQL APIs without Conflict Resolution**. [Learn more about GraphQL and Conflict Resolution here](/console/data/data-model/#datastore-and-graphql). 
