...
If you have a [Connected Form](/console/formbuilder/data-binding/#connected-forms) bound to a data model with [relationships](/console/data/relationships/), Form Builder uses a special field to handle submission. The **Autocomplete** field will allow your form submitters to select one or more records from a related data model. These connected autocomplete fields have some special configuration settings. 
