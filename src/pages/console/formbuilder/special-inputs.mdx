...
Studio Form Builder supports relationships in **all Amplify GraphQL APIs, with and without DataStore**.
...
When you are satisfied with your form configuration and style, [your forms can be generated in your local project](/console/formbuilder/overview/#render-react-form-in-your-app). 

**If your GraphQL API is not using DataSore, forms with relationships require a query codegen depth of 4**, and will not work as expected otherwise. To update your query depth:
