export const meta = {
  ...
  description: `Gotchas and limitations of the Figma-to-React capabilities of Amplify Studio`,
};

We're constantly improving Amplify Studio to make Figma-to-React code conversion better but there are some limitations that you should be aware of.
