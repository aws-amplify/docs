...
<Callout note>
  ...
  <p>
    Currently, Component Slots only support one-to-many data relationships, like one Post to many Comments. Many-to-many relationships will be added in the future.
  </p>
</Callout>
