...
|-|-|
|![Studio configurator](/images/console/go_to_url_studio.png) | ![Interactive website](/images/console/go_to_url_app.gif)|
...
![Studio configurator](/images/console/go_to_url_collection.png) 
...
In your app code, you can set an onClick handler for Home collections to show the delete modal. Then, set the `DeleteHome` component's `home` property to configure which home to delete. You can also listen in to the `ui` Hub events to dismis the modal after the record is deleted. 
