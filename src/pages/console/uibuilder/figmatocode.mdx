...
1. Launch the [Amplify Theme Editor plugin](https://www.figma.com/community/plugin/1040722185526429545/AWS-Amplify-Theme-Editor) and click the update button. (optional) View which components are broken by examining the broken component links. ![figma](/images/console/figma-migration.gif)
