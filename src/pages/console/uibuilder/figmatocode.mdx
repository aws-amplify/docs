...
1. Copy everything in the 'README' page of the newest community file into your customized Figma file
...
1. Copy everything in the 'Primitives' page of the new Figma file, and paste it into the 'Primitives' page of your customized Figma file.
