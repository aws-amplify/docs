...
1. In the new Figma file, launch the [Amplify Theme Editor plugin](https://www.figma.com/community/plugin/1040722185526429545/AWS-Amplify-Theme-Editor) and click 
the update button. (optional) View which component instances are outdated by clicking the 
broken component links. Update the broken component instances to point to matching local 
components on the 'Primitives' page. **This is important because if you do not do this, your design might look ok, but the React code it generates won't use
 the [Amplify UI components](https://ui.docs.amplify.aws).**
