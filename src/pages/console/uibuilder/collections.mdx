...
- Collections cannot include [Search](#set-search-and-pagination)
...
Collections bound to an API without DataStore cannot be sorted. [Learn more about DataStore and Conflict Resolution](/console/data/data-model/#datastore-and-graphql)
...
Collections bound to GraphQL APIs without DataStore cannot use Search. [Learn more about DataStore and Conflict Resolution](/console/data/data-model/#datastore-and-graphql)
...
For collections bound to GraphQL APIs without DataStore, pagination has limited support. Users can step forward through pages (e.g. page 1 to page 2), but cannot skip pages (e.g. page 1 to page 3). [Learn more about DataStore and Conflict Resolution](/console/data/data-model/#datastore-and-graphql)
