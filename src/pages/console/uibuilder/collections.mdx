...
5. Components that already have data model bindings, automatically map data to child elements. For components that do not have data model bindings, 

![Screenshot showing data binding](/images/console/ui-collections-databind.png)

### Set filters

Filters help control what records can be displayed in a collection

![Screenshot showing setting filters](/images/console/ui-collections-set-filters.png)

### Set sort conditions

Sort conditions help control the direction records can be displayed in a collection 
