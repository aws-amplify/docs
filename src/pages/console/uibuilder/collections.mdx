...
[Amplify Studio](/console/adminui/start/#logging-in-and-creating-an-app) offers a visual way to bind collections to items in your data model. Collection items can be filtered, sorted, or linked to specific records from the content management view.

1. Create a [collection](/console/tutorial/collections/) from a component
