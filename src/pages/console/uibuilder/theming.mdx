...
The Amplify Theme Editor allows you to apply breakpoints to your components to make them responsive. To change the pixel values for your breakpoints:
1. Open the Amplify Theme Editor
...
You can learn more about how to use breakpoints in our [Responsive components documentation](responsive/).  
