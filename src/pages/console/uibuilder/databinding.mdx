...
You need to deploy a data model in order to bind to data. [Clone the Home example to get started](https://sandbox.amplifyapp.com/schema-design/a66f071a-4eea-4277-8d03-a851f2a08e79/clone). Studio supports GraphQL APIs [with and without DataStore](/console/data/data-model/#datastore-and-graphql).
