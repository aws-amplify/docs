...
Amplify Studio provides [data action bindings](/console/uibuilder/actionbinding#bind-ui-to-create-update-or-delete-a-data-record) but if you can also self-manage the form submission states and workflows in code.
...
Amplify Studio provides [navigation action bindings](/console/uibuilder/actionbinding/#bind-ui-to-navigation-actions) but if you want to integrate with your own routing system, you can also self-manage the navigation actions. 
