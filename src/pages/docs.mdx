...
<Container
  ...
  <Grid columns="4" class="margin-top-lg">
      <Card url="/lib" class="border-radius">
      ...
      <Card url="/cli" class="border-radius">
      ...
      <Card url="/console/console" class="border-radius" >
      ...
      <Card url="/console/adminui/intro" class="border-radius">
        <img slot="graphic" src="/assets/console.png" />
