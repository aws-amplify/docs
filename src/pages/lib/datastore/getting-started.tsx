        ...
        <InnerContainer>
          ...
          <section>
            ...
            >
              <Card
                className="vertical"
                href="/lib/datastore/getting-started/q/platform/js"
              >
              ...
              <Card
                className="vertical"
                href="/lib/datastore/getting-started/q/platform/android"
              >
              ...
              <Card
                className="vertical"
                href="/lib/datastore/getting-started/q/platform/ios"
              >
              ...
              <Card
                className="vertical"
                href="/lib/datastore/getting-started/q/platform/flutter"
              >
