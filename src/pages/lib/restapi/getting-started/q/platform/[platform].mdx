...
import js0 from '/src/fragments/lib/restapi/native_common/getting-started/common.mdx';

<Fragments fragments={{ js: js0 }} />

import reactnative0 from '/src/fragments/lib/restapi/native_common/getting-started/common.mdx';
