...
import js0 from '/src/fragments/lib/project-setup/native_common/prereq/common_body.mdx';

<Fragments fragments={{ js: js0 }} />

import reactnative0 from '/src/fragments/lib/project-setup/native_common/prereq/common_body.mdx';
