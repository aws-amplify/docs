...
import android_escape_hatch from '/src/fragments/lib/geo/android/escapehatch.mdx';
import ios_escape_hatch from '/src/fragments/lib/geo/ios/escapehatch.mdx';

<Fragments
  fragments={{ android: android_escape_hatch, ios: ios_escape_hatch }}
/>
