export const meta = {
  title: `ConsoleLogger`,
  description: `AWS Amplify writes console logs through ConsoleLogger. You can use ConsoleLogger in your apps for the same purpose.`,
  filterKey: 'platform',
...
AWS Amplify writes console logs through ConsoleLogger. You can use ConsoleLogger in your apps for the same purpose.
