...
- An [application connected to the API](/lib/graphqlapi/getting-started/q/platform/android/)

</InlineFilter>

<InlineFilter filters={["ios"]}>

- An [application connected to the API](/lib/graphqlapi/getting-started/q/platform/ios/)

</InlineFilter>

<InlineFilter filters={["flutter"]}>

- An [application connected to the API](/lib/graphqlapi/getting-started/q/platform/flutter/)

</InlineFilter>

## Run mutations to create, update, and delete application data
  
In GraphQL, mutations are APIs that are used to create, update, or delete data. This is different than queries that are used to read the data but not change it. What follows are some examples of how you can create, update, and delete items using the Amplify GraphQL client.
...
__Note:__ You do not have to pass in the `createdAt` field. Amplify manages this field for you.
...
- You do not have to pass in the `updatedAt` field. AWS Amplify manages this field for you.
- If you pass in *extra* input fields not expected by the API, this query will fail. You can see this in the `error` field returned by the query. In GraphQL, errors are not thrown like exceptions in other languages. Instead, any errors are captured and returned as part of the query result in the `error` field.
...
- [Read application data](/lib/graphqlapi/query-data/q/platform/react-native/)
...
- [Read application data](/lib/graphqlapi/query-data/q/platform/ios/)
- [Subscribe to real-time events](/lib/graphqlapi/subscribe-data/q/platform/ios/)

</InlineFilter>

<InlineFilter filters={["android"]}>

- [Read application data](/lib/graphqlapi/query-data/q/platform/android/)
- [Subscribe to real-time events](/lib/graphqlapi/subscribe-data/q/platform/android/)

</InlineFilter>

<InlineFilter filters={["flutter"]}>

- [Read application data](/lib/graphqlapi/query-data/q/platform/flutter/)
- [Subscribe to real-time events](/lib/graphqlapi/subscribe-data/q/platform/flutter/)
