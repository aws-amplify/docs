...
In this guide, you will learn how to create, read, update, and delete your data using Amplify Libraries' GraphQL client.

Before you begin, you will need:
- An [application connected to the API](https://docs.amplify.aws/lib/graphqlapi/connect/q/platform/js/)

## Run mutations to create, update, and delete application data
  
In GraphQL, mutations are APIs that are used to create, update, or delete data. This is different than queries that are reserved to reading the data but not change it. What follows are some examples of how you can create, update, and delete items using the Amplify GraphQL client.
