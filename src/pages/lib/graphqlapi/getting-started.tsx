        ...
        <InnerContainer>
          ...
          <section>
            ...
            >
              <Card
                className="vertical"
                href="/lib/graphqlapi/getting-started/q/platform/js"
              >
              ...
              <Card
                className="vertical"
                href="/lib/graphqlapi/getting-started/q/platform/react"
              >
              ...
              <Card
                className="vertical"
                href="/lib/graphqlapi/getting-started/q/platform/angular"
              >
              ...
              <Card
                className="vertical"
                href="/lib/graphqlapi/getting-started/q/platform/vue"
              >
