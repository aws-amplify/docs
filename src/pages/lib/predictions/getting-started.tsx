        ...
        <InnerContainer>
          ...
          <section>
            ...
            >
              <Card
                className="vertical"
                href="/lib/predictions/getting-started/q/platform/js"
              >
              ...
              <Card
                className="vertical"
                href="/lib/predictions/getting-started/q/platform/android"
              >
              ...
              <Card
                className="vertical"
                href="/lib/predictions/getting-started/q/platform/ios"
              >
