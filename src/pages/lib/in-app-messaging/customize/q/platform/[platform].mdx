...
import reactnative0 from '/src/fragments/lib/in-app-messaging/customize/customize.mdx';

<Fragments fragments={{ 'react-native': reactnative0 }} />

import js0 from '/src/fragments/lib/in-app-messaging/customize/customize.mdx';
