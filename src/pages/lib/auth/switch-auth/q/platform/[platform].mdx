...
import android_switch_auth from '/src/fragments/lib/auth/android/switch-auth/switch-auth.mdx';
import ios_switch_auth from '/src/fragments/lib/auth/ios/switch-auth/switch-auth.mdx';

<Fragments fragments={{ android: android_switch_auth, ios: ios_switch_auth }} />
