...
import common_getting_started from '/src/fragments/lib/auth/native_common/getting_started/common.mdx';
...
import js_authenticator_support from '/src/fragments/lib/v6/callout/auth-authenticator-support.mdx';
...
<Callout warning>
  ...
  If you need to support Multi-Factor Authentication (i.e. TOTP & SMS codes) in your application make sure to enable it during this step to avoid having to revisit this process. Please see [Set Up Backend Resources](/lib/auth/mfa/q/platform/js/#set-up-backend-resources) for more information.
