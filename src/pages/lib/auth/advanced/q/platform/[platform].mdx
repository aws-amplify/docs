...
import ios_advanced from '/src/fragments/lib/auth/ios/advanced/advanced.mdx';
import android_advanced from '/src/fragments/lib/auth/android/advanced/advanced.mdx';
import flutter_advanced from '/src/fragments/lib/auth/flutter/advanced/advanced.mdx';

<Fragments
  fragments={{
    ios: ios_advanced,
    android: android_advanced,
...
import federation from '/src/fragments/lib/v6/callout/auth-federation.mdx';
