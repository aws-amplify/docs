...
import common_social_signin_web_ui from '/src/fragments/lib/auth/native_common/social_signin_web_ui/common.mdx';

<Fragments
  fragments={{
    ios: common_social_signin_web_ui,
    android: common_social_signin_web_ui,
    flutter: common_social_signin_web_ui
  }}
/>
