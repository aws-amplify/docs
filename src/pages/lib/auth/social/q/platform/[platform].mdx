...
V6_TODO: Update APIs to use the new `signInWithRedirect API, and make the example more minimal. 
...
V6_TODO: The example here needs to be cleaned up for React Native
