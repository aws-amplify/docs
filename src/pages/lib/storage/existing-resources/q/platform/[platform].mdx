...
If you are using Amplify CLI you can first import and configure the CLI generated `amplifyconfiguration.json` file and then you can then manually configure Storage like this:
