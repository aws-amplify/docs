...
The open-source Amplify provides the following products to build full-stack iOS, Android, Flutter, Web, and React Native apps:
...
The **Amplify [Hosting](https://aws.amazon.com/amplify/hosting/)** is an AWS service that provides a git-based workflow for continuous deployment & hosting of full-stack web apps. Cloud resources created by the Amplify CLI are also visible in the Amplify Console.
