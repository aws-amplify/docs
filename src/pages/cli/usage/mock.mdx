...
A GraphQL Lambda resolver connected to your schema using [@function](/cli/graphql-transformer/function) can be mocked using [`amplify mock api`](#api-mocking-setup). For example, if you have a function named **quoteOfTheDay** and a schema like:
