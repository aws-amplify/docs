...
**Resource**: Specify resources that the AWS resource needs access. The resource accepts multiple ARN's for a service and wild card character ‘*’ is accepted.
