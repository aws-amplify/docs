...
Packages from external package managers like `npm` can be used in command hooks scripts. In this example, you'll install `axios` as a dependency for our Node.js hooks.
