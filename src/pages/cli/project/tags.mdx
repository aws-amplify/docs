...
> The tag configuration file is created, when you run "amplify init" and the initial Amplify project resources are created. You can optionally also pre-create the `amplify/backend/tags.json` configuration file before "amplify init". This allows you to tag the initial Amplify project resources with your designated tags as well. 
