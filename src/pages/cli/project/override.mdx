...
Run the command above to override Amplify-generated project-level resources, such as IAM roles for authenticated and unauthenticated. Note: Due to the dependencies on auth and unauth roles, it is recommended to ONLY modify these resources at the beginning of your project, when no other resources are added yet.
