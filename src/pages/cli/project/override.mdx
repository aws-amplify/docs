...
## Example: Modify unauthRole's IAM policies

For example, use `amplify override project` to further modify the unauthRole policy for Geo category beyond the default policy statements:
