...
If you want the users of the Cognito group added above to be able to render a map or search for places in your application, 
follow the instructions as mentioned [in the section below](#granting-maps-andor-search-permissions-to-a-group-of-users).
