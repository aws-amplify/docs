...
You can check the pricing plan for Geo resources from `geo/<resourceID>/pricingPlan` attribute in your project metadata file located at `amplify/backend/amplify-meta.json` in your project.
