...
For example, to use storage override to update the S3 storage public Auth policy for S3 PUT and GET access while keeping existing policies, we can use the following example:
