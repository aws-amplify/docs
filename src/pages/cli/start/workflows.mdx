...
When working with secrets in your Amplify project it is important to safeguard your secrets from being exposed by being committed to GitHub. We recommend using [git-secrets](https://github.com/awslabs/git-secrets) from [AWS Labs](https://github.com/awslabs). Once installed, it will scan your local repository for secrets and prevent you from committing them.