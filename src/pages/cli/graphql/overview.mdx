...
As part of the `amplify push` deployment workflow, a new `aws-exports.js` file is generated for you. `aws-exports.js` is the client configuration file for the Amplify libraries, it includes your API endpoint URL, authentication information, and region. 
...
For Flutter, Android, and Swift client code generation, refer to [JavaScript, Android, Swift, and Flutter client code generation](/cli/graphql/client-code-generation/).
...
Import the `generateClient` function from the Amplify Library to create your API client. In addition, also import related generated client code:
