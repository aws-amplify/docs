...
**Note:** Amplify will always use the most specific authorization rule that's present. For example, a field-level authorization rule will be used in favor of a model-level authorization rule; similarily, a model-level authorization rule will be used in favor of a global authorization rule. 
