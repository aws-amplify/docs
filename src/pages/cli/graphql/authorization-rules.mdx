...
import accordion from '/src/fragments/cli/graphql/authorization_strategies.mdx';

<Fragments fragments={{ all: accordion }} />

import accordionWithButton from '/src/fragments/cli/graphql/authorization_strategies_button.mdx';

<Fragments fragments={{ all: accordionWithButton }} />
