...
const result = await client.graphql(graphqlOperation(getInventory, params));
...
const result = await client.graphql(graphqlOperation(createProject, params));
...
const result = await client.graphql(graphqlOperation(createPost, params));
...
const result = await client.graphql(graphqlOperation(createPost, postParams));
const post = result.data.createPost;
...
await client.graphql(graphqlOperation(createComment, commentParams));

// get post
const result = await client.graphql(graphqlOperation(getPost, { id: post.id }));
...
const result = await client.graphql(graphqlOperation(createTeam, teamParams));
...
const tagResult = await client.graphql(graphqlOperation(createTag, tagParams));
...
await client.graphql(graphqlOperation(createPostTags, postTagParams));

// get posts
const listPostsResult = await client.graphql(graphqlOperation(listPosts));
...
const subscription = client.graphql(graphqlOperation(onCreateTask, filter)).subscribe({
