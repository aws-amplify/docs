...
## Subscriptions Runtime Filtering

You can filter the subscriptions server-side by passing a filter expression.
...
If you want to subscribe to tasks of type `Security` and priority greater than `5`, you can set the `filter` argument accordingly.
