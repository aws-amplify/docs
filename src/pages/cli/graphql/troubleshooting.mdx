...
When you generate models with the GraphQL improvePluralization feature flag enabled, they will be incompatible with iOS SDK versions earlier than 1.15.4 and Android SDK versions earlier than 1.28.3. Other libraries are not impacted.
