...
Creating a geo query is straightforward. The first step is to create a custom resolver. For more information on creating custom resolvers check [here](https://docs.amplify.aws/cli/graphql/custom-business-logic/#how-it-works-1).
