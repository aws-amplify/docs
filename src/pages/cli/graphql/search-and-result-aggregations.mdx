...
This total will be calculated based on all records, in the case of pagination even if not all records can be returned at once the total will still be representative of all matching results.
...
The same as [total](#total-count-of-search-results), these aggregates will be calculated based on all matching records, aggregate results are not based on pagination
