...
### Multi-Environment Workflow
 ...
 To specify AWS ARN resources across environments, an optional ‘\${env}’ parameter can be used. The ‘\${env}’ parameter in the AWS ARN resource will get populated with the current Amplify environment name at deployment.
