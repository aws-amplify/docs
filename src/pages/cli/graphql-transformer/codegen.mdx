...
After completing the [Amplify Getting Started](/start/start) navigate in your terminal to an Xcode project directory and run the following:
...
After completing the [Amplify Getting Started](/start/start) navigate in your terminal to an Android Studio project directory and run the following:
