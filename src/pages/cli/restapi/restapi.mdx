...
If your app uses User Pool Groups to manage different user types and would like to restrict access of specific routes to specifc User Pool Groups. We can accomplish this by the following flow: 
- Create API route. 
