...
- Restrict-access to the API route to the user-group.

>
> The following example flow assumes the existence of two User Pools : AdminUsers and GuestUsers for a Book store.
...
```
At the end of this command you can verify the routes and their respective user group restrictions in the `cli-inputs.json` file at the following path.
```bash
