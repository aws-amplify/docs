...
<Callout>Note: When an Amplify environement is deleted, all parameters under that environment name are deleted in Parmater Store. When an Amplify project is deleted, all parameters for that appId are deleted along with it.</Callout>
