...
A complete list of all translatable strings can be found in [`Translations.ts`](https://github.com/aws-amplify/amplify-ui/blob/main/packages/ui/src/i18n/translations.ts).
