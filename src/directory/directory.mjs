              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/connect-api-to-existing-database/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/data-modeling/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/customize-authorization-rules/index.mdx'
                    },
                    {
                    ...
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/customize-authorization-modes/index.mdx'
                    },
                    {
                    ...
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/custom-business-logic/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/search-and-result-aggregations/index.mdx'
                    },
                    {
                    ...
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/client-code-generation/index.mdx'
                    },
                    {
                    ...
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/connect-machine-learning-services/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/schema-evolution/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/modify-amplify-generated-resources/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/troubleshooting/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/upgrade-guide/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/best-practice/index.mdx',
                      children: [
                        {
                          path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/best-practice/batch-put-custom-resolver/index.mdx'
                        },
                        {
                          path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/best-practice/query-with-sorting/index.mdx'
                        },
                        {
                          path: 'src/pages/[platform]/prev/build-a-backend/graphqlapi/best-practice/warehouse-management/index.mdx'
                        }
                      ]
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/restapi/configure-rest-api/index.mdx'
                    },
                    {
                    ...
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/restapi/override-api-gateway/index.mdx'
                    }
                  ]
                },
                {
                ...
                },
                {
                  ...
                  children: [
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/functions/set-up-function/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/functions/layers/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/functions/environment-variables/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/functions/secrets/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/functions/build-options/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/functions/configure-options/index.mdx'
                    },
                    {
                      path: 'src/pages/[platform]/prev/build-a-backend/functions/graphql-from-lambda/index.mdx'
                    }
                  ]
                },
                {
