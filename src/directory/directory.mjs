          ...
          children: [
            {
              ...
              children: [
                ...
                {
                  path: 'src/pages/gen2/build-a-backend/auth/user-management/index.mdx'
                },
                {
                  path: 'src/pages/gen2/build-a-backend/auth/client-side/index.mdx'
                },
                {
                  path: 'src/pages/gen2/build-a-backend/auth/server-side/index.mdx'
                },
                {
                  path: 'src/pages/gen2/build-a-backend/auth/modify-resources-with-cdk/index.mdx'
                },
                {
                  path: 'src/pages/gen2/build-a-backend/auth/moving-to-production/index.mdx'
                }
              ]
            },
            {
