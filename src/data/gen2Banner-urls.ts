...
export const GEN2BANNER_URLS = [
  ...
  '/next/prev/start/project-setup/create-application',
  ...
  '/next/start/project-setup/create-application',
  ...
  '/next/start/getting-started/data-model',
  ...
  '/next/start/getting-started/hosting',
  ...
  '/next/start/getting-started/installation',
  ...
  '/next/start/getting-started/nextsteps',
  ...
  '/next/start/getting-started/setup',
  ...
  '/next/start/getting-started/introduction',
