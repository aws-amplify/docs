...
- An GraphQL API already set up either via the [Amplify CLI](/lib-v1/graphqlapi/getting-started/), or directly via the underlying [AWS AppSync service](https://docs.aws.amazon.com/appsync/latest/devguide/designing-a-graphql-api.html).
...
To learn more about queries, mutations, and subscriptions in more detail, see the guides to [_Create, update, and delete application data_](/lib-v1/graphqlapi/mutate-data/q/platform/js/) and [_Read application data_](/lib-v1/graphqlapi/query-data/q/platform/js/).
...
- [Create, update, and delete application data](/lib-v1/graphqlapi/mutate-data/q/platform/js/)
