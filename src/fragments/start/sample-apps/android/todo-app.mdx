...
1.  Follow the steps in [Amplify Android Getting Started Tutorial](/gen1/[platform]/start/) to sign up for an AWS account, install and configure Amplify CLI. Install all the [prerequisites](/gen1/[platform]/start/getting-started/installation/) for setting up a fullstack project.
...
3.  Follow the [instructions](/gen1/[platform]/start/getting-started/generate-model/) to generate model files.
