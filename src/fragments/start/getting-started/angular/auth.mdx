...
Now that you have your authentication service deployed to AWS, it's time to add authentication to your Angular app. Creating the login flow can be quite difficult and time consuming to get right. Luckily Amplify has an authentication UI component you can use that will provide the entire authentication flow for us, using your configuration specified in your `aws-exports.js` file.
