...
Next, in your `src/app/app.component.ts` file, add data to your database with a mutation by using the `API.service` file which was generated when you ran `amplify add api`:
