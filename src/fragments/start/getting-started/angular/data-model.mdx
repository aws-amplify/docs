...
<Callout warning={true}>
  ...
  <a href="https://www.typescriptlang.org/tsconfig#strict" rel="noopener noreferrer" target="_blank">
    strict mode
  </a>{' '}
  is enabled by default, which will introduce some type errors when you run the
  application. Please see the TypeScript strict mode{' '}
