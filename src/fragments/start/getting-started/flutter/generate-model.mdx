...
2. On the local setup instructions page, you will be prompted with on-screen instructions to pull the data model.
    ...
    2. As the rest of the steps will be covered by the tutorial, you can skip steps **2** and **3** by clicking **Next**. 
3. Finally, Click **Deploy to AWS** at the end of step **3**.
4. In order to deploy a backend, you will need an AWS account. We will go over this in a later step when we’re ready to sync our app to the cloud. For now, keep the link to this page handy!
