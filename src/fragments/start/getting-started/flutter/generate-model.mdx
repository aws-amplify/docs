...
3. On the Data modeling screen, you should see your Todo data model.  This is a good start but let’s take it a step further by adding a completion flag to your Todo items.
...
3. In order to deploy a backend, you will need an AWS account. We will go over this in a later step when you’re ready to sync your app to the cloud. For now, keep the link to this page open!
