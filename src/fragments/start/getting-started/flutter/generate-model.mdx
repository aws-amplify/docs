...
These models are specified as  [GraphQL](http://graphql.org/) schemas. You can 
[learn more](/cli/graphql/overview) about GraphQL schemas and data modeling. For now, 
let's start by creating our budget management data model.
