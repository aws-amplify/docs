...
1. Navigate to the [Data feature in AWS Amplify Studio](https://sandbox.amplifyapp.com/getting-started) and, with **To-do list schema** selected, click **Create new schema**.
