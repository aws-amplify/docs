...
See the documentation for [project setup](/lib/project-setup/create-application) and the [Auth category](/lib/auth/getting-started) for more informationon about web and desktop support.
