...
See the documentation for [project setup](/lib/project-setup/create-application) and the [Auth category](/lib/auth/getting-started), the [Analytics category](/lib/analytics/getting-started), and the [Storage category](/lib/storage/getting-started) for more information about web and desktop support.
