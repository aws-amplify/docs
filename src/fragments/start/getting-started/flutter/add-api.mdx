...
4. The on-screen text should walk you through the deployment process and, when the deployment status reads **Deployment completed**, click **Launch Studio**.
