...
The Amplify CLI supports creating and interacting with two types of API categories: [REST](/[platform]/build-a-backend/restapi/set-up-rest-api/) and [GraphQL](/[platform]/build-a-backend/graphqlapi/set-up-data/).
