...
The Amplify CLI supports creating and interacting with two types of API categories: [REST](/gen1/[platform]/build-a-backend/restapi/set-up-rest-api/) and [GraphQL](/gen1/[platform]/build-a-backend/graphqlapi/set-up-graphql-api/).
...
The schema generated is for a Todo app. You'll notice a `@model` directive on the `Todo` type. This directive is part of the [GraphQL transformer](/gen1/[platform]/build-a-backend/graphqlapi/data-modeling/) feature of the Amplify CLI.
