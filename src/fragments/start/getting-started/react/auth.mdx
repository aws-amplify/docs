...
1. Import the `withAuthenticator` component and styles:
...
`Auth` has over 30 methods including `signUp`, `signIn`, `forgotPassword`, and `signOut` that allow you full control over all aspects of the user authentication flow. Check out the complete API and docs [here](https://ui.docs.amplify.aws/components/authenticator)
