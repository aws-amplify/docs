...
If you are following this step using TypeScript, you may run into an issue where your project cannot find your GraphQL queries.
To fix this, you will need to add a ```tsconfig.json``` file to your Amplify project manually.

An example working tsconfig.json file is provided below: 
