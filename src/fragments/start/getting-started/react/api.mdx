...
*Note:* `amplify mock api` requires Java. If you have not already deployed you API with `amplify push`, you will be walked through the following steps for GraphQL code generation
