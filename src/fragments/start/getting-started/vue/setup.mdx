...
Next, you need to configure Amplify on the client so that you can use it to interact with our backend services.
...
Now that our Vue app is set up and Amplify is initialized, you're ready to add an API in the next step.
