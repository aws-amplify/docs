...
> AWS profile
  AWS access keys
```
Select AWS profile and then choose the profile you configured in the [Prerequisites](/gen1/[platform]/start/getting-started/installation/#configure-the-amplify-cli).
