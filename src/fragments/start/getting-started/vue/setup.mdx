...
If you are using Vue 2, please check out our legacy [documentation](https://github.com/aws-amplify/amplify-ui/tree/legacy/legacy/amplify-ui-vue). For Vite installs check out this [documentation](https://ui.docs.amplify.aws/getting-started/installation?platform=vue#vite). 
...
We can configure Amplify on the client as a global plugin so that we can use `ui-vue` components anywhere without importing them in.
