...
⚠️  WARNING: your GraphQL API currently allows public create, read, update, and delete access to all models via an API Key. To configure PRODUCTION-READY authorization rules, review: https://docs.amplify.aws/nextjs/build-a-backend/graphqlapi/customize-auth/
...
The schema generated is for a blog app. You'll notice a directive on the `Post` type of `@model`. This directive is part of the [GraphQL transform](/[platform]/tools/cli/graphqlapi/data-modeling/) library of Amplify.
...
<Fragments fragments={{ nextjs: nextCallout }} />
