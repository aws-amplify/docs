...
Edit your schema at /Users/<user>/Desktop/<project-path>/next-amplified/amplify/backend/api/nextamplified/schema.graphql or place .graphql files in a directory at /Users/<user>/Desktop/<project-path>/next-amplified/amplify/backend/api/nextamplified/schema
✔ Do you want to edit the schema now? (Y/n) · yes
Edit the file in your editor: /Users/<user>/Desktop/<project-path>/next-amplified/amplify/backend/api/nextamplified/schema.graphql
