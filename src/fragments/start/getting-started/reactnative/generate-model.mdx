...
1. Navigate to the [Data feature in AWS Amplify Admin UI](https://sandbox.amplifyapp.com/getting-started) , select **Build a Todo** with **React Native** and then click on **Get started**.
