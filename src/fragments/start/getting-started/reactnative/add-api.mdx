...
1. After deployment, click on **Local setup instructions** at the top of the Amplify Studio
...
Synchronization is bi-directional. Try creating a Todo entry from the Content screen in the Amplify Studio:
1. Click **Create todo**
