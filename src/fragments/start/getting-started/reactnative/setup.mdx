...
Create the new app with the follwing command:    
...
After you [Setup development environment](https://reactnative.dev/docs/environment-setup), create the new app with the follwing command:    
