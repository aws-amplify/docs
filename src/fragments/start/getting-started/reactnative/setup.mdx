...
With `expo-cli` you can develop for **Android**, **iOS**, and **web**.

With `react-native-cli` you can develop for **Android** and **iOS**.
...
Expo apps come with a prebuilt entry point but because it is necessary to customize this file to configure Amplify later, you must create a different one.

Inside the root folder of your project create **index.js** file with the following content:
...
Inside the root folder of your project open the **package.json** file and replace the content of the **"main"** field to update your project's entry point:
...
import installLibraries from "/src/fragments/start/getting-started/reactnative/getting-started-steps-ui.mdx";

<Fragments fragments={{"react-native": installLibraries}} />
