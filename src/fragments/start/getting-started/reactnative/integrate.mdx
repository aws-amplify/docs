...
#### App.js
First, replace the contents of your **App.js** file with the following UI boilerplate code. Here, you are importing our Home component. 
...
#### Home.js
Next, you will create a Home component for our app which will implement most of the CRUD functionality for our app. Create a new file **Home.js** at location `src/Home.js`. Here, you have total four components defined :
...
If you try to add todos using the form now, it should successfully close the form when pressing the *Save* button. But our Todo list is still empty even if you restart the app! After initializing our todos as an empty list, you aren't currently updating it again. You will remedy that in the next step.
