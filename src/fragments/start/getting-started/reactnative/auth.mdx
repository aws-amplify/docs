...
Using Amplify UI connected components together makes it easier to manage styling across your entire app.
...
If you built your app with `expo`, In the next section, you'll host your app on the Amplify Console, a hosting service complete with a globally available CDN, atomic deployments, easy custom domains, and CI / CD.
