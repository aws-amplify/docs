...
1. Open the main file of the application - `ContentView.swift` or `TodoApp.swift` depending on the Life Cycle previously chosen - and **add the following** import statements at the top of the file:
  <BlockSwitcher>
