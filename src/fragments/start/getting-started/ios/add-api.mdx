...
1. **Build and run** the application. In the console output if `.info` logging is enabled, you will see that we are making a websocket connection to receive updates any time there is a mutation to the Todo model.
