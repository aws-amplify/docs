---
lastUpdated: '2022-01-03T17:25:52.000Z'
---
...
4. The on screen text should walk you through the deployment progress and, when the deployment status reads **Deployment completed**, click **Open Amplify Studio**.
...
1. Click on **Local setup instructions** at the top of Amplify Studio
...
From the Amplify Studio, select **Content** from the sidebar. If you have added todos from your app, you should see them show up as part of the results!
...
Synchronization is bi-directional. Try creating a Todo entry from the Content screen in the Studio:
1. Click **Create todo**
2. Fill in the form
