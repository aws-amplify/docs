...
These models are specified as [GraphQL](http://graphql.org/) schemas. If you'd like, first [learn more](/[platform]/tools/cli/graphqlapi/) about GraphQL schemas and data modeling.
