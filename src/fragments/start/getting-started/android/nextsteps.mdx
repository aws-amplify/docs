...
To begin your production application, continue to the [Project Setup](/lib/project-setup/create-application) guide which will walk you through more details of setting up an Amplify project. Then, you will be ready to start exploring additional Amplify categories to add to your application:
