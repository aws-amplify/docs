...
- [Android SDK](https://developer.android.com/studio/releases/platforms) API level 29 (Android 10)
- [Amplify CLI](/cli) version 4.21.0 or later. Install by running:
...
## Add Amplify to your application
  ...
  If you prefer, you can create the Amplify app with [Amplify Studio](https://sandbox.amplifyapp.com/) instead!
...
3. Under **Gradle Scripts**, open **build.gradle (Module: Todo.app)**.
