...
1. Open **Android Studio**. Select **New Project**.
    ...
    ![Shows Android studio welcome window](/images/lib/getting-started/android/set-up-android-studio-welcome.png)
...
4. Run **Gradle Sync**
    ...
    ![Shows where to click for syncing with gradle in Android studio ](/images/lib/getting-started/android/set-up-android-studio-sync-gradle.png)
