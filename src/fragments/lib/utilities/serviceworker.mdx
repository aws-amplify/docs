...
If you enable AWS Amplify [Analytics](/lib/analytics/getting-started) category, *ServiceWorker* module automatically tracks service worker state changes and message events.
