...
If you enable AWS Amplify [Analytics](/lib/analytics/getting-started) category, _ServiceWorker_ module automatically tracks service worker state changes and message events.
