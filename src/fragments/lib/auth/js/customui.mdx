...
<Callout warning={true}>
  ...
  <p>
    ...
    <a href="https://ui.docs.amplify.aws/components/authenticator#styling">
      documentation
    </a>
    .
  </p>
...
You can also pass the child components you want to use. For example, the following Authenticator configuration only renders _Greetings_ component which has a _Sign Out_ button:
...
The _Greetings_ component has two states: signedIn, and signedOut. To customize the greeting message, set properties `inGreeting` and `outGreeting` using a string or function.
