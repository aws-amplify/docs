...
You now have set up and configured your backend resources for Amplify authentication and are ready to start working on your frontend application.

## Determine your Auth integration path

Before you implement Auth on your frontend application, you will want to evaluate the options of using the Authenticator connected UI component or using the Amplify Library APIs directly. We recommend using the Authenticator since it creates a sign in and registration experience for your app with a few lines of code.
...
We recommend using the Authenticator UI component for quick and easy set up and then use the Amplify Libraries to customize the user experience and logic as needed. Once you decide which option will work for your use case you can continue implementing authentication on your frontend application.
