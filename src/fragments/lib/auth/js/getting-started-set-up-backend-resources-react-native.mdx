...
> Prerequisites: [Install and configure](/lib/project-setup/prereq/q/platform/react-native/#install-and-configure-the-amplify-cli) the Amplify CLI in addition to the Amplify libraries and [necessary dependencies](/lib/auth/getting-started/q/platform/react-native/#install-amplify-libraries).
