...
```sh
npm install aws-amplify amazon-cognito-identity-js amazon-cognito-identity-js @react-native-community/netinfo @react-native-async-storage/async-storage core-js
```
