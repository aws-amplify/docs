In this guide you will set up sign-up, sign-in, and sign-out and then test this functionality. This includes a review of sign-up methods provided by Amplify, the specific user attributes used by Amazon Cognito, how to confirm users after initial sign-up, and the differences between local and global sign-out.

Before you begin, you should have finished [*Set up and connected backend resources with a configured Auth category*](/lib/auth/set_up_auth#set-up-and-connect-backend-resources).
