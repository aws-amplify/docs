...
Follow the instructions in [Sign In](/[platform]/build-a-backend/auth/enable-sign-in/) to learn about how to integrate these authentication flows in your application with the Auth APIs.
