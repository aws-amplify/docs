...
If you are using the new [Amplify Android (Developer Preview)](/lib/devpreview/getting-started), check the Developer Preview tab for how to access the Escape Hatch for the AWS SDK for Kotlin.
