...
The default CLI flow as mentioned in the [getting started guide](/gen1/[platform]/build-a-backend/auth/set-up-auth/) requires a username, password and a valid email id as parameters to register a user. Invoke the following api to initiate a sign up flow.
...
import flutter12 from '/src/fragments/lib/auth/flutter/signin/60_runtime_auth_flow.mdx';
