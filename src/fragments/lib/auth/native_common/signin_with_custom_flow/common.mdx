...
import android1 from '/src/fragments/lib/auth/common/signin_with_custom_flow/cli_setup.mdx';

<Fragments fragments={{ android: android1 }} />

import ios1 from '/src/fragments/lib/auth/common/signin_with_custom_flow/cli_setup.mdx';
