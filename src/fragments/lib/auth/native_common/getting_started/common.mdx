...
- [Authenticate a user with username password](/gen1/[platform]/build-a-backend/auth/enable-sign-in/)
- [Authenticate a user using a web UI](/gen1/[platform]/build-a-backend/auth/sign-in-with-web-ui/)
- [Authenticate a user with another auth provider](/gen1/[platform]/build-a-backend/auth/add-social-provider/)
