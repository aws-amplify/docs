...
When the console opens, scroll down to the **Device Tracking** section and click the `Edit` button. This will render the following page allowing you to configure your preference for remembering a user's device.
