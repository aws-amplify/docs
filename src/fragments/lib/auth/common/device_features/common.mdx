...
import ios3 from "/src/fragments/lib/auth/ios/device_features/20_forgetDevice.mdx";

<Fragments fragments={{ios: ios3}} />

import android4 from "/src/fragments/lib/auth/android/device_features/20_forgetDevice.mdx";

<Fragments fragments={{android: android4}} />

import js5 from "/src/fragments/lib/auth/js/device_features/20_forgetDevice.mdx";
...
import ios6 from "/src/fragments/lib/auth/ios/device_features/30_fetchDevice.mdx";

<Fragments fragments={{ios: ios6}} />

import android7 from "/src/fragments/lib/auth/android/device_features/30_fetchDevice.mdx";

<Fragments fragments={{android: android7}} />

import js8 from "/src/fragments/lib/auth/js/device_features/30_fetchDevice.mdx";
