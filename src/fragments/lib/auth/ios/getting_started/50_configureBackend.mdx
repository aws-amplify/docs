...
For more details, see how to [Use an existing Cognito User Pool and Identity Pool](/[platform]/tools/cli/auth/import/).
...
> You can also [import](https://docs.amplify.aws/console/auth/import/) existing Amazon Cognito resources and [manage users and groups](/[platform]/tools/console/auth/user-management//) through the Amplify Studio UI.
