...
If you are using Cognito and would like to display a more specific view or messaging to your users based the error that occured, you can handle this by downcasting the `underlyingError` to `AWSCognitoAuthError`.
