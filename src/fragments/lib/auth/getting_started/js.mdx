import basic_auth from "./js/getting-started-steps-basic-auth.mdx";
...
<Fragments fragments={{js: basic_auth}} />
...
<inline-fragment src="/start/getting-started/fragments/reactnative/getting-started-steps-ui"></inline-fragment>
