...
The XR category is on a deprecation path and your Sumerian scenes will not be accessible by 2/21/2023. Please see [https://github.com/aws-samples/aws-tools-for-babylonjs-editor](https://github.com/aws-samples/aws-tools-for-babylonjs-editor) for examples 
