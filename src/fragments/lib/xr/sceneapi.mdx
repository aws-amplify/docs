...
The XR category is on a deprecation path and your Sumerian scenes will not be accessible after 2/21/2023. You can use BabylonJS, an open source 3D engine to author scenes in the future. Please see [https://github.com/aws-samples/aws-tools-for-babylonjs-editor](https://github.com/aws-samples/aws-tools-for-babylonjs-editor) for examples on using BabylonJS and publishing your scenes with Amplify Hosting.
