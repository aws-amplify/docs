...
Amplify JS can be used with Next.js' App Router with a few important changes to how you configure and use the library, namely:
...
Example of an Next.js App Router component that uses Amplify JS on the server:
