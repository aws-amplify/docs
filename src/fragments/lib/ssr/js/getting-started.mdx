...
Amplify can be used with Next.js' App Router with a few important changes to how you configure and use the library, namely:

- Amplify must be explicitly configured in both your client-side and server-side code (with `ssr` enabled)
