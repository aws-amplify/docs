...
- Prepare a request object for `withSSRContext` to perform server-side operations that require authentication.

Example of a Next.js App Router Server Component that uses Amplify JavaScript:
