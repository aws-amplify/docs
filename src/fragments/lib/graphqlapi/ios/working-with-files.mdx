...
For more on the Amplify GraphQL API, see the [API documentation](/[platform]/prev/build-a-backend/graphqlapi/set-up-data/). For Storage, see [Storage documentation](/[platform]/build-a-backend/storage/set-up-storage/). For Auth, see [Auth documentation](/[platform]/build-a-backend/auth/set-up-auth/)
