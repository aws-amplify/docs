---
lastUpdated: '2022-03-28T19:06:53.000Z'
---
## Query by Id
...
If you are using the new [Amplify iOS (Developer Preview)](/lib/devpreview/getting-started), check the Developer Preview tab for how to get the list of items using `.list` with optional parameters `limit` and `where`.
