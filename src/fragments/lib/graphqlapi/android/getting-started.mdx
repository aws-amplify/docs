> ### Prerequisites
>
> - An [Android project](https://developer.android.com/training/basics/firstapp/creating-project) targeting Android API level 24 (Android 7.0) or above
...
<BlockSwitcher>
  <Block name="Groovy DSL">
    ...
    Also in your **app** `build.gradle`, add this piece of code to support the Java 11 features Amplify uses:
  ...
  <Block name="Kotlin DSL">
    ...
    Also in your **app** `build.gradle.kts`, add this piece of code to support the Java 11 features Amplify uses:
