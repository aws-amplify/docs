...
__[Amplify GraphQL client](/lib/graphqlapi/query-data)__ - a light weight option if you're looking for a simple way to leverage GraphQL features and do not need the offline capabilities or caching. If you need those features, please look at [Amplify DataStore](/lib/datastore/getting-started).
