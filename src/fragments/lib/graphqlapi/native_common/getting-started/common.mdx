...
- [Fetch data](/[platform]/build-a-backend/graphqlapi/query-data/)
- [Update data](/[platform]/build-a-backend/graphqlapi/mutate-data/)
- [Subscribe to data](/[platform]/build-a-backend/graphqlapi/subscribe-data/)
- [Concepts](/[platform]/build-a-backend/graphqlapi/api-graphql-concepts/)
- [Configure authorization modes](/[platform]/build-a-backend/graphqlapi/customize-authorization-rules)
