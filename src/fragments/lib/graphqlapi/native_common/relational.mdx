...
## Customizing Query depth

You can perform a query, through one network request, by specifying which connected model to include. 
...
Query for the Post and all of its comments for the post. 
