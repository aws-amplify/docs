...
const response = await client.graphql<GraphQLQuery<CreateSongMutation>>({
...
// Add the file association to the record:
const response = await client.graphql<GraphQLQuery<UpdateSongMutation>>({
  query: mutations.updateSong,
  variables: { input: updateSongDetails },
});
...
const response = await client.graphql<GraphQLQuery<GetSongQuery>>({
...
const updatedSong = await client.graphql<GraphQLQuery<UpdateSongMutation>>({
  query: mutations.updateSong,
...
const deletedSong = await client.graphql<GraphQLQuery<DeleteSongMutation>>({
...
const deletedSong = await client.graphql({
  query: mutations.deleteSong,
  variables: { input: songDetails },
});
```
...
const response = await client.graphql<GraphQLQuery<GetPhotoAlbumQuery>>({
  query: queries.getPhotoAlbum,
  variables: { id: currentPhotoAlbum.id },
});
...
await client.graphql<GraphQLQuery<DeletePhotoAlbumMutation>>({
...
function App() {
  ...
  async function deleteCurrentSongAndImage() {
    ...
    try {
      ...
      await client.graphql<GraphQLQuery<DeleteSongMutation>>({
        query: mutations.deleteSong,
        variables: { input: songDetails },
      });
