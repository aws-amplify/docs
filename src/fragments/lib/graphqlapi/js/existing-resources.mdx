...
const myAppConfig = {
  ...
  aws_appsync_graphqlEndpoint:
    'https://xxxxxx.appsync-api.us-east-1.amazonaws.com/graphql',
  aws_appsync_region: 'us-east-1',
  aws_appsync_authenticationType: 'OPENID_CONNECT' // Before calling client.graphql(...) is required to do Auth.federatedSignIn(...) check authentication guide for details.
  // ...
};
...
// Considering you have an existing amplifyconfiguration.json configuration file
