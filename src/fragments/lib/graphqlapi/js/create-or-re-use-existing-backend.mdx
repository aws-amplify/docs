...
### Using with a custom AppSync domain

[Custom domains](https://docs.aws.amazon.com/appsync/latest/devguide/custom-domain-name.html) can have any format, but must end with `/graphql` (see https://graphql.org/learn/serving-over-http/#uris-routes).
