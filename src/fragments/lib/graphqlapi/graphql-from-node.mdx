...
You can also define which GraphQL operation you're running. In this example, we are going to be creating a `createTodo` mutation within a separate `graphql.js` file.
