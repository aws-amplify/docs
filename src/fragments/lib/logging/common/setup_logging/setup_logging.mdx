...
You can use the Amplify CLI to [add custom CDK resources](/gen1/[platform]/tools/cli/custom/cdk/).
...
import androidInstallLibraries from '/src/fragments/lib/logging/android/install_libraries/install_libs.mdx';

<Fragments
  fragments={{
    android: androidInstallLibraries
  }}
/>
