...
**NOTE:** Due to a [known issue](https://github.com/aws-amplify/amplify-cli/issues/12208), you will need to update your amplify backend configuration with the properties below before pushing to the cloud:
