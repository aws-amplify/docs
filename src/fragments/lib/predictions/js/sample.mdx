...
If you are running into an issue with `Uncaught ReferenceError: Buffer is not defined` due to `react-scripts@5.0.0`, try following the instructions provided in [this stack exchange answer](https://stackoverflow.com/a/71205013).
  ...
  return (
    <div className="Text">
      <div className="category-content">
        ...
        <input className="primary-button" type="file" onChange={identifyFromFile}></input>
        <p>{response}</p>
      </div>
    </div>
  );
  ...
  function AudioRecorder({ finishRecording }) {
    ...
    return (
      <div className="audioRecorder">
        <div>
          {recording && <button className="primary-button" onClick={stopRecording}>Stop recording</button>}
          {!recording && <button className="primary-button" onClick={startRecording}>Start recording</button>}
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="Text">
      <div className="category-content">
        ...
        <button className="primary-button" onClick={generateTextToSpeech}>Text to Speech</button>
        <h3>{response}</h3>
      </div>
    </div>
  );
  ...
  return (
    <div className="Text">
      <div className="category-content">
        ...
        <button className="primary-button" onClick={translate}>Translate</button>
        <p>{response}</p>
      </div>
    </div>
  );
