...
Please [adjust your authorization permissions](/gen1/[platform]/build-a-backend/more-features/geo/existing-resources/) accordingly for your escape hatch use-cases.
