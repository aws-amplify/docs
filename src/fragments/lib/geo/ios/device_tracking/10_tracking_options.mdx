...
* Shows Background Location Update Indicator: Only applicable if Request Always Authorization is true.  If true, the background location indicator is displayed and visible to the users.
