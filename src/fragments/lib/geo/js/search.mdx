...
**Note:** If you are using React, you should use the [Amplify UI Geocoder component](https://ui.docs.amplify.aws/components/geo#geocoder) to display the search results on a map.
