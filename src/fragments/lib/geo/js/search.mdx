...
**Note:** Upgrade to the latest Amplify CLI version (greater than version 12.15.1) and do an ``amplify push`` to update your IAM policies to allow for ``getPlace`` API.
