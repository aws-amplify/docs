...
Below we have provided two examples of using the Amazon Location Service APIs.

### Searching for places

This example requires you to have first provisioned a Search Index resource using the [Amplify CLI Location Search docs](/cli/geo/search/)
