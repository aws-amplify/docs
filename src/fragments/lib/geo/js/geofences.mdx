...
> **Notes:** To use Geofence Controls you will need to be authenticated with the administrative Cognito user associated with the Geofence Collection you created above. An easy way to add this to a React application for instance is to use the [Amplify Authenticator](https://ui.docs.amplify.aws/components/authenticator)
