...
**Note:** If you want to use existing Amazon Location Service resources [follow this guide](/lib/geo/existing-resources) instead. If you want to use Amazon Location Service APIs not directly supported by Geo, use the [escape hatch](/lib/geo/escapehatch) to access the Amazon Location Service SDK.

**Note:** If you want to use Amazon Location Service APIs not directly supported by Geo use the [escape hatch](/lib/geo/escapehatch) to access the Amazon Location Service SDK.
