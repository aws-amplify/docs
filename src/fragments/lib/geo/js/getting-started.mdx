...
Make sure you call `Amplify.configure` as early as possible in your application. A `Library Not Configured` error is thrown if Amplify.configure isn't called before other Amplify JavaScript APIs. Review the [Library Not Configured Troubleshooting guide](/[platform]/build-a-backend/troubleshooting/library-not-configured/) for possible causes of this issue.
