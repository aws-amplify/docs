You can move an existing file to a different folder location in your S3 bucket. The user initiating the move operation must have read and write permission on the source file.
