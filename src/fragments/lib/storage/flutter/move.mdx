...
You can move an existing file to a different location. This requires the user who initiates the move operation to have read and write permission on the source file.
