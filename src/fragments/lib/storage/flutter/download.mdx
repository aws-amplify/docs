...
In addition to the existing functionality of the `Amplify.Storage.getUrl`, it supports checking file existence now with given file key and access level. If the file doesn't exist or cannot be accessed it throws exception.
