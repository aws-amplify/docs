...
import androidPart from "/src/fragments/lib/storage/android/transfer-acceleration.mdx";

<Fragments fragments={{android: androidPart}} />

import swiftPart from "/src/fragments/lib/storage/ios/transfer-acceleration.mdx";

<Fragments fragments={{swift: swiftPart}} />

import flutterPart from "/src/fragments/lib/storage/flutter/transfer-acceleration.mdx";

<Fragments fragments={{flutter: flutterPart}} />