...
- **region**: AWS Region where the bucket is provisioned (e.g. _us-east-1_) {/* TODO Rewrite need to add a section for configuring the Amplify libraries for JS+React Native */}
