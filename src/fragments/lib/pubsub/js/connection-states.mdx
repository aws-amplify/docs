...
- **ConnectionDisrupted** - The service connection is interrupted and the network is available.
- **ConnectionDisruptedPendingNetwork** - The service connection is interrupted and the network connection is unavailable.
