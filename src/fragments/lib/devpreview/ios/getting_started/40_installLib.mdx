...
You'll see the Amplify iOS repository rules for which version of Amplify you want Swift Package Manager to install. Choose the dependency rule **Up to Next Major Version** and enter **1.22.0-swift-sdk-dev-preview.0** as the minimum version, then click **Add Package**.
