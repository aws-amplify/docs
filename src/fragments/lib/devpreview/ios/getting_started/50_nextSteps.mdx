...
---
Congratulations! You've successfully setup Amplify iOS (Developer Preview) and are ready to start adding Amplify categories to your application. The following categories are currently supported in Amplify iOS (Developer Preview):
