> To use a a Lex V2 chatbot please refer to the [LexV2 bot section](#lex-v2-bot) 
...
## Manual setup
### Lex V1 bot
You can create Amazon Lex V1 chatbox in Amazon Lex console. To create your bot, follow the steps shown in [Amazon Lex V1 Developer Guide](https://docs.aws.amazon.com/lex/latest/dg/getting-started.html).
...
### Lex V2 bot
You can create Amazon Lex V2 chatbox in Amazon Lex console. To create your bot, follow the steps shown in [Amazon Lex V2 Developer Guide](https://docs.aws.amazon.com/lexv2/latest/dg/getting-started.html).
...
const interactionsConfig = {
    ...
    Interactions: {
        bots: {
            ...
            <V1BotName>: {
                name: "<V1BotName>",
                alias: "<V1BotAliasName>",
                region: "<V1BotRegion>",
                // default provider "AWSLexProvider"
            },
            // LexV2 Bot
            <V2BotName>: {
                name: "<V2BotName>",
