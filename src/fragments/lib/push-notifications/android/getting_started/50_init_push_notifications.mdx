...
The **AWSPinpointPushNotificationsPlugin** automatically records and displays your notifications. Besides Identify user, you do not need to call APIs manually if you are using our library out of the box.
