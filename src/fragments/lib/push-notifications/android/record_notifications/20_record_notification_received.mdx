...
You should call either `handleNotificationReceived` or `recordNotificationReceived`, but not both since `handleNotificationReceived` already calls `recordNotificationReceived`.
