...
Push notifications for Android apps are sent using Firebase Cloud Messaging (FCM). Before you can send push notifications to Android devices, you must perform the following steps.  Please note that you should stop at the "Add Firebase SDKs to your app" step. 
