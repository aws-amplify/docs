...
Push Notifications category is integrated with [AWS Amplify Analytics category](/lib/analytics/getting-started) to be able to track notifications. Make sure that you have configured the Analytics category in your app before configuring the Push Notifications category.
...
11. Run your app:
    ...
    ```bash
    npx react-native@0.68.2 init run-android --version 0.68.0
    ```
...
8. Run your app:
    ...
    ```bash
    npx react-native@0.68.2 init run-ios --version 0.68.0
    ```
