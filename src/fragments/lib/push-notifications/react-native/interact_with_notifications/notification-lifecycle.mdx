...
Before delving into details about the various functions Amplify provides, it can be helpful to better understand lifecycle of a notification as it moves through your app in its various states once you've integrated Amplify Push Notification.
...
- It is possible for notifications to arrive in your user's notification center but not be interacted with until a later time, including while the app is in the active foreground
