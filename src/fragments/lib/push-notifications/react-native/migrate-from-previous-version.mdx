...
Please note that you may need to delete your `yarn.lock` file, `package-lock.json` file as well as the `/node_modules` folder before adding the new native module.
