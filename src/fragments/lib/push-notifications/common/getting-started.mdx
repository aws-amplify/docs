...
import android6 from "/src/fragments/lib/push-notifications/android/getting_started/30_existing_resources.mdx";

<Fragments fragments={{android: android6}} />

import ios13 from "/src/fragments/lib/push-notifications/ios/getting_started/50_existing_resources.mdx";
