...
In order to use APNs, you need to setup credentials (keys or certificates) and export your credentials to a p12 file. See [Setting up push notification services](/lib/push-notifications/existing-resources) for more information.
