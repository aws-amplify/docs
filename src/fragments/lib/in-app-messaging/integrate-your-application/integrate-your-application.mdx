...
<Fragments fragments={{ 'react-native': reactnative0, javascript: js0 }} />
...
<Fragments fragments={{ 'react-native': reactnative2, javascript: js2 }} />
...
<Fragments fragments={{ 'react-native': reactnative3, javascript: js3 }} />
