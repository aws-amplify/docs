...
```js
npm install aws-amplify@in-app-messaging &&
npm install aws-amplify-react-native@in-app-messaging &&
npm install amazon-cognito-identity-js @react-native-community/netinfo @react-native-async-storage/async-storage @react-native-picker/picker
```
