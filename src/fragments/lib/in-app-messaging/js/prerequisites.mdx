...
Bootstrap your project with Amplify by navigating in to your project’s root folder and running the `init` command.
...
4. On the **Visual editor** tab, select the following:
   ...
   ![In-App-Messaging](/images/lib/in-app-messaging/pinpoint-console-policy-action.png)
