...
<Fragments fragments={{ swift: codegenPlatformIntegration }} />
<Fragments fragments={{ android: codegenPlatformIntegration }} />
...
- [Write data](/gen1/[platform]/build-a-backend/more-features/datastore/manipulate-data/#create-and-update)
- [Query data](/gen1/[platform]/build-a-backend/more-features/datastore/manipulate-data/#query-data)
- [Model associations](/gen1/[platform]/build-a-backend/more-features/datastore/relational-models/)
- [Cloud synchronization](/gen1/[platform]/build-a-backend/more-features/datastore/sync-to-cloud/)
- [Clear local data](/gen1/[platform]/build-a-backend/more-features/datastore/sync-to-cloud/#clear-local-data)
