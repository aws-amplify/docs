...
`observeQuery` also accepts the same [predicates](/[platform]/build-a-backend/datastore/manipulate-data/#predicates) and [sorting](/[platform]/build-a-backend/more-features/datastore/manipulate-data/#sort) options as `query`.
