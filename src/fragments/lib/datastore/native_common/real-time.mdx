...
`observeQuery` also accepts the same [predicates](/[platform]/prev/build-a-backend/more-features/datastore/#predicates) and [sorting](/[platform]/build-a-backend/more-features/datastore/manipulate-data/#sort) options as `query`.
