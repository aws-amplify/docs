...
Deletion can also be achieved by passing an instance and a predicate into `Amplify.DataStore.delete()`. Only if the data being deleted meets the specific conditions will it be deleted.
