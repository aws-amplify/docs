...
Amplify Android includes optional support for **[Kotlin Coroutines](/gen1/[platform]/start/project-setup/kotlin-coroutines/)** and **[RxJava](/gen1/[platform]/start/project-setup/rxjava/)**.
