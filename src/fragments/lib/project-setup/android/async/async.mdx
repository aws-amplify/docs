...
Amplify Android includes optional support for **[Kotlin Coroutines](/[platform]/start/project-setup/kotlin-coroutines/)** and **[RxJava](/[platform]/start/project-setup/rxjava/)**.
