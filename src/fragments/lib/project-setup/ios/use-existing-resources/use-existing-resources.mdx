...
Before you can add an existing AWS resource to an iOS application, the application must have the Amplify libraries installed. For detailed instructions, see [Install Amplify Libraries](/lib/project-setup/create-application#n2-install-amplify-libraries).
...
* See the [Geo (Developer Preview) category](/lib/geo/existing-resources) to use existing Amazon Location Service resources.
