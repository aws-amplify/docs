...
Before you can add an existing AWS resource to an iOS application, the application must have the Amplify libraries installed. For detailed instructions, see [Install Amplify Libraries](/gen1/[platform]/start/project-setup/create-application/#n2-install-amplify-libraries).
...
- See the [Analytics category](/gen1/[platform]/build-a-backend/more-features/analytics/existing-resources/) to use existing AWS Pinpoint resources.
- See the [API (GraphQL) category](/gen1/[platform]/build-a-backend/graphqlapi/) to use existing AWS AppSync resources.
- See the [API (REST) category](/gen1/[platform]/build-a-backend/restapi/existing-resources/) to use existing Amazon API Gateway and AWS Lambda resources.
- See the [Authentication category](/gen1/[platform]/build-a-backend/auth/existing-resources/) to use existing Amazon Cognito resources.
- See the [Geo (Developer Preview) category](/gen1/[platform]/build-a-backend/more-features/geo/existing-resources/) to use existing Amazon Location Service resources.
- See the [Storage category](/gen1/[platform]/build-a-backend/storage/existing-resources/) to use existing Amazon S3 resources.
