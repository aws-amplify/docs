...
Amplify for Swift supports converting the async/await apis to Combine publishers. For more details check: [Using Combine with Amplify](/lib/project-setup/combine)
