...
Configuration for Hosted UI varies slightly in v1 compared to v0.
...
In v1, these changes are no longer required and can be safely removed without any effect on Hosted UI.
...
Follow the instructions [here](/lib/auth/social/q/platform/flutter/#platform-setup) to configure Web and Desktop platforms for Hosted UI in v1.
