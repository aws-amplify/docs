...
- `fetchAuthSession` had several changes. See the example below for how to migrate.
  ...
  - `CognitoAuthSession.credentials`, `CognitoAuthSession.userPoolTokens`, `CognitoAuthSession.userSub`, and `CognitoAuthSession.identityId` are deprecated and will be removed in a future release.
