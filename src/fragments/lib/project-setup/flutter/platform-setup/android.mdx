...
_If your Flutter app was generated with Flutter 3.16 or higher, you can skip the first two steps._
...
If your Kotlin Gradle plugin version is below 1.9, update `android/build.gradle`:

```
ext.kotlin_version = '1.9.10'
```

If your Flutter app was generated with Flutter 3.16 or higher, make the following changes instead:
