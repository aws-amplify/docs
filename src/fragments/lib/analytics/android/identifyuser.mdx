...
You can get the current user's ID from the Amplify Auth category as shown below. Be sure you have it added and setup per the [Auth category documentation](/gen1/[platform]/build-a-backend/auth/set-up-auth/).
...
import android0 from "/src/fragments/lib/analytics/native_common/identify-use-cases.mdx";
