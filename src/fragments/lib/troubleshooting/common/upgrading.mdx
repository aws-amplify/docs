...
<BlockSwitcher>
  <Block name="Web">
    ...
    If you are using npm as a package manager, make sure the version of `aws-amplify` in your package.json file is `latest` or `^6.0.2` and re-installing dependencies by running `npm install`.
  ...
  <Block name="React Native">
    <Callout>The `aws-amplify-react-native` package has been deprecated in v6.</Callout>
