...
We highly recommend reading the [v6 docs on Server-Side Rendering](/[platform]/build-a-backend/server-side-rendering/), as there has been a shift in approach to accommodate working with cookies and middleware in NextJS, and it is important to have deeper context on what has changed. 
