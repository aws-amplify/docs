...
<Callout>Find a comprehensive summary of changes to In-App Messaging in the [In-App Messaging migration guide](/[platform]/build-a-backend/storage/storage-v5-to-v6-migration-guide/)</Callout>
