...
<BlockSwitcher>
  <Block name="Web">
    ...
    If you are using npm as a package manager, make sure the version of `aws-amplify` in your package.json file is `latest` or `^6.0.1` and re-installing dependencies by running `npm install`.
  ...
  <Block name="React Native">
    ...
    In v6, the following packages have been replaced with `@aws-amplify/react-native` and should be removed from your `package.json`.
