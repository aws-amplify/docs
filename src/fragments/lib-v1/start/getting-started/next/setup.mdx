...
<Fragments fragments={{  javascript: versionRangeCallout , angular: versionRangeCallout, nextjs: versionRangeCallout, react: versionRangeCallout, vue: versionRangeCallout }} />
...
For details of using Amplify with in your Next.js app, see [use Amplify with Next.js](/lib-v1/ssr/nextjs/q/platform/js).
