...
You can use the escape hatch to `federatedSignIn` with a valid token from other social providers. Find more details [here](/gen1/[platform]/sdk/auth/federated-identities/)
