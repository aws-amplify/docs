...
The default CLI flow as mentioned in the [getting started guide](/gen1/[platform]/prev/build-a-backend/auth/set-up-auth/) requires a username, password and a valid email id as parameters to register a user. Invoke the following api to initiate a sign up flow.
