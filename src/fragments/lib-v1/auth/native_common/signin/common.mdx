...
The default CLI flow as mentioned in the [getting started guide](/lib-v1/auth/getting-started) requires a username, password and a valid email id as parameters to register a user. Invoke the following api to initiate a sign up flow.
