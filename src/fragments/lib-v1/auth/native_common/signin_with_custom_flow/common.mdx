...
import flutter0 from '/src/fragments/lib-v1/auth/flutter/getting_started/10_preReq.mdx';

<Fragments fragments={{ flutter: flutter0 }} />

## Configure Auth Category

import ios1 from '/src/fragments/lib-v1/auth/ios/signin_with_custom_flow/10_cli_setup.mdx';

<Fragments fragments={{ swift: ios1 }} />

import flutter1 from '/src/fragments/lib-v1/auth/flutter/signin_with_custom_flow/10_cli_setup.mdx';
...
import ios2 from '/src/fragments/lib-v1/auth/ios/signin_with_custom_flow/20_signup.mdx';

<Fragments fragments={{ swift: ios2 }} />

import flutter2 from '/src/fragments/lib-v1/auth/flutter/signin_with_custom_flow/20_signup.mdx';
...
import ios3 from '/src/fragments/lib-v1/auth/ios/signin_with_custom_flow/30_confirmSignup.mdx';

<Fragments fragments={{ swift: ios3 }} />

import flutter3 from '/src/fragments/lib-v1/auth/flutter/signin/20_confirmSignUp.mdx';
...
import ios4 from '/src/fragments/lib-v1/auth/ios/signin_with_custom_flow/40_signin.mdx';

<Fragments fragments={{ swift: ios4 }} />

import flutter4 from '/src/fragments/lib-v1/auth/flutter/signin_with_custom_flow/30_signin.mdx';
...
import ios5 from '/src/fragments/lib-v1/auth/ios/signin_with_custom_flow/50_custom_challenge.mdx';

<Fragments fragments={{ swift: ios5 }} />

import flutter5 from '/src/fragments/lib-v1/auth/flutter/signin_with_custom_flow/40_custom_challenge.mdx';

<Fragments fragments={{ flutter: flutter5 }} />

import flutter6 from '/src/fragments/lib-v1/auth/flutter/signin_with_custom_flow/50_custom_challenge_password_verification.mdx';
