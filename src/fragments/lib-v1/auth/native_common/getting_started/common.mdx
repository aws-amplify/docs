...
- [Authenticate a user with username password](/[platform]/prev/build-a-backend/auth/enable-sign-in/)
- [Authenticate a user using a web UI](/[platform]/prev/build-a-backend/auth/sign-in-with-web-ui/)
- [Authenticate a user with another auth provider](/[platform]/prev/build-a-backend/auth/add-social-provider/)
