...
Web and desktop support for the Amplify Flutter Analytics category is now in developer preview!  See the documentation for [project setup](/lib-v1/project-setup/create-application) for more information about getting started.
