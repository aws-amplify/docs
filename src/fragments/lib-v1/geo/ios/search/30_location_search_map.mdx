...
You can customize the feature images displayed on the `AMLMapView` or `AMLMapCompositeView`, you can leverage the `featureImage()` view modifier. {/* // spell-checker: disable \ */}
...
{/* // spell-checker: enable \ */} ![AMLMapView featureImage view modifier](/images/ios-geocoder-custom-images.png)
