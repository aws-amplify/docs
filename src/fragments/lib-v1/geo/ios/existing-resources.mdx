...
Amplify Geo is dependent on your Amplify Auth category. If it is not already configured, then you will need to [configure it](/lib-v1/auth/existing-resources) as well.
