...
`getAvailableMaps` will return the map resources you currently have provisioned in your Amplify application. You can switch between any of these different maps and display their different map styles.
