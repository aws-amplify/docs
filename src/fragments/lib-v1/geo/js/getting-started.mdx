...
The CLI will let you configure the Geo category based on the capabilities you want to add (maps and/or search). You can either choose to stick with the defaults or configure advanced settings. Please refer to [Amplify CLI Geo docs](/gen1/[platform]/build-a-backend/more-features/geo/configure-maps/) for more details on these configurations.
...
For more information, you can visit the full [Amplify CLI Geo Maps docs](/gen1/[platform]/build-a-backend/more-features/geo/configure-maps/).
