...
Please refer to the [Getting started](/gen1/react-native/build-a-backend/push-notifications/) portion of this guide to start learning more about the new Amplify Push Notifications.
