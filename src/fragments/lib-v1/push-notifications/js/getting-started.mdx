...
3. Push Notifications category is integrated with [AWS Amplify Analytics category](/lib-v1/analytics/getting-started) to be able to track notifications. Make sure that you have configured the Analytics category in your app before configuring the Push Notifications category.
...
If you don't have Analytics already enabled, see our [Analytics Developer Guide](/lib-v1/analytics/getting-started) to add Analytics to your app.
