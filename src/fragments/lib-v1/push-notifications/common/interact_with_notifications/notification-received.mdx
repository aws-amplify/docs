...
import flutterOnForegroundNotification from '/src/fragments/lib-v1/push-notifications/flutter/interact_with_notifications/on-foreground-notification.mdx';
import reactNativeOnForegroundNotification from '/src/fragments/lib-v1/push-notifications/react-native/interact_with_notifications/on-foreground-notification.mdx';

<Fragments
  fragments={{
    flutter: flutterOnForegroundNotification,
    'react-native': reactNativeOnForegroundNotification
  }}
/>
...
import flutterOnBackgroundNotification from '/src/fragments/lib-v1/push-notifications/flutter/interact_with_notifications/on-background-notification.mdx';
import reactNativeOnBackgroundNotification from '/src/fragments/lib-v1/push-notifications/react-native/interact_with_notifications/on-background-notification.mdx';

<Fragments
  fragments={{
    flutter: flutterOnBackgroundNotification,
    'react-native': reactNativeOnBackgroundNotification
  }}
/>
