...
The maximum number of records that will be stored locally is configurable [here](/lib-v1/datastore/conflict).
...
For more information see the [Setup authorization rules](/lib-v1/datastore/setup-auth-rules/) section.
