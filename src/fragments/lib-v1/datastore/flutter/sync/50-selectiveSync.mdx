...
By default, DataStore fetches all the records that you’re authorized to access from your cloud data source to your local device. The maximum number of records that will be stored locally is configurable [here](/gen1/[platform]/build-a-backend/more-features/datastore/conflict-resolution/).
