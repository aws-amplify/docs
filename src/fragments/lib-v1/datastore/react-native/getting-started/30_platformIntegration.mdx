...
npm install aws-amplify@^5.0 amazon-cognito-identity-js @react-native-community/netinfo @react-native-async-storage/async-storage @azure/core-asynciterator-polyfill
```
...
cd AmplifyDataStoreRN
npx amplify-app@latest
npm install aws-amplify@^5.0 amazon-cognito-identity-js @aws-amplify/datastore-storage-adapter react-native-sqlite-storage @react-native-community/netinfo @react-native-async-storage/async-storage @azure/core-asynciterator-polyfill
npx pod-install
```
