...
3. During the lifecycle of the app, listen to Auth events to show different views based on the user's state. See [Auth Events](/[platform]/prev/build-a-backend/auth/auth-events/) for more details.

For more information on related topics:

- [Auth.SignIn](/[platform]/prev/build-a-backend/auth/enable-sign-in/)
- [Auth.fetchAuthSession](/[platform]/prev/build-a-backend/auth/set-up-auth/#check-the-current-auth-session)
- [Auth Events](/[platform]/prev/build-a-backend/auth/auth-events/)
