...
import js0 from '/src/fragments/lib-v1/datastore/js/conflict.mdx';

<Fragments fragments={{  javascript: js0 , angular: js0, nextjs: js0, react: js0, vue: js0 }} />

import reactnative0 from '/src/fragments/lib-v1/datastore/js/conflict.mdx';

<Fragments fragments={{ 'react-native': reactnative0 }} />

import ios1 from '/src/fragments/lib-v1/datastore/ios/conflict.mdx';

<Fragments fragments={{ swift: ios1 }} />

import android2 from '/src/fragments/lib-v1/datastore/android/conflict.mdx';

<Fragments fragments={{ android: android2 }} />

import flutter3 from '/src/fragments/lib-v1/datastore/flutter/conflict.mdx';
