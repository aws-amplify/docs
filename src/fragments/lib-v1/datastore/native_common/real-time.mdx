...
`observeQuery` also accepts the same [predicates](/[platform]/prev/build-a-backend/datastore/manipulate-data/#predicates) and [sorting](/[platform]/prev/build-a-backend/more-features/datastore/manipulate-data/#sort) options as `query`.
