...
import flutter2 from '/src/fragments/lib-v1/datastore/flutter/sync/10-installPlugin.mdx';

<Fragments fragments={{ flutter: flutter2 }} />

### Push the backend to the cloud

By now you should have a backend created with conflict detection enabled, as described in the [Getting started](/gen1/[platform]/prev/build-a-backend/more-features/datastore/set-up-datastore/) guide.
...
DataStore can connect to an existing AWS AppSync backend that has been deployed from another project, no matter the platform it was originally created in. In these workflows it is best to work with the CLI directly by running an `amplify pull` command from your terminal and then generating models afterwards, using the process described in the [Getting started](/gen1/[platform]/prev/build-a-backend/more-features/datastore/set-up-datastore/#idiomatic-persistence-models) guide.
...
**Note:** In case multiple users share the same device and your schema defines user-specific data, make sure you call `Amplify.DataStore.clear()` when switching users. Visit [Auth events](/gen1/[platform]/prev/build-a-backend/auth/auth-events/) for all authentication related events.

</Callout>

import js6 from '/src/fragments/lib-v1/datastore/js/sync/40-clear.mdx';

<Fragments fragments={{  javascript: js6 , angular: js6, nextjs: js6, react: js6, vue: js6 }} />

import reactnative0 from '/src/fragments/lib-v1/datastore/js/sync/40-clear.mdx';
...
import flutter9 from '/src/fragments/lib-v1/datastore/flutter/sync/40-clear.mdx';
...
import js10 from '/src/fragments/lib-v1/datastore/js/sync/50-selectiveSync.mdx';

<Fragments fragments={{  javascript: js10 , angular: js10, nextjs: js10, react: js10, vue: js10 }} />

import reactnative1 from '/src/fragments/lib-v1/datastore/js/sync/50-selectiveSync.mdx';
...
import flutter13 from '/src/fragments/lib-v1/datastore/flutter/sync/50-selectiveSync.mdx';
