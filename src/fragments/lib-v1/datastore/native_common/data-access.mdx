...
To both query _and_ observe subsequent changes to a Model, consider using [`observeQuery`](/lib-v1/datastore/real-time#displaying-data-during-the-sync-process-with-observequery).
