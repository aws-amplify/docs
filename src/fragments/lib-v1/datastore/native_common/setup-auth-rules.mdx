...
import datastoreAuthRulesCallout from '/src/fragments/lib-v1/datastore/native_common/callout/datastore-auth-rules-cli.mdx';
...
The following are commonly used patterns for owner based authorization. For more information on how to tune these examples, please see the [CLI documentation on owner based authorization](/[platform]/build-a-backend/graphqlapi/customize-auth/#per-user--owner-based-data-access).
...
The following are commonly used patterns for static group authorization. For more information on how to tune these examples, please see the [CLI documentation on static group authorization](/[platform]/build-a-backend/graphqlapi/customize-auth/#user-group-based-data-access).
...
The following are commonly used patterns for combining owner and static group authorization. For more information on how to tune these examples, please see the [CLI documentation on static group authorization](/[platform]/build-a-backend/graphqlapi/customize-auth/#static-group-authorization).
...
The following are commonly used patterns to grant everyone access. For more information on how to tune these examples, please see the [CLI documentation on public data access](/[platform]/build-a-backend/graphqlapi/customize-auth/#public-data-access).
...
The following are commonly used patterns for private authorization. For more information on how to tune these examples, please see the [CLI documentation on signed-in user data access](/[platform]/build-a-backend/graphqlapi/customize-auth//#signed-in-user-data-access).
...
The following are commonly used patterns for owner based authorization using a 3rd party OIDC provider (e.g. Facebook, Google, etc...). For more information on how to tune these examples, please see the [CLI documentation on using an oidc authorization provider](/[platform]/build-a-backend/graphqlapi/customize-auth/#using-oidc-authorization-provider).
...
import android0 from '/src/fragments/lib-v1/datastore/android/setup-auth-rules/owner_based_auth_oidc.mdx';

<Fragments fragments={{ android: android0 }} />

import ios1 from '/src/fragments/lib-v1/datastore/ios/setup-auth-rules/owner_based_auth_oidc.mdx';

<Fragments fragments={{ swift: ios1 }} />

import flutterOidc from '/src/fragments/lib-v1/datastore/flutter/setup-auth-rules/owner_based_auth_oidc.mdx';

<Fragments fragments={{ flutter: flutterOidc }} />

### Static Group Authorization with OIDC provider

The following are commonly used patterns for using `groupClaims` to achieve group based authorization using a 3rd party OIDC provider. For more information on how to tune these examples, please see the [CLI documentation on static group authorization](/[platform]/build-a-backend/graphqlapi/customize-auth/#custom-claims).
...
import ios2 from '/src/fragments/lib-v1/datastore/ios/setup-auth-rules/10_multiauth-snippet.mdx';

<Fragments fragments={{ swift: ios2 }} />

import android3 from '/src/fragments/lib-v1/datastore/android/setup-auth-rules/10_multiauth-snippet.mdx';

<Fragments fragments={{ android: android3 }} />

import js4 from '/src/fragments/lib-v1/datastore/js/setup-auth-rules/10_multiauth-snippet.mdx';
...
import reactnative0 from '/src/fragments/lib-v1/datastore/js/setup-auth-rules/10_multiauth-snippet.mdx';

<Fragments fragments={{ 'react-native': reactnative0 }} />

import flutterMultiAuth from '/src/fragments/lib-v1/datastore/flutter/setup-auth-rules/10_multiauth-snippet.mdx';
...
import js5 from '/src/fragments/lib-v1/datastore/js/setup-auth-rules/20_function-auth-snippet.mdx';
...
import reactnative1 from '/src/fragments/lib-v1/datastore/js/setup-auth-rules/20_function-auth-snippet.mdx';
