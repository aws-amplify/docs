...
You can copy a file from the specified key to another key within the same [File Access Level](/gen1/[platform]/build-a-backend/storage/configure-access/) (Defaults to 'public').
