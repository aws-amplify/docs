...
You can also configure the resources on a scoped level by [following the steps shown here](/lib-v1/client-configuration/configuring-amplify-categories/#storage-amazon-s3).
