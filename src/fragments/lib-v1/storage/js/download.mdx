...
Get a presigned URL of a stored file. You can specify some options: mainly [file access `level`](https://docs.amplify.aws/lib-v1/storage/configureaccess/q/platform/js) and whether to `download` the file:
...
Here is a quick guide to the access levels - [see the docs](https://docs.amplify.aws/lib-v1/storage/configureaccess/q/platform/js) for more detail:
