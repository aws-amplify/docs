The API category provides a solution for making HTTP requests to REST and GraphQL endpoints. For building GraphQL APIs please visit the [GraphQL Getting Started](/[platform]/prev/build-a-backend/graphqlapi/set-up-data/) section of our documentation.
