This section lists known TypeScript errors and their workarounds when [strict mode](/lib-v1/troubleshooting/strict-mode/q/platform/js/) is enabled on your application.
