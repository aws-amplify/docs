...
## Upgrade Amplify packages to the v6 developer preview
...
The v6 developer preview doesn't support all categories. If the application your upgrading uses any of the
