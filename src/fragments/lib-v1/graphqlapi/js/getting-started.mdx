...
Because the `Todo` type was decorated with an `@model` directive of the [GraphQL Transform](/[platform]/tools/cli/graphqlapi/data-modeling/) library, the CLI created the additional schema and resolvers for queries, mutations, and subscriptions as well as a DynamoDB table to hold the Todos.
...
| --- | --- |
| [@model](/[platform]/tools/cli/graphqlapi/data-modeling/) on Object | Store objects in DynamoDB and configure CRUD resolvers. |
| [@auth](/[platform]/build-a-backend/graphqlapi/customize-auth/) on Object | Define authorization strategies for your API. |
| [@hasOne, @hasMany, @belongsTo, @manyToMany](/[platform]/tools/cli/graphqlapi/data-modeling/) on Field | Specify relationships between @model object types. |
| [@searchable](/[platform]/tools/cli/graphqlapi/search-and-result-aggregations/) on Object | Stream data of an @model object type to the Amazon OpenSearch Service. |
| [@primaryKey and @index](/[platform]/tools/cli/graphqlapi/data-modeling/) on Object | Index your data with keys. |
| [@function](/[platform]/tools/cli/graphqlapi/custom-business-logic/#lambda-function-resolver) on Field | Connect Lambda resolvers to your API. |
| [@predictions](/[platform]/tools/cli/graphqlapi/connect-machine-learning-services/) on Field | Connect machine learning services. |
| [@http](/[platform]/tools/cli/graphqlapi/custom-business-logic/#http-resolver) on Field | Configure HTTP resolvers within your API. |
...
The Amplify CLI will create an `amplify/backend/api` folder that will hold the existing GraphQL schema, resolvers, and additional configuration around the API. To learn more about how the CLI manages this configuration, check out the documentation [here](/[platform]/tools/cli/graphqlapi/). To learn how to configure custom GraphQL resolvers, check out the documentation [here](/[platform]/tools/cli/graphqlapi/custom-business-logic/#override-amplify-generated-resolvers).
