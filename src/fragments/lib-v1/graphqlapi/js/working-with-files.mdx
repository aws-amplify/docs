...
For more details on how to configure Storage authorization levels, see the [Storage documentation](/[platform]/build-a-backend/storage/configure-access/). For more on configuring GraphQL API authorization, see the [API documentation](https://docs.amplify.aws/lib-v1/graphqlapi/authz/q/platform/js/).
