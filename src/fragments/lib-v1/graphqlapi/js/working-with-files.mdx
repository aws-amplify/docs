...
For more details on how to configure Storage authorization levels, see the [Storage documentation](/[platform]/build-a-backend/storage/configure-access/). For more on configuring GraphQL API authorization, see the [API documentation](/[platform]/prev/build-a-backend/graphqlapi/customize-authz-modes/).
