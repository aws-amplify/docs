...
- [Fetch data](/lib-v1/graphqlapi/query-data)
- [Update data](/lib-v1/graphqlapi/mutate-data)
- [Subscribe to data](/lib-v1/graphqlapi/subscribe-data)
- [Concepts](/lib-v1/graphqlapi/concepts)
- [Configure authorization modes](/lib-v1/graphqlapi/authz)

{/_ TODO: _ [Authorizing API calls with Cognito User Pool] \\ \*/}
