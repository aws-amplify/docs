...
Please use the latest version (v1) of [Amplify Flutter](/lib/q/platform/flutter/) to get started.

If you are currently using v0, follow [these instructions](/lib/project-setup/upgrade-guide/q/platform/flutter/) to upgrade to v1.
