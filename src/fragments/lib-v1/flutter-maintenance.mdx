...
Please use the latest version (v1) of [Amplify Flutter](/gen1/[platform]/tools/libraries/) to get started.

If you are currently using v0, follow [these instructions](/gen1/[platform]/start/project-setup/upgrade-guide/) to upgrade to v1.
