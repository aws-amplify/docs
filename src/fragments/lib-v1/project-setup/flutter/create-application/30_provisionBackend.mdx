...
| App type: flutter
| Configuration file location: ./lib-v1/
...
Upon successfully running `amplify init`, you will see a configuration file created in `./lib-v1/` called `amplifyconfiguration.dart`.
