...
Before you can add an existing AWS resource to an Android application, the application must have the Amplify libraries installed. For detailed instructions, see [Install Amplify Libraries](/gen1/[platform]/prev/start/project-setup/create-application/#n2-install-amplify-libraries).
...
- See the [Analytics category](/gen1/[platform]/prev/build-a-backend/more-features/analytics/existing-resources/) to use existing AWS Pinpoint resources.
- See the [API (GraphQL) category](/gen1/[platform]/prev/build-a-backend/graphqlapi/) to use existing AWS AppSync resources.
- See the [API (REST) category](/gen1/[platform]/prev/build-a-backend/restapi/existing-resources/) to use existing Amazon API Gateway and AWS Lambda resources.
- See the [Authentication category](/gen1/[platform]/prev/build-a-backend/auth/set-up-auth/#prerequisites) to use existing Amazon Cognito resources.
- See the [Storage category](/gen1/[platform]/prev/build-a-backend/storage/existing-resources/) to use existing Amazon S3 resources.
