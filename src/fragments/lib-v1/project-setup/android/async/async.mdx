...
Amplify Android includes optional support for **[Kotlin Coroutines](/gen1/[platform]/prev/start/project-setup/kotlin-coroutines/)** and **[RxJava](/gen1/[platform]/prev/start/project-setup/rxjava/)**.
