...
<Callout>
  Amplify Android supports API levels 16 and higher. If your are supporting a min SDK less than 21, follow <a href="https://developer.android.com/studio/build/multidex#mdex-pre-l" rel="noopener noreferrer" target="_blank">Android's documentation on adding multidex support</a>.
</Callout>
