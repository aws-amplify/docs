...
![](/images/lib-v1/getting-started/android/set-up-android-studio-sync-gradle.png)

When complete, you will see *CONFIGURE SUCCESSFUL* in the output in the *Build* tab at the bottom of your screen.

![](/images/lib-v1/getting-started/android/set-up-android-studio-configure-successful.png)
