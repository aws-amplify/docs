...
![](/images/lib-v1/getting-started/android/set-up-android-studio-welcome.png)

In **Select a Project Template**, select **Empty Activity**. Press **Next**.

![](/images/lib-v1/getting-started/android/set-up-android-studio-select-project-template.png)
...
![](/images/lib-v1/getting-started/android/set-up-android-studio-configure-your-project.png)
...
![](/images/lib-v1/getting-started/android/set-up-android-studio-successful-setup.png)
