...
<img src="/images/project-setup/1_useExistingResources.png" alt="GSA" width="240" />
...
* See the [API (GraphQL) category](/[platform]/prev/build-a-backend/graphqlapi/existing-resources/) to use existing AWS AppSync resources.
