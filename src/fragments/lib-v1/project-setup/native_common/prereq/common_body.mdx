...
import flutter2 from "/src/fragments/lib-v1/project-setup/flutter/prereq/cliInstall.mdx";

<Fragments fragments={{flutter: flutter2}} />

<Callout warning>
Because we're installing the Amplify CLI globally, you might need to run the command above with <b>sudo</b>.
</Callout>
