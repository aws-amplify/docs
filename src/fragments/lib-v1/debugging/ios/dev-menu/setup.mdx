...
If you do not see the `amplify` directory, please follow the [project setup instructions](https://docs.amplify.aws/lib-v1/project-setup/prereq/q/platform/ios).
