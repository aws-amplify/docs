...
> If you login in your app either using the [Drop-In Auth](/sdk/auth/drop-in-auth) or directly via the [Auth APIs](/sdk/auth/working-with-api), the user session will transition automatically to an authenticated role.
