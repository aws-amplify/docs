...
**Prerequisite:** [Install and configure the Amplify CLI](/gen1/[platform]/tools/cli)<br/> **Recommendation:** [Complete the Getting Started guide](/gen1/[platform]/start/getting-started/introduction/)

## How it works

The AWSMobileClient manages your application session for authentication related tasks. The credentials it pulls in can be used by other AWS services when you call a `.getInstance()` constructor. The Amplify category examples in this documentation use this by default, however [you can also use this with any AWS service via the generated SDK clients](/gen1/[platform]/sdk/configuration/setup-options/).
