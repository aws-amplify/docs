...
dependencies {
    ...
    implementation 'com.amazonaws:aws-android-sdk-auth-facebook:2.36.0'

    // Sign in UI
    implementation 'com.android.support:appcompat-v7:28.+'
    implementation 'com.amazonaws:aws-android-sdk-auth-ui:2.36.0'
}
```
...
dependencies {
    ...
    // Google SignIn
    implementation 'com.android.support:support-v4:28.+'
    implementation 'com.amazonaws:aws-android-sdk-auth-google:2.36.0'
