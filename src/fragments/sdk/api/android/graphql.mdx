...
**Note:** generated models with the GraphQL [`improvePluralization`](/cli/reference/feature-flags/#improvePluralization) feature flag enabled will be incompatible with Android SDK versions earlier than 1.28.3
...
In the Adapter object, create the BaseQuery and the BaseQuery Callback. You will use the `listPosts` query from the sample schema as your base query.
```java
...
Next, you will create a subscription to get notified whenever a change (Add, Update or Delete) happens to a post.
