...
In the Adapter object, create the BaseQuery and the BaseQuery Callback. You will use the `listPosts` query from the sample schema as our base query.
```java
//Setup the BaseQuery - you will use the ListPostsQuery as our base query
