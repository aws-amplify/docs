...
<b> Prerequisite:</b> [Install and configure the Amplify CLI](/gen1/[platform]/tools/cli/start/set-up-cli/) <br />
<b>Recommendation:</b> [Complete the Getting Started guide](/gen1/[platform]/start/getting-started/introduction/)
