...
describe('Menu', () => {
  ...
  it('should render the cli-legacy-specific menu', async () => {
    const component = (
      <Menu
        ...
        path="/gen1/[platform]/tools/cli-legacy/overview"
      />
    );
  ...
  it('should render the v5-specific menu', async () => {
    const menuComponent = (
      <Menu currentPlatform="react" path="/gen1/[platform]/prev"></Menu>
    );
  ...
  it('should render the sdk-specific menu', async () => {
    const menuComponent = (
      <Menu currentPlatform="swift" path="/gen1/[platform]/sdk"></Menu>
    );
    render(menuComponent);
