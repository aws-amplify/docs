...
export const PinpointEOLBanner = () => {
  return (
    <Callout backgroundColor="background.error">
      ...
      </Link>, and is no longer accepting any new users as of May 20 (see the linked
            doc). The guidance is to use{' '}
      <Link
        href="https://aws.amazon.com/end-user-messaging"
        className={classNames('amplify-link')}>
        AWS End User Messaging
      </Link>{' '}for push notifications and SMS,{' '}
      <Link href="https://aws.amazon.com/ses" className={classNames('amplify-link')}>
      ...
      <Link
        ...
        className={classNames('amplify-link')}>
        Amazon Connect
      </Link>{' '}for campaigns, journeys, endpoints, and engagement analytics. Pinpoint
            recommends{' '}
      <Link
        href="https://aws.amazon.com/kinesis"
        className={classNames('amplify-link')}>
        Amazon Kinesis
      </Link>{' '}for event collection and mobile analytics.
          </Callout>
  );
};
