...
Choose **Google** and then provide your Google **Client IDs** as appropriate. The CLI will as you for both the **Web Client ID** and **iOS Client ID** at the appropriate time.
